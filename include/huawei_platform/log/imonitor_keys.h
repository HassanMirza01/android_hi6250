...
/*** Reliability events' keys ***/
	...
	/* Process Name */
	#define E901000003_PNAME_VARCHAR 4
	/* 1st fuction in stack */
	#define E901000003_F1NAME_VARCHAR 5
...
/*** PowerThermal events' keys ***/
	...
	/* Cam0 temperature */
	#define E903001012_CAM0TEMP_TINYINT 10
	/* Cam1 temperature */
	#define E903001012_CAM1TEMP_TINYINT 11
	/* Cam2 temperature */
	#define E903001012_CAM2TEMP_TINYINT 12
	...
	/* InterFreq measurement count */
	#define E903001018_INTERMEASCOUNT_INT 25
	...
	/* Cam0 temperature */
	#define E903002010_CAM0TEMP_TINYINT 27
	/* Cam1 temperature */
	#define E903002010_CAM1TEMP_TINYINT 28
	/* Cam2 temperature */
	#define E903002010_CAM2TEMP_TINYINT 29
...
/*** DMD events' keys ***/
	...
	/* Event 920001028
		battery fcc learn */
	/* error level */
	#define E920001028_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001028_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001028_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001028_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001028_COUNT_INT 4

	/* Event 920001029
		battery fcc learn only 90% fcc design */
	/* error level */
	#define E920001029_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001029_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001029_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001029_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001029_COUNT_INT 4
	...
	/* Event 920001031
		battery fcc learn only 80% fcc design */
	/* error level */
	#define E920001031_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001031_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001031_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001031_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001031_COUNT_INT 4

	/* Event 920001032
		battery fcc learn only 60% fcc design */
	/* error level */
	#define E920001032_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001032_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001032_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001032_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001032_COUNT_INT 4

	/* Event 920001033
		otg ocp */
	/* error level */
	#define E920001033_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001033_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001033_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001033_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001033_COUNT_INT 4

	/* Event 920001034
		charger i2c read and write fail */
	/* error level */
	#define E920001034_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001034_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001034_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001034_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001034_COUNT_INT 4
	...
	/* Event 920001063
		idapt(%d) > adaptor_leakage_current_th */
	/* error level */
	...
	/* Event 920001064
		vbus ovp happened */
	/* error level */
	#define E920001064_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001064_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001064_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001064_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001064_COUNT_INT 4

	/* Event 920001065
		reverse ocp happened */
	/* error level */
	#define E920001065_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001065_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001065_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001065_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001065_COUNT_INT 4

	/* Event 920001066
		otp happened */
	/* error level */
	#define E920001066_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001066_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001066_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001066_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001066_COUNT_INT 4

	/* Event 920001067
		input ocp happened */
	/* error level */
	#define E920001067_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001067_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001067_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001067_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001067_COUNT_INT 4

	/* Event 920001068
		adaptor otp */
	/* error level */
	#define E920001068_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920001068_IC_NAME_VARCHAR 1
	/* module name */
	#define E920001068_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920001068_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920001068_COUNT_INT 4

	/* Event 920002000
		battery ID detect abnormal */
	/* error level */
	#define E920002000_ERROR_LEVEL_INT 0
	/* IC name */
	#define E920002000_IC_NAME_VARCHAR 1
	/* module name */
	#define E920002000_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920002000_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920002000_COUNT_INT 4
	...
	/* IC name */
	#define E920007049_IC_NAME_VARCHAR 1
	/* module name */
	#define E920007049_MODULE_NAME_VARCHAR 2
	/* description */
	#define E920007049_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E920007049_COUNT_INT 4
	...
	/* Event 921003001
		SMARTPA INT abnormally */
	/* error level */
	#define E921003001_ERROR_LEVEL_INT 0
	/* IC name */
	#define E921003001_IC_NAME_VARCHAR 1
	/* module name */
	#define E921003001_MODULE_NAME_VARCHAR 2
	/* description */
	#define E921003001_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E921003001_COUNT_INT 4
	...
	/* Event 922001032
		fb0 device is released */
	/* error level */
	#define E922001032_ERROR_LEVEL_INT 0
	/* IC name */
	#define E922001032_IC_NAME_VARCHAR 1
	/* module name */
	#define E922001032_MODULE_NAME_VARCHAR 2
	/* description */
	#define E922001032_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E922001032_COUNT_INT 4
	...
	/* Event 923002014
		NFCC status abnormal and go to recovery */
	/* error level */
	#define E923002014_ERROR_LEVEL_INT 0
	/* IC name */
	#define E923002014_IC_NAME_VARCHAR 1
	/* module name */
	#define E923002014_MODULE_NAME_VARCHAR 2
	/* description */
	#define E923002014_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E923002014_COUNT_INT 4

	/* Event 923002015
		hisee cos image upgrade failure */
	/* error level */
	#define E923002015_ERROR_LEVEL_INT 0
	/* IC name */
	#define E923002015_IC_NAME_VARCHAR 1
	/* module name */
	#define E923002015_MODULE_NAME_VARCHAR 2
	/* description */
	#define E923002015_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E923002015_COUNT_INT 4

	/* Event 923002016
		hisee power on/off failure */
	/* error level */
	#define E923002016_ERROR_LEVEL_INT 0
	/* IC name */
	#define E923002016_IC_NAME_VARCHAR 1
	/* module name */
	#define E923002016_MODULE_NAME_VARCHAR 2
	/* description */
	#define E923002016_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E923002016_COUNT_INT 4

	/* Event 923002017
		hisee apdu command operation failure */
	/* error level */
	#define E923002017_ERROR_LEVEL_INT 0
	/* IC name */
	#define E923002017_IC_NAME_VARCHAR 1
	/* module name */
	#define E923002017_MODULE_NAME_VARCHAR 2
	/* description */
	#define E923002017_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E923002017_COUNT_INT 4
	...
	/* Event 926004025
		Get lcd panel name failed info */
	/* error level */
	#define E926004025_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926004025_IC_NAME_VARCHAR 1
	/* module name */
	#define E926004025_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926004025_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926004025_COUNT_INT 4

	/* Event 926004026
		TP noise info report */
	/* error level */
	#define E926004026_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926004026_IC_NAME_VARCHAR 1
	/* module name */
	#define E926004026_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926004026_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926004026_COUNT_INT 4
	...
	/* Event 926010000
		DPSTS BOTH CONNECTED */
	/* error level */
	#define E926010000_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010000_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010000_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010000_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010000_COUNT_INT 4

	/* Event 926010001
		UFP INVALID */
	/* error level */
	#define E926010001_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010001_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010001_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010001_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010001_COUNT_INT 4

	/* Event 926010002
		DFP INVALID */
	/* error level */
	#define E926010002_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010002_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010002_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010002_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010002_COUNT_INT 4

	/* Event 926010003
		OVER VDO MAX SIZE */
	/* error level */
	#define E926010003_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010003_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010003_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010003_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010003_COUNT_INT 4

	/* Event 926010004
		PD MSG IS NULL */
	/* error level */
	#define E926010004_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010004_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010004_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010004_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010004_COUNT_INT 4

	/* Event 926010005
		data obj is null */
	/* error level */
	#define E926010005_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010005_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010005_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010005_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010005_COUNT_INT 4

	/* Event 926010006
		OVER VDO MAX SVID SIZE */
	/* error level */
	#define E926010006_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010006_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010006_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010006_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010006_COUNT_INT 4

	/* Event 926010007
		NR PE STATES */
	/* error level */
	#define E926010007_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010007_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010007_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010007_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010007_COUNT_INT 4

	/* Event 926010008
		TIMER NR */
	/* error level */
	#define E926010008_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010008_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010008_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010008_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010008_COUNT_INT 4

	/* Event 926010009
		ALLOC MSG */
	/* error level */
	#define E926010009_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010009_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010009_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010009_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010009_COUNT_INT 4

	/* Event 926010010
		FREE MSG */
	/* error level */
	#define E926010010_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010010_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010010_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010010_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010010_COUNT_INT 4

	/* Event 926010011
		TCPC DEV NULL */
	/* error level */
	#define E926010011_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010011_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010011_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010011_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010011_COUNT_INT 4

	/* Event 926010012
		DATA ROLE ISNOT PD ROLE DFP */
	/* error level */
	#define E926010012_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010012_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010012_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010012_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010012_COUNT_INT 4

	/* Event 926010013
		SVID_DATA_NULL */
	/* error level */
	#define E926010013_ERROR_LEVEL_INT 0
	/* IC name */
	#define E926010013_IC_NAME_VARCHAR 1
	/* module name */
	#define E926010013_MODULE_NAME_VARCHAR 2
	/* description */
	#define E926010013_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E926010013_COUNT_INT 4
	...
	/* Event 927003021
		Front Camera MatchId Error */
	/* error level */
	#define E927003021_ERROR_LEVEL_INT 0
	/* IC name */
	#define E927003021_IC_NAME_VARCHAR 1
	/* module name */
	#define E927003021_MODULE_NAME_VARCHAR 2
	/* description */
	#define E927003021_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E927003021_COUNT_INT 4

	/* Event 927003022
		Back Sub Camera MatchId Error */
	/* error level */
	#define E927003022_ERROR_LEVEL_INT 0
	/* IC name */
	#define E927003022_IC_NAME_VARCHAR 1
	/* module name */
	#define E927003022_MODULE_NAME_VARCHAR 2
	/* description */
	#define E927003022_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E927003022_COUNT_INT 4
	...
	/* Event 928008010
		UFS_VOLT_GPIO_ERR */
	/* error level */
	#define E928008010_ERROR_LEVEL_INT 0
	/* IC name */
	#define E928008010_IC_NAME_VARCHAR 1
	/* module name */
	#define E928008010_MODULE_NAME_VARCHAR 2
	/* description */
	#define E928008010_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E928008010_COUNT_INT 4

	/* Event 928008011
		UFS_LINKUP_ERR */
	/* error level */
	#define E928008011_ERROR_LEVEL_INT 0
	/* IC name */
	#define E928008011_IC_NAME_VARCHAR 1
	/* module name */
	#define E928008011_MODULE_NAME_VARCHAR 2
	/* description */
	#define E928008011_DESCRIPTION_VARCHAR 3
	/* report counts */
	#define E928008011_COUNT_INT 4
...
/*** LogEngine events' keys ***/
	...
	/* List of used apps */
	#define E908001006_USEDAPPSLIST_VARCHAR 0
...
/*** Wifi events' keys ***/
	...
	/* is AP Model Recognized */
	#define E909002020_ISRECOGNIZED_TINYINT 2
	/* AP Vendor */
	#define E909002020_APVENDOR_VARCHAR 3
	/* AP Model */
	#define E909002020_APMODEL_VARCHAR 4
...
/*** NFC events' keys ***/
	...
	/* Event 915001001
		NFC exception event */
	/* ErrorCode */
	#define E915001001_ERRORCODE_SMALLINT 0
	/* SubErrorCode */
	#define E915001001_SUBERRORCODE_SMALLINT 1
...
/*** Audio events' keys ***/
	...
	/* Event 916010101
		File Reader Error */
	/* Event Level(mandatory) */
	#define E916010101_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010101_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010101_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010101_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010101_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010101_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010101_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010101_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010101_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010101_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010101_RESERVED2_VARCHAR 10

	/* Event 916010102
		Extractor Error */
	/* Event Level(mandatory) */
	#define E916010102_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010102_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010102_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010102_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010102_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010102_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010102_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010102_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010102_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010102_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010102_RESERVED2_VARCHAR 10

	/* Event 916010103
		Decoder Error */
	/* Event Level(mandatory) */
	#define E916010103_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010103_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010103_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010103_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010103_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010103_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010103_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010103_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010103_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010103_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010103_RESERVED2_VARCHAR 10

	/* Event 916010104
		Render Error */
	/* Event Level(mandatory) */
	#define E916010104_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010104_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010104_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010104_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010104_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010104_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010104_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010104_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010104_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010104_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010104_RESERVED2_VARCHAR 10

	/* Event 916010105
		Streaming Error */
	/* Event Level(mandatory) */
	#define E916010105_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010105_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010105_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010105_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010105_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010105_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010105_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010105_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010105_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010105_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010105_RESERVED2_VARCHAR 10

	/* Event 916010106
		MediaPlayer Service Error */
	/* Event Level(mandatory) */
	#define E916010106_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010106_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010106_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010106_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010106_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010106_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010106_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010106_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010106_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010106_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010106_RESERVED2_VARCHAR 10

	/* Event 916010201
		Mode Error */
	/* Event Level(mandatory) */
	#define E916010201_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010201_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010201_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010201_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010201_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010201_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010201_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010201_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010201_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010201_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010201_RESERVED2_VARCHAR 10

	/* Event 916010202
		RingTone Error */
	/* Event Level(mandatory) */
	#define E916010202_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010202_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010202_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010202_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010202_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010202_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010202_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010202_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010202_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010202_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010202_RESERVED2_VARCHAR 10

	/* Event 916010203
		Mic Error */
	/* Event Level(mandatory) */
	#define E916010203_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010203_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010203_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010203_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010203_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010203_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010203_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010203_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010203_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010203_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010203_RESERVED2_VARCHAR 10

	/* Event 916010204
		BlueTooth SCO Error */
	/* Event Level(mandatory) */
	#define E916010204_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010204_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010204_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010204_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010204_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010204_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010204_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010204_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010204_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010204_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010204_RESERVED2_VARCHAR 10

	/* Event 916010205
		Volume Error */
	/* Event Level(mandatory) */
	#define E916010205_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010205_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010205_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010205_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010205_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010205_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010205_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010205_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010205_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010205_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010205_RESERVED2_VARCHAR 10

	/* Event 916010206
		Video No Signal */
	/* Event Level(mandatory) */
	#define E916010206_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010206_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010206_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010206_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010206_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010206_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010206_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010206_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010206_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010206_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010206_RESERVED2_VARCHAR 10

	/* Event 916010301
		Create Track Error */
	/* Event Level(mandatory) */
	#define E916010301_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010301_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010301_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010301_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010301_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010301_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010301_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010301_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010301_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010301_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010301_RESERVED2_VARCHAR 10

	/* Event 916010302
		Record Track Error */
	/* Event Level(mandatory) */
	#define E916010302_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010302_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010302_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010302_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010302_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010302_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010302_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010302_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010302_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010302_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010302_RESERVED2_VARCHAR 10

	/* Event 916010303
		Mix Error */
	/* Event Level(mandatory) */
	#define E916010303_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010303_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010303_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010303_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010303_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010303_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010303_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010303_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010303_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010303_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010303_RESERVED2_VARCHAR 10

	/* Event 916010401
		AudioEffect */
	/* Event Level(mandatory) */
	#define E916010401_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010401_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010401_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010401_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010401_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010401_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010401_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010401_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010401_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010401_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010401_RESERVED2_VARCHAR 10

	/* Event 916010501
		AF Audio Latency Error */
	/* Event Level(mandatory) */
	#define E916010501_EEVENTID_INT 0
	/* Event Module(mandatory) */
	#define E916010501_EEVENTLEVEL_INT 1
	/* Sub Type(mandatory) */
	#define E916010501_SUBTYPE_INT 2
	/* User Scenario description(mandatory or null) */
	#define E916010501_REASON_VARCHAR 3
	/* Calling Applcation Name */
	#define E916010501_CALLINGAPP_VARCHAR 4
	/* Error Count(only when level and subtype match) */
	#define E916010501_COUNT_INT 5
	/* paramter Int(Specified by Scenario ) */
	#define E916010501_PARAINT_INT 6
	/* paramter Char(Specified by Scenario ) */
	#define E916010501_PARACHAR_VARCHAR 7
	/* Associated Eevent ID */
	#define E916010501_ASSOCIATEDEEVENTID_INT 8
	/* Reserverd Parameter 1 */
	#define E916010501_RESERVED1_INT 9
	/* Reserverd Parameter 2 */
	#define E916010501_RESERVED2_VARCHAR 10

	/* Event 916019001
		Audio format compatibility KPI */
	/* Format Type(mandatory) */
	#define E916019001_FORMATTYPE_VARCHAR 0
	/* Support or not */
	#define E916019001_SUPPORTS_VARCHAR 1
	/* Reserverd Parameter 1 */
	#define E916019001_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019001_RESERVED2_VARCHAR 3

	/* Event 916019002
		Streaming protocol compatibility KPI */
	/* Protocol Type(mandatory) */
	#define E916019002_PROTOCOLTYPE_INT 0
	/* Support or not */
	#define E916019002_SUPPORTS_INT 1
	/* Reserverd Parameter 1 */
	#define E916019002_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019002_RESERVED2_VARCHAR 3

	/* Event 916019003
		Latency KPI */
	/* Latency Type(mandatory) */
	#define E916019003_LATENCYTYPE_INT 0
	/* Latency Time(ms) */
	#define E916019003_LATENCYTIME_INT 1
	/* Reserverd Parameter 1 */
	#define E916019003_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019003_RESERVED2_VARCHAR 3

	/* Event 916019004
		Resouce consumption KPI */
	/* Resource Type(mandatory) */
	#define E916019004_RESOURCETYPE_INT 0
	/* Resource Consumption */
	#define E916019004_RESOURCECONSUMPTION_INT 1
	/* Reserverd Parameter 1 */
	#define E916019004_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019004_RESERVED2_VARCHAR 3

	/* Event 916019005
		Resouce load KPI */
	/* Resource Type(mandatory) */
	#define E916019005_RESOURCETYPE_INT 0
	/* Resource load */
	#define E916019005_RESOURCELOAD_FLOAT 1
	/* Reserverd Parameter 1 */
	#define E916019005_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019005_RESERVED2_VARCHAR 3

	/* Event 916019006
		Power KPI */
	/* Power Type(mandatory) */
	#define E916019006_POWERTYPE_INT 0
	/* Power Consumption(mandatory) */
	#define E916019006_POWERCONSUMPTION_INT 1
	/* Reserverd Parameter 1 */
	#define E916019006_RESERVED1_INT 2
	/* Reserverd Parameter 2 */
	#define E916019006_RESERVED2_VARCHAR 3

	/* Event 916019007
		Stability KPI */
	/* Stability Type(mandatory) */
	#define E916019007_STABILITYTYPE_INT 0
	/* Test duration(mandatory) */
	#define E916019007_TESTDURATION_INT 1
	/* Total error count(mandatory) */
	#define E916019007_TOTALERRORCNT_INT 2
	/* Error type */
	#define E916019007_ERRORTYPE_INT 3
	/* Each error count(mandatory) */
	#define E916019007_ERRORCNTS_VARCHAR 4
	/* Reserverd Parameter 1 */
	#define E916019007_RESERVED1_INT 5
	/* Reserverd Parameter 2 */
	#define E916019007_RESERVED2_VARCHAR 6

	/* Event 916019101
		Player Data */
	/* Huawei Music */
	#define E916019101_HWPLAYER_INT 0
	/* QQ Music */
	#define E916019101_QQPLAYER_INT 1
	/* KuGou Music */
	#define E916019101_KUGOUPLAYER_INT 2
	/* KuWo Music */
	#define E916019101_KUWOPLAYER_INT 3
	/* XiaMi Music */
	#define E916019101_XIAMIPLAYER_INT 4
	/* BaiDu Music */
	#define E916019101_BAIDUPLAYER_INT 5
	/* NetEasy Music */
	#define E916019101_NETEASYPLAYER_INT 6
	/* TianTian Music */
	#define E916019101_TTPLAYER_INT 7
	/* MiGu Music */
	#define E916019101_MIGUPLAYER_INT 8
	/* Other Player */
	#define E916019101_OTHERPLAYER_INT 9
	/* Total */
	#define E916019101_TOTAL_INT 10

	/* Event 916019102
		Play Format */
	/* HiRes Format */
	#define E916019102_PLAYHIRES_INT 0
	/* MP3 Format */
	#define E916019102_PLAYMP3_INT 1
	/* WAV Format */
	#define E916019102_PLAYWAVE_INT 2
	/* AAC Format */
	#define E916019102_PLAYAAC_INT 3
	/* WMA Format */
	#define E916019102_PLAYWMA_INT 4
	/* Flac Format */
	#define E916019102_PLAYFLAC_INT 5
	/* APE Format */
	#define E916019102_PLAYAPE_INT 6
	/* Other Format */
	#define E916019102_PLAYOTHER_INT 7
	/* Total */
	#define E916019102_TOTAL_INT 8

	/* Event 916019103
		Play Mode */
	/* Playoffload */
	#define E916019103_PLAYOFFLOAD_INT 0
	/* Play Non-Offload */
	#define E916019103_PLAYNONOFFLOAD_INT 1
	/* Play LowPower */
	#define E916019103_PLAYLPP_INT 2
	/* Play Other */
	#define E916019103_PLAYOTHER_INT 3
	/* Total */
	#define E916019103_TOTAL_INT 4

	/* Event 916019104
		Play OutPut Device */
	/* Output EarPhone */
	#define E916019104_OUTPUTEARPHONE_INT 0
	/* Output Speaker */
	#define E916019104_OUTPUTSPEAKER_INT 1
	/* Output BT */
	#define E916019104_OUTPUTBULETOOTH_INT 2
	/* Output USB */
	#define E916019104_OUTPUTUSB_INT 3
	/* Output Other */
	#define E916019104_OUTPUTOTHER_INT 4
	/* Total */
	#define E916019104_TOTAL_INT 5

	/* Event 916019201
		Play Effect */
	/* No Audio Effect */
	#define E916019201_EEFFECTEMPTY_INT 0
	/* DTS effect */
	#define E916019201_EFFECTDTS_INT 1
	/* SWS effect */
	#define E916019201_EFFECTSWS_INT 2
	/* Dolby Effec */
	#define E916019201_EFFECTDOLBY_INT 3
	/* Other effect */
	#define E916019201_EFFECTOTHER_INT 4
	/* Total */
	#define E916019201_TOTAL_INT 5

	/* Event 916019202
		StereoAudio */
	/* StereoOff */
	#define E916019202_STEREOOFF_INT 0
	/* StereoLandscape */
	#define E916019202_STEREOLANDSCAPE_INT 1
	/* StereoPortrait */
	#define E916019202_STEREOPORTRAIT_INT 2
	/* Total */
	#define E916019202_TOTAL_INT 3
