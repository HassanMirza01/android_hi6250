...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED4_A,      654*1024,  49*1024,       EMMC_USER_PART},/* reserved4A      49M    p40*/
  {PART_DDR_PARA_A,      703*1024,  1*1024,       EMMC_USER_PART},/* DDR_PARA      1M    p41*/
  {PART_MODEMNVM_UPDATE_A,704*1024,  80*1024,       EMMC_USER_PART},/* modemnvm update 80M    p42*/
  {PART_ISP_DTS_A,        784*1024,  16*1024,       EMMC_USER_PART},/* isp_dts         16M    p43*/
  {PART_VERSION_A,        800*1024,  8*1024,        EMMC_USER_PART},/* version         8M     p44*/
  {PART_VENDOR_A,         808*1024,  352*1024,      EMMC_USER_PART},/* vendor          352M   p45*/
  {PART_PRODUCT_A,        1160*1024, 120*1024,      EMMC_USER_PART},/* product         120M   p46*/
  {PART_CUST_A,           1280*1024, 128*1024,      EMMC_USER_PART},/* cust            128M   p47*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         1408*1024, 1848*1024,     EMMC_USER_PART},/* system          1848M  p48*/
  {PART_FW_LPM3_B,        3256*1024, 256,           EMMC_USER_PART},/* mcuimage        256K   p49*/
  {PART_RESERVED3_B,      3334400,   7936,          EMMC_USER_PART},/* reserved3A      7936KB p50*/
  {PART_FASTBOOT_B,       3264*1024, 12*1024,       EMMC_USER_PART},/* fastboot        12M    p51*/
  {PART_VECTOR_B,         3276*1024, 4*1024,        EMMC_USER_PART},/* avs vector      4M     p52*/
  {PART_ISP_BOOT_B,       3280*1024, 2*1024,        EMMC_USER_PART},/* isp_boot        2M     p53*/
  {PART_ISP_FIRMWARE_B,   3282*1024, 14*1024,       EMMC_USER_PART},/* isp_firmware    14M    p54*/
  {PART_FW_HIFI_B,        3296*1024, 12*1024,       EMMC_USER_PART},/* hifi            12M    p55*/
  {PART_TEEOS_B,          3308*1024, 8*1024,        EMMC_USER_PART},/* teeos           8M     p56*/
  {PART_RECOVERY2_B,      3316*1024, 64*1024,       EMMC_USER_PART},/* recovery2       64M    p57*/
  {PART_SENSORHUB_B,      3380*1024, 16*1024,       EMMC_USER_PART},/* sensorhub       16M    p58*/
  {PART_BOOT_B,           3396*1024, 32*1024,       EMMC_USER_PART},/* boot            32M    p59*/
  {PART_RECOVERY_B,       3428*1024, 64*1024,       EMMC_USER_PART},/* recovery        64M    p60*/
  {PART_DTS_B,            3492*1024, 16*1024,       EMMC_USER_PART},/* dtimage         16M    p61*/
  {PART_TRUSTFIRMWARE_B,  3508*1024, 2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p62*/
  {PART_MODEM_FW_B,       3510*1024, 56*1024,       EMMC_USER_PART},/* modem_fw        56M    p63*/
  {PART_RESERVED4_B,      3566*1024, 49*1024,       EMMC_USER_PART},/* reserved4B      49M    p64*/
  {PART_DDR_PARA_B,       3615*1024,  1*1024,       EMMC_USER_PART},/* DDR_PARA      1M    p65*/
  {PART_MODEMNVM_UPDATE_B,3616*1024, 80*1024,       EMMC_USER_PART},/* modemnvm update 80M    p66*/
  {PART_ISP_DTS_B,        3696*1024, 16*1024,       EMMC_USER_PART},/* isp_dts         16M    p67*/
  {PART_VERSION_B,        3712*1024, 8*1024,        EMMC_USER_PART},/* version         8M     p68*/
  {PART_VENDOR_B,         3720*1024, 352*1024,      EMMC_USER_PART},/* vendor          352M   p69*/
  {PART_PRODUCT_B,        4072*1024, 120*1024,      EMMC_USER_PART},/* product         120M   p70*/
  {PART_CUST_B,           4192*1024, 128*1024,      EMMC_USER_PART},/* cust            128M   p71*/
  {PART_SYSTEM_B,         4320*1024, 1848*1024,     EMMC_USER_PART},/* system          1848M  p72*/
  {PART_RESERVED5,        6168*1024, 64*1024,       EMMC_USER_PART},/* reserved5       64M    p73*/
  {PART_USERDATA,         6232*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p74*/
  #else
  {PART_SYSTEM_A,         1408*1024, 2640*1024,     EMMC_USER_PART},/* system          2640M  p48*/
  {PART_FW_LPM3_B,        4048*1024, 256,           EMMC_USER_PART},/* mcuimage        256K   p49*/
  {PART_RESERVED3_B,      4145408,   7936,          EMMC_USER_PART},/* reserved3A      7936KB p50*/
  {PART_FASTBOOT_B,       4056*1024, 12*1024,       EMMC_USER_PART},/* fastboot        12M    p51*/
  {PART_VECTOR_B,         4068*1024, 4*1024,        EMMC_USER_PART},/* avs vector      4M     p52*/
  {PART_ISP_BOOT_B,       4072*1024, 2*1024,        EMMC_USER_PART},/* isp_boot        2M     p53*/
  {PART_ISP_FIRMWARE_B,   4074*1024, 14*1024,       EMMC_USER_PART},/* isp_firmware    14M    p54*/
  {PART_FW_HIFI_B,        4088*1024, 12*1024,       EMMC_USER_PART},/* hifi            12M    p55*/
  {PART_TEEOS_B,          4100*1024, 8*1024,        EMMC_USER_PART},/* teeos           8M     p56*/
  {PART_RECOVERY2_B,      4108*1024, 64*1024,       EMMC_USER_PART},/* recovery2       64M    p57*/
  {PART_SENSORHUB_B,      4172*1024, 16*1024,       EMMC_USER_PART},/* sensorhub       16M    p58*/
  {PART_BOOT_B,           4188*1024, 32*1024,       EMMC_USER_PART},/* boot            32M    p59*/
  {PART_RECOVERY_B,       4220*1024, 64*1024,       EMMC_USER_PART},/* recovery        64M    p60*/
  {PART_DTS_B,            4284*1024, 16*1024,       EMMC_USER_PART},/* dtimage         16M    p61*/
  {PART_TRUSTFIRMWARE_B,  4300*1024, 2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p62*/
  {PART_MODEM_FW_B,       4302*1024, 56*1024,       EMMC_USER_PART},/* modem_fw        56M    p63*/
  {PART_RESERVED4_B,      4358*1024, 49*1024,       EMMC_USER_PART},/* reserved4B      49M    p64*/
  {PART_DDR_PARA_B,       4407*1024,  1*1024,       EMMC_USER_PART},/* DDR_PARA        1M    p65*/
  {PART_MODEMNVM_UPDATE_B,4408*1024, 80*1024,       EMMC_USER_PART},/* modemnvm update 80M    p66*/
  {PART_ISP_DTS_B,        4488*1024, 16*1024,       EMMC_USER_PART},/* isp_dts         16M    p67*/
  {PART_VERSION_B,        4504*1024, 8*1024,        EMMC_USER_PART},/* version         8M     p68*/
  {PART_VENDOR_B,         4512*1024, 352*1024,      EMMC_USER_PART},/* vendor          352M   p69*/
  {PART_PRODUCT_B,        4864*1024, 120*1024,      EMMC_USER_PART},/* product         120M   p70*/
  {PART_CUST_B,           4984*1024, 128*1024,      EMMC_USER_PART},/* cust            128M   p71*/
  {PART_SYSTEM_B,         5112*1024, 2640*1024,     EMMC_USER_PART},/* system          2640M  p72*/
  {PART_RESERVED5,        7752*1024, 64*1024,       EMMC_USER_PART},/* reserved5       64M    p73*/
  {PART_USERDATA,         7816*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p74*/
  #endif
  {"0", 0, 0, 0},                                        /* total 11848M*/
};
#ifdef CONFIG_HISI_STORAGE_UFS_PARTITION
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED4_A,      646*1024,  49*1024,       UFS_PART_3},/* reserved4A      49M    p36*/
  {PART_DDR_PARA_A,       695*1024,  1*1024,        UFS_PART_3},/* DDR_PARA        1M     p37*/
  {PART_MODEMNVM_UPDATE_A,696*1024,  80*1024,       UFS_PART_3},/* modemnvm update 80M    p38*/
  {PART_ISP_DTS_A,        776*1024,  16*1024,       UFS_PART_3},/* isp_dts         16M    p39*/
  {PART_VERSION_A,        792*1024,  8*1024,        UFS_PART_3},/* version         8M     p40*/
  {PART_VENDOR_A,         800*1024,  352*1024,      UFS_PART_3},/* vendor          352M   p41*/
  {PART_PRODUCT_A,        1152*1024, 120*1024,      UFS_PART_3},/* product         120M   p42*/
  {PART_CUST_A,           1272*1024, 128*1024,      UFS_PART_3},/* cust            128M   p43*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         1400*1024, 1848*1024,     UFS_PART_3},/* system          1848M  p44*/
  {PART_FW_LPM3_B,        3248*1024, 256,           UFS_PART_3},/* mcuimage        256K   p45*/
  {PART_RESERVED3_B,      3326208,   7936,          UFS_PART_3},/* reserved3A      7936KB p46*/
  {PART_FASTBOOT_B,       3256*1024, 12*1024,       UFS_PART_3},/* fastboot        12M    p47*/
  {PART_VECTOR_B,         3268*1024, 4*1024,        UFS_PART_3},/* avs vector      4M     p48*/
  {PART_ISP_BOOT_B,       3272*1024, 2*1024,        UFS_PART_3},/* isp_boot        2M     p49*/
  {PART_ISP_FIRMWARE_B,   3274*1024, 14*1024,       UFS_PART_3},/* isp_firmware    14M    p50*/
  {PART_FW_HIFI_B,        3288*1024, 12*1024,       UFS_PART_3},/* hifi            12M    p51*/
  {PART_TEEOS_B,          3300*1024, 8*1024,        UFS_PART_3},/* teeos           8M     p52*/
  {PART_RECOVERY2_B,      3308*1024, 64*1024,       UFS_PART_3},/* recovery2       64M    p53*/
  {PART_SENSORHUB_B,      3372*1024, 16*1024,       UFS_PART_3},/* sensorhub       16M    p54*/
  {PART_BOOT_B,           3388*1024, 32*1024,       UFS_PART_3},/* boot            32M    p55*/
  {PART_RECOVERY_B,       3420*1024, 64*1024,       UFS_PART_3},/* recovery        64M    p56*/
  {PART_DTS_B,            3484*1024, 16*1024,       UFS_PART_3},/* dtimage         16M    p57*/
  {PART_TRUSTFIRMWARE_B,  3500*1024, 2*1024,        UFS_PART_3},/* trustfirmware   2M     p58*/
  {PART_MODEM_FW_B,       3502*1024, 56*1024,       UFS_PART_3},/* modem_fw        56M    p59*/
  {PART_RESERVED4_B,      3558*1024, 49*1024,       UFS_PART_3},/* reserved4B      49M    p60*/
  {PART_DDR_PARA_B,       3607*1024,  1*1024,        UFS_PART_3},/* DDR_PARA        1M    p61*/
  {PART_MODEMNVM_UPDATE_B,3608*1024, 80*1024,       UFS_PART_3},/* modemnvm update 80M    p62*/
  {PART_ISP_DTS_B,        3688*1024, 16*1024,       UFS_PART_3},/* isp_dts         16M    p63*/
  {PART_VERSION_B,        3704*1024, 8*1024,        UFS_PART_3},/* version         8M     p64*/
  {PART_VENDOR_B,         3712*1024, 352*1024,      UFS_PART_3},/* vendor          352M   p65*/
  {PART_PRODUCT_B,        4064*1024, 120*1024,      UFS_PART_3},/* product         120M   p66*/
  {PART_CUST_B,           4184*1024, 128*1024,      UFS_PART_3},/* cust            128M   p67*/
  {PART_SYSTEM_B,         4312*1024, 1848*1024,     UFS_PART_3},/* system          2640M  p68*/
  {PART_RESERVED5,        6160*1024, 64*1024,       UFS_PART_3},/* reserved5       64M    p69*/
  {PART_USERDATA,         6224*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p70*/
  #else //default or CONFIG_MARKET_OVERSEA
  {PART_SYSTEM_A,         1400*1024, 2640*1024,     UFS_PART_3},/* system          2640M  p44*/
  {PART_FW_LPM3_B,        4040*1024, 256,           UFS_PART_3},/* mcuimage        256K   p45*/
  {PART_RESERVED3_B,      4137216,   7936,          UFS_PART_3},/* reserved3A      7936KB p46*/
  {PART_FASTBOOT_B,       4048*1024, 12*1024,       UFS_PART_3},/* fastboot        12M    p47*/
  {PART_VECTOR_B,         4060*1024, 4*1024,        UFS_PART_3},/* avs vector      4M     p48*/
  {PART_ISP_BOOT_B,       4064*1024, 2*1024,        UFS_PART_3},/* isp_boot        2M     p49*/
  {PART_ISP_FIRMWARE_B,   4066*1024, 14*1024,       UFS_PART_3},/* isp_firmware    14M    p50*/
  {PART_FW_HIFI_B,        4080*1024, 12*1024,       UFS_PART_3},/* hifi            12M    p51*/
  {PART_TEEOS_B,          4092*1024, 8*1024,        UFS_PART_3},/* teeos           8M     p52*/
  {PART_RECOVERY2_B,      4100*1024, 64*1024,       UFS_PART_3},/* recovery2       64M    p53*/
  {PART_SENSORHUB_B,      4164*1024, 16*1024,       UFS_PART_3},/* sensorhub       16M    p54*/
  {PART_BOOT_B,           4180*1024, 32*1024,       UFS_PART_3},/* boot            32M    p55*/
  {PART_RECOVERY_B,       4212*1024, 64*1024,       UFS_PART_3},/* recovery        64M    p56*/
  {PART_DTS_B,            4276*1024, 16*1024,       UFS_PART_3},/* dtimage         16M    p57*/
  {PART_TRUSTFIRMWARE_B,  4292*1024, 2*1024,        UFS_PART_3},/* trustfirmware   2M     p58*/
  {PART_MODEM_FW_B,       4294*1024, 56*1024,       UFS_PART_3},/* modem_fw        56M    p59*/
  {PART_RESERVED4_B,      4350*1024, 49*1024,       UFS_PART_3},/* reserved4B      49M    p60*/
  {PART_DDR_PARA_B,       4399*1024,  1*1024,       UFS_PART_3},/* DDR_PARA        1M    p61*/
  {PART_MODEMNVM_UPDATE_B,4400*1024, 80*1024,       UFS_PART_3},/* modemnvm update 80M    p62*/
  {PART_ISP_DTS_B,        4480*1024, 16*1024,       UFS_PART_3},/* isp_dts         16M    p63*/
  {PART_VERSION_B,        4496*1024, 8*1024,        UFS_PART_3},/* version         8M     p64*/
  {PART_VENDOR_B,         4504*1024, 352*1024,      UFS_PART_3},/* vendor          352M   p65*/
  {PART_PRODUCT_B,        4856*1024, 120*1024,      UFS_PART_3},/* product         120M   p66*/
  {PART_CUST_B,           4976*1024, 128*1024,      UFS_PART_3},/* cust            128M   p67*/
  {PART_SYSTEM_B,         5104*1024, 2640*1024,     UFS_PART_3},/* system          2640M  p68*/
  {PART_RESERVED5,        7744*1024, 64*1024,       UFS_PART_3},/* reserved5       64M    p69*/
  {PART_USERDATA,         7808*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p70*/
  #endif
  {"0", 0, 0, 0},
};
#endif
