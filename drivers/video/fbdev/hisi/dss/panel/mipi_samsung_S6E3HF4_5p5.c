...
#if 0
	{DTYPE_DCS_WRITE, 0, 10, WAIT_TYPE_MS,  //28
		sizeof(display_off), display_off},
	{DTYPE_DCS_WRITE, 0, 125, WAIT_TYPE_MS,  //10
...
#if 0
		/*4. VR Brightness Setting*/
		mipi_dsi_cmds_tx(vr_brightness_cmds,
			ARRAY_SIZE(vr_brightness_cmds), hisifd->mipi_dsi0_base);
#endif
...
#if 0
		/*4. Normal Brightness Setting*/
		mipi_dsi_cmds_tx(normal_brightness_cmds,
			ARRAY_SIZE(normal_brightness_cmds), hisifd->mipi_dsi0_base);
#endif
		msleep(200);
