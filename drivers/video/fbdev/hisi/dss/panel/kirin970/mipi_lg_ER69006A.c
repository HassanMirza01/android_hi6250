...
**
*/
static int mipi_lg_ER69006A_panel_set_fastboot(struct platform_device *pdev)
{
...
static int mipi_lg_ER69006A_panel_on(struct platform_device *pdev)
{
	struct hisi_fb_data_type *hisifd = NULL;
	...
	if (pinfo->lcd_init_step == LCD_INIT_POWER_ON) {
		...
		power_status = inp32(mipi_dsi0_base + MIPIDSI_CMD_PKT_STATUS_OFFSET);
...
static int mipi_lg_ER69006A_panel_off(struct platform_device *pdev)
{
	struct hisi_fb_data_type *hisifd = NULL;
	struct hisi_panel_info *pinfo = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static int mipi_lg_ER69006A_panel_remove(struct platform_device *pdev)
{
	struct hisi_fb_data_type *hisifd = NULL;
...
static int mipi_lg_ER69006A_panel_set_backlight(struct platform_device *pdev, uint32_t bl_level)
{
	int ret = 0;
	char __iomem *mipi_dsi0_base = NULL;
	struct hisi_fb_data_type *hisifd = NULL;
...
static int mipi_lg_ER69006A_panel_set_display_region(struct platform_device *pdev,
...
/******************************************************************************/
static ssize_t mipi_lg_ER69006A_panel_lcd_model_show(struct platform_device *pdev,
	char *buf)
{
	struct hisi_fb_data_type *hisifd = NULL;
	ssize_t ret = 0;
	...
	ret = snprintf(buf, PAGE_SIZE, "LG_eR69006A 6' CMD TFT Boston\n");
...
static ssize_t mipi_lg_ER69006A_panel_lcd_check_reg_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static struct hisi_fb_panel_data g_panel_data = {
	...
	.set_fastboot = mipi_lg_ER69006A_panel_set_fastboot,
	.on = mipi_lg_ER69006A_panel_on,
	.off = mipi_lg_ER69006A_panel_off,
	.remove = mipi_lg_ER69006A_panel_remove,
	.set_backlight = mipi_lg_ER69006A_panel_set_backlight,
	.set_display_region = mipi_lg_ER69006A_panel_set_display_region,

	.lcd_model_show = mipi_lg_ER69006A_panel_lcd_model_show,
	.lcd_check_reg  = mipi_lg_ER69006A_panel_lcd_check_reg_show,
};

/*******************************************************************************
**
*/
static int mipi_lg_ER69006A_probe(struct platform_device *pdev)
{
	int ret = 0;
	struct hisi_panel_info *pinfo = NULL;
	...
	if (g_lcd_fpga_flag == 1) {
		...
		gpio_lcd_vcc3v1 = of_get_named_gpio(np, "gpios", 5);
	...
	HISI_FB_DEBUG("vsp=%d, vsn=%d, reset=%d, bl_enable=%d, vcc3v1=%d, vcc1v8=%d!\n",
		 gpio_lcd_p5v5_enable, gpio_lcd_n5v5_enable, gpio_lcd_reset, gpio_lcd_bl_enable, gpio_lcd_vcc3v1,gpio_lcd_vcc1v8);
