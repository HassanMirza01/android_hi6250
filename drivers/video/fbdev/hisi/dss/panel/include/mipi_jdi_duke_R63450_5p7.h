...
#define SENCE_ARRAY_SIZE 2
static char lcd_cmd_now[LCD_CMD_NAME_MAX] = {0};

static char *sence_array[SENCE_ARRAY_SIZE] = {"RUNNINGTEST10","BL_OPEN_SHORT",
};

static char *cmd_array[SENCE_ARRAY_SIZE] = {"BL_OPEN_SHORT","/sys/class/lm36923/lm36923/self_test",
};
