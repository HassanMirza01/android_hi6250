...
#endif
extern void kirin_pcie_pm_control(int resume_flag, u32 rc_idx);
...
#ifdef MSM_PCIE_LINKDOWN_RECOVERY || CONFIG_ARCH_HISI
				bus->islinkdown = TRUE;
#endif /* MSM_PCIE_LINKDOWN_RECOVERY || CONFIG_ARCH_HISI*/
				bus->dhd->d3ackcnt_timeout = 0;
