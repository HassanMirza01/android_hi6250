...
/* 新增PID 添加到reserved位置，并将reserved删除 */
    ...
    DEFINE_PID(I0_WUEPS_PID_BACKOFF)        /* = 155 */
    DEFINE_PID(I1_WUEPS_PID_BACKOFF)        /* = 156 */
    ...
    DEFINE_PID(I2_WUEPS_PID_BACKOFF)        /* = 250 */
...
#define WUEPS_PID_BACKOFF   I1_WUEPS_PID_BACKOFF
...
#define WUEPS_PID_BACKOFF   I2_WUEPS_PID_BACKOFF
...
#define WUEPS_PID_BACKOFF   I0_WUEPS_PID_BACKOFF
#define WUEPS_PID_WRR   I0_WUEPS_PID_WRR
#define WUEPS_PID_WCOM  I0_WUEPS_PID_WCOM
