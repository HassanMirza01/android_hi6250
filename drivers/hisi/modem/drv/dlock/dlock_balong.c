...
/*************************************************************************
 函 数 名	: dlock_bus_state_free
 功能描述	: 释放前面申请的bus_state、bus_dlock_info空间
 输入参数	: u32 i
 返 回 值	: 无
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_bus_dlock_free
 功能描述	: 释放前面申请的bus_state、bus_dlock_info、mst_port_info、mst_id_info空间
 输入参数	: u32 i
 返 回 值	: 无
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_get_axi_gm_master
 功能描述	: 获取axi_glb、axi_mdm总线端口号、mst_id对应的mst_name
 输入参数	: u32 mst_port
              u32 i
              const char *mst_name
 返 回 值	:
...
/*************************************************************************
 函 数 名	: dlock_get_fbp_master
 功能描述	: 获取axi_fast、axi_bbphy、axi_pcie总线端口号对应的mst_name
 输入参数	: u32 mst_port
              u32 i
              const char *mst_name
 返 回 值	:
...
/*************************************************************************
 函 数 名	: dlock_master_match
 功能描述	: 根据bus_name匹配对应的总线，获取对应的mst_name
 输入参数	: char *bus_name
              u32 mst_port
              u32 i
              const char *mst_name
...
/*************************************************************************
 函 数 名	: dlock_sysctrl_reset
 功能描述	: 配置V7R22版本复位寄存器，清除残留dlock状态
 输入参数	:
 返 回 值	:
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_sysctrl_unreset
 功能描述	: 配置V7R22版本复位寄存器为解复位状态
 输入参数	:
 返 回 值	:
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_get_reset_reg
 功能描述	: 获取复位寄存器、死锁计数分频系数寄存器
 输入参数	:
 返 回 值	:
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_axi_pub_info
 功能描述	: 读取锁死总线mst端口号、slv端口号、读写指示寄存器
 输入参数	: struct device_node *dev
              u32 i
 返 回 值	: 成功返回0，失败返回-1
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_axi_gm_info
 功能描述	: 获取axi_glb、axi_mdm总线所有锁死相关寄存器信息
 输入参数	: const char *node_name
              u32 i
 返 回 值	: 成功返回0，失败返回-1
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_get_fbp_info
 功能描述	: 获取axi_fast、axi_bbphy、axi_pcie总线所有锁死相关寄存器信息
 输入参数	: const char *node_name
              u32 i
 返 回 值	: 成功返回0，失败返回-1
 修改历史	:
...
/*************************************************************************
 函 数 名	: dlock_bus_match
 功能描述	: 根据bus_name匹配对应的总线，获取对应总线锁死寄存器信息
 输入参数	: char *bus_name
              u32 i
 返 回 值	:
 修改历史	:
...
/*************************************************************************
 函 数 名	: dlock_get_bus_state_reg
 功能描述	: 读取总线锁死状态寄存器基址、偏移、起始位、终止位以及对应bus_name
 输入参数	:
 返 回 值	: 成功返回0，失败返回-1
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: bsp_dlock_reset_cb
 功能描述	: 对于Chicago版本，modem复位后enable irq
 输入参数	: 无
 返 回 值	: 成功返回0，失败返回-1
 修改历史	:
 日    期	: 2016年6月10日
...
/*************************************************************************
 函 数 名	: dlock_int_handler
 功能描述	: 中断处理函数,在A核串口打印信息，并复位
 输入参数	: 无
