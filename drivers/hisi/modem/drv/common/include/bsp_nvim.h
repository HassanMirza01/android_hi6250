...
#define NV_FILE_CTRL_CRC_MARK     ((((struct nv_ctrl_file_info_stru*)NV_GLOBAL_CTRL_INFO_ADDR)->crc_mark)&NV_CTRL_CTRL_CRC)
#define NV_FILE_CRC_MARK          ((((struct nv_ctrl_file_info_stru*)NV_GLOBAL_CTRL_INFO_ADDR))->crc_mark)
