...
)
{
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpPrimPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstPdpEntity->stIpv6Dhcp.aucPrimPcscfAddr,
                   sizeof(pstPdpEntity->stIpv6Dhcp.aucPrimPcscfAddr),
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpSecPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstPdpEntity->stIpv6Dhcp.aucSecPcscfAddr,
                   sizeof(pstPdpEntity->stIpv6Dhcp.aucSecPcscfAddr),
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpThiPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstPdpEntity->stIpv6Dhcp.aucThiPcscfAddr,
                   sizeof(pstPdpEntity->stIpv6Dhcp.aucThiPcscfAddr),
...
)
{
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpPrimPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstCallEntity->stIpv6DhcpInfo.aucPrimPcscfAddr,
                   sizeof(pstCallEntity->stIpv6DhcpInfo.aucPrimPcscfAddr),
                   pstEvent->stIpv6Pcscf.aucPrimPcscfAddr,
                   TAF_IPV6_ADDR_LEN);
    }
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpSecPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstCallEntity->stIpv6DhcpInfo.aucSecPcscfAddr,
                   sizeof(pstCallEntity->stIpv6DhcpInfo.aucSecPcscfAddr),
                   pstEvent->stIpv6Pcscf.aucSecPcscfAddr,
                   TAF_IPV6_ADDR_LEN);
    }
    ...
    if (VOS_TRUE == pstEvent->stIpv6Pcscf.bitOpThiPcscfAddr)
    {
        ...
        TAF_MEM_CPY_S(pstCallEntity->stIpv6DhcpInfo.aucThiPcscfAddr,
                   sizeof(pstCallEntity->stIpv6DhcpInfo.aucThiPcscfAddr),
                   pstEvent->stIpv6Pcscf.aucThiPcscfAddr,
                   TAF_IPV6_ADDR_LEN);
    }
