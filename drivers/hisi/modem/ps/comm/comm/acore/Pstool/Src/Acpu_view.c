...
void AcpuView_Dump(ACPU_UINT32 ulDumpMode)
{
    ...
    */
    ...
    if (CPU_VIEW_DUMP_GEN_MODE_FLASH == ulDumpMode)    /* 输出到FLASH */
    {
        ...
        (VOS_VOID)VOS_nsprintf_s(acDumpFileName, sizeof(acDumpFileName), strlen("/data/hisi_logs/ap_log/coredump/AcpuView255.dump") + 1, "/data/hisi_logs/ap_log/coredump/AcpuView%d.dump", s_ucDumpFileNO);
