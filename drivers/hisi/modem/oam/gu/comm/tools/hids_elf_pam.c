...
{
    VOS_MSG_HEADER
    TAF_XPDS_MNTN_MSG_ID_ENUM_UINT32                        enMsgId;
    VOS_UINT32                                              ulModuleId;
    TAF_XPDS_FSM_ID_ENUM_UINT32                             ulCurFsmId;
    union
    {
        TAF_XPDS_L1_STA_ENUM_UINT32                         enL1MainState;
        TAF_XPDS_LINK_CTRL_SUBSTA_ENUM_UINT32               enL2LinkState;
        TAF_XPDS_CP_LINK_Ctrl_SUBSTA_ENUM_UINT32            enL2CpLinkState;
        TAF_XPDS_L2_MPC_PROC_STA_ENUM_UINT32                enL2MpcState;
        TAF_XPDS_L2_PDE_PROC_STA_ENUM_UINT32                enL2PdeState;
        TAF_XPDS_CP_L2_PDE_PROC_STA_ENUM_UINT32             enL2CpPdeState;
    }unCurFsmState;
}TAF_XPDS_ELF_MNTN_LOG_FSM_INFO_STRU;


/*****************************************************************************
 结构名    : TAF_XSMS_ELF_INT_3RD_PARTY_ERR_STRU
 结构说明  :
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : TAF_XSMS_ELF_INT_CUR_MO_FSM_STRU
 结构说明  : 当前MO STATE的状态
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : TAF_XSMS_ELF_INT_CUR_MT_FSM_STRU
 结构说明  : 当前MT STATE的状态
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : TAF_XSMS_ELF_INT_SMS_CONTENT_STRU
 结构说明  : 短信发送或者接收的数据结构
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : TAF_XSMS_ELF_INT_TL_ACK_STRU
...
int pam_main()
{
    ...
    enum SI_PIH_SIM_STATE_ENUM                          enSI_PIH_SIM_STATE_ENUM;
    enum SI_PIH_UICCAUTH_ENUM                           enSI_PIH_UICCAUTH_ENUM;
    enum SI_PIH_UICCAPP_ENUM                            enSI_PIH_UICCAPP_ENUM;
    enum SI_PIH_ACCESSTYPE_ENUM                         enSI_PIH_ACCESSTYPE_ENUM;
    enum SI_PIH_CARD_SLOT_ENUM                          enSI_PIH_CARD_SLOT_ENUM;
    enum SI_PB_TYPE_ENUM                                enSI_PB_TYPE_ENUM;
    ...
    /*XPDS AT*/
    enum AT_XPDS_MSG_TYPE_ENUM                          enAT_XPDS_MSG_TYPE_ENUM;
    ...
    enum TAF_XPDS_GPS_START_MODE_ENUM                   enTAF_XPDS_GPS_START_MODE_ENUM;
    ...
    enum TAF_XPDS_MNTN_MSG_ID_ENUM                      enTAF_XPDS_MNTN_MSG_ID_ENUM;
    enum TAF_XPDS_FSM_ID_ENUM                           enTAF_XPDS_FSM_ID_ENUM;
    enum TAF_XPDS_L1_STA_ENUM                           enTAF_XPDS_L1_STA_ENUM;
    enum TAF_XPDS_LINK_CTRL_SUBSTA_ENUM                 enTAF_XPDS_LINK_CTRL_SUBSTA_ENUM;
    enum TAF_XPDS_CP_LINK_Ctrl_SUBSTA_ENUM              enTAF_XPDS_CP_LINK_Ctrl_SUBSTA_ENUM;
    enum TAF_XPDS_L2_MPC_PROC_STA_ENUM                  enTAF_XPDS_L2_MPC_PROC_STA_ENUM;
    enum TAF_XPDS_L2_PDE_PROC_STA_ENUM                  enTAF_XPDS_L2_PDE_PROC_STA_ENUM;
    enum TAF_XPDS_CP_L2_PDE_PROC_STA_ENUM               enTAF_XPDS_CP_L2_PDE_PROC_STA_ENUM;
    enum TAF_XPDS_RL_MSGTYPE_REQ_ENUM                   enTAF_XPDS_RL_MSGTYPE_REQ_ENUM;
    enum TAF_XPDS_RL_MSGTYPE_RESP_ENUM                  enTAF_XPDS_RL_MSGTYPE_RESP_ENU;
    enum TAF_XPDS_MS_TO_MPC_MSG_TYPE_ENUM               enTAF_XPDS_MS_TO_MPC_MSG_TYPE_ENUM;
    enum TAF_XPDS_MS_POS_CAPABILITY_ENUM                enTAF_XPDS_MS_POS_CAPABILITY_ENUM;
    enum TAF_XPDS_APP_TYPE_INDICATOR_ENUM               enTAF_XPDS_APP_TYPE_INDICATOR_ENUM;
    enum TAF_XPDS_RL_REJ_REASON_ENUM                    enTAF_XPDS_RL_REJ_REASON_ENUM;

    /* OM XPDS */
    enum NAS_OM_CDMA_GPS_FIX_RSLT_ENUM                  enNAS_OM_CDMA_GPS_FIX_RSLT_ENUM;
    enum NAS_OM_CDMA_GPS_FIX_MODE_ENUM                  enNAS_OM_CDMA_GPS_FIX_MODE_ENUM;
    enum NAS_OM_CDMA_GPS_START_MODE_ENUM                enNAS_OM_CDMA_GPS_START_MODE_ENUM;
    enum NAS_OM_CDMA_GPS_FIX_TYPE_ENUM                  enNAS_OM_CDMA_GPS_FIX_TYPE_ENUM;
    enum NAS_OM_CDMA_GPS_SIGNAL_MSG_TYPE_ENUM           enNAS_OM_CDMA_GPS_SIGNAL_MSG_TYPE_ENUM;
    ...
    enum CNAS_HSD_REACQ_FALG_ENUM                       enCNAS_HSD_REACQ_FALG_ENUM;
    enum CNAS_PRL_BAND_CLASS_ENUM                       enCNAS_PRL_BAND_CLASS_ENUM;
    enum CNAS_HSD_FREQ_TYPE_INDICATION_ENUM             enCNAS_HSD_FREQ_TYPE_INDICATION_ENUM;
    enum CNAS_HSD_AVOID_REASON_ENUM                     enCNAS_HSD_AVOID_REASON_ENUM;
    ...
    USIMM_CARDSCIERR_IND_STRU usimm_cardtimeoutind_stru;
#if (FEATURE_ON == FEATURE_UE_MODE_CDMA)
    ...
    /* XSMS XSMS */
    TAF_XSMS_ELF_INT_3RD_PARTY_ERR_STRU taf_xsms_int_3rd_party_err_stru;
    TAF_XSMS_ELF_INT_CUR_MO_FSM_STRU taf_xsms_int_cur_mo_fsm_stru;
    ...
    AT_XPDS_GPS_QRY_REFLOC_INFO_REQ_STRU at_xpds_gps_qry_refloc_info_req_stru;
    ...
    AT_XPDS_GPS_STOP_REQ_STRU at_xpds_gps_stop_req_stru;
    ...
    XPDS_AT_GPS_START_REQ_STRU xpds_at_gps_start_req_stru;
    ...
    AT_XPDS_MSG_STRU at_xpds_msg_stru;
    XPDS_AT_UTS_GPS_POS_INFO_IND_STRU xpds_at_uts_gps_pos_info_ind_stru;
    XPDS_AT_GPS_OM_TEST_START_REQ_STRU xpds_at_gps_om_test_start_req_stru;
    XPDS_AT_GPS_OM_TEST_STOP_REQ_STRU xpds_at_gps_om_test_stop_req_stru;
    ...
    TAF_XPDS_ELF_MNTN_LOG_FSM_INFO_STRU  taf_xpds_elf_mntn_log_fsm_info_stru;
    TAF_XPDS_MNTN_SESSION_BEGIN_IND_STRU taf_xpds_mntn_session_begin_ind_stru;
    TAF_XPDS_MNTN_SESSION_END_IND_STRU   taf_xpds_mntn_session_end_ind_stru;
    TAF_XPDS_MNTN_REVERSE_MSG_INFO_IND_STRU taf_xpds_mntn_reverse_msg_info_ind_stru;
    TAF_XPDS_MNTN_FORWARD_MSG_INFO_IND_STRU taf_xpds_mntn_forward_msg_info_ind_stru;
    TAF_XPDS_MNTN_PILOT_INFO_STRU           taf_xpds_mntn_pilot_info_stru;
    TAF_XPDS_MNTN_PILOT_INFO_CTX_IND_STRU   taf_xpds_mntn_pilot_info_ctx_ind_stru;
    TAF_XPDS_MNTN_PSEU_RANGE_INFO_CTX_IND_STRU taf_xpds_mntn_pseu_range_info_ctx_ind_stru;
    TAF_XPDS_MNTN_ASSIST_DATA_CTX_IND_STRU taf_xpds_mntn_assist_data_ctx_ind_stru;
    TAF_XPDS_MNTN_POS_INFO_CTX_IND_STRU taf_xpds_mntn_pos_info_ctx_ind_stru;
    TAF_XPDS_MNTN_EPH_INFO_CTX_IND_STRU taf_xpds_mntn_eph_info_ctx_ind_stru;
    TAF_XPDS_MNTN_ALM_INFO_CTX_IND_STRU taf_xpds_mntn_alm_info_ctx_ind_stru;
    TAF_XPDS_MNTN_FORWARD_PDE_MSG_HEADER_IND_STRU_STRU taf_xpds_mntn_forward_pde_msg_header_ind_stru_stru;
    TAF_XPDS_MNTN_REVERSE_PDE_MSG_HEADER_IND_STRU_STRU taf_xpds_mntn_reverse_pde_msg_header_ind_stru_stru;
    TAF_XPDS_MNTN_REVERSE_START_DELIVER_DATA_IND_STRU_STRU taf_xpds_mntn_reverse_start_deliver_data_ind_stru_stru;
    ...
    NAS_OM_CDMA_START_GPS_FIX_CNF_STRU nas_om_cdma_start_gps_fix_cnf_stru;
    OM_NAS_CDMA_STOP_GPS_FIX_REQ_STRU  om_nas_cdma_stop_gps_fix_req_stru;
    NAS_OM_CDMA_STOP_GPS_FIX_CNF_STRU  nas_om_cdma_stop_gps_fix_cnf_stru;
    NAS_OM_CDMA_GPS_UTC_TIME_STRU      nas_om_cdma_gps_utc_time_stru;
    NAS_OM_CDMA_GPS_POS_INFO_STRU      nas_om_cdma_gps_pos_info_stru;
    NAS_OM_CDMA_GPS_FIX_RSLT_IND_STRU  nas_om_cdma_gps_fix_rslt_ind_stru;
    NAS_OM_CDMA_GPS_SIGNAL_MSG_IND_STRU nas_om_cdma_gps_signal_msg_ind_stru;
    NAS_OM_CDMA_GPS_FIX_START_IND_STRU  nas_om_cdma_gps_fix_start_ind_stru;
    ...
    CNAS_HSD_HSD_BG_SRCH_RSLT_CNF_STRU      cnas_hsd_hsd_bg_srch_rslt_cnf_stru;
    CNAS_HSD_HSD_INTERNAL_OOC_NTF_STRU      cnas_hsd_hsd_internal_ooc_ntf_stru;
    CNAS_HSD_HSD_OOC_NTF_RSLT_CNF_STRU      cnas_hsd_hsd_ooc_ntf_rslt_cnf_stru;
#endif
    ...
    TAF_MMA_1XCHAN_QUERY_CNF_STRU       stTAF_MMA_1XCHAN_QUERY_CNF_STRU;
    TAF_MMA_CVER_QUERY_REQ_STRU         stTAF_MMA_CVER_QUERY_REQ_STRU;
    TAF_MMA_CVER_QUERY_CNF_STRU         stTAF_MMA_CVER_QUERY_CNF_STRU;
    TAF_MMA_STATE_QUERY_REQ_STRU        stTAF_MMA_STATE_QUERY_REQ_STRU;
    TAF_MMA_STATE_QUERY_CNF_STRU        stTAF_MMA_STATE_QUERY_CNF_STRU;
    TAF_MMA_CHIGHVER_QUERY_REQ_STRU     stTAF_MMA_CHIGHVER_QUERY_REQ_STRU;
    TAF_MMA_CHIGHVER_QUERY_CNF_STRU     stTAF_MMA_CHIGHVER_QUERY_CNF_STRU;
