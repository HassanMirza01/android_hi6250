...
VOS_UINT32 VOS_GetSysTime( SYS_T *pSysTime )
{
    ...
    {
        (VOS_VOID)VOS_SetErrorNo(VOS_ERRNO_SYSTIME_GETSYST_INPUTPARAISNULL);
    ...
    if ( VOS_NULL_PTR == VOS_MemCpy_s(pSysTime, (VOS_SIZE_T)sizeof(SYS_T), pSysTimeSrc, (VOS_SIZE_T)sizeof(SYS_T)) )
    {
