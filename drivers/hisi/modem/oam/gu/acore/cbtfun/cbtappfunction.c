...
VOS_UINT32 CBT_AcpuEstablishProc(CBT_UNIFORM_MSG_STRU * pstAppToCbtMsg)
{
    ...
    /*lint -e419 -e416*/
    (VOS_VOID)VOS_MemSet(pstCbtToAppEstablish->ausReserve, 0, CBT_EST_IND_RSV_LEN);    /*预留字段，暂时赋值为全0*/
    /*lint +e419 +e416*/
...
VOS_UINT32 CBT_AcpuReleaseProc(CBT_UNIFORM_MSG_STRU * pstAppToCbtMsg)
{
    ...
    /*lint -e419 -e416*/
    (VOS_VOID)VOS_MemCpy((VOS_VOID *)(pMsg->aucValue), (VOS_VOID *)pstAppToCbtMsg, sizeof(CBT_UNIFORM_MSG_STRU) );
    /*lint +e419 +e416*/
