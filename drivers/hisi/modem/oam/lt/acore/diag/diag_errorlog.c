...
VOS_VOID OM_AcpuRcvMsgFinish(VOS_VOID)
{
    ...
    (VOS_VOID)VOS_MemSet(&stOmAppReportStatus, 0, (VOS_UINT32)(sizeof(stOmAppReportStatus)));
    ...
    VOS_MemSet(g_ucErrRptFlag,OM_MSG_RECEIVE_FLAG,(VOS_UINT32)sizeof(g_ucErrRptFlag));
    /* 防止消息再次下发不成功 */
...
VOS_VOID OM_AcpuSendAppResult(VOS_UINT32 ulRest, VOS_UINT16  usModemId)
{
    ...
    (VOS_VOID)VOS_MemSet(&stOmAppResultCnf, 0, (VOS_UINT32)sizeof(stOmAppResultCnf));
...
VOS_INT OM_AcpuReportErrLogMsg(VOS_UINT8 *pucData, VOS_UINT32 ulLen)
{
    ...
    VOS_MemSet(pstErrologModule,0,OM_PAM_LENGTH);
 ...
 //       pstErrologModule = VOS_NULL;
    ...
    VOS_MemSet(g_ucErrRptFlag,0,256);
...
VOS_VOID OM_AcpuSendFTMMsgOther(APP_OM_FTM_REQ_STRU *pstAppOmFtmReq, VOS_UINT32 ulLen, VOS_UINT32 ulPID)
{
    ...
    (VOS_VOID)VOS_MemCpy((VOS_VOID*)pstOmFtmReq->aucContent, (VOS_VOID*)pstAppOmFtmReq, ulLen);
                          ...
                          VOS_UINT8  ucAlmLevel)
{
    ...
    (VOS_VOID)VOS_MemSet(&stAppOmCtrlStatus, 0, (VOS_UINT32)sizeof(stAppOmCtrlStatus));
...
VOS_VOID OM_AcpuReportCltInfo(VOS_UINT16 modemID, VOS_UINT16 infoId, VOS_UINT32 mcc, VOS_UINT32 mnc)
{
    ...
    (VOS_VOID)VOS_MemSet(cltInfoReq, 0, allocSize);
    ...
    (VOS_VOID)OM_AcpuReadVComData(APP_VCOM_DEV_INDEX_ERRLOG, (VOS_UINT8*)cltInfoReq,allocSize);
    (VOS_VOID)VOS_MemFree(MSP_PID_DIAG_APP_AGENT, cltInfoReq);
