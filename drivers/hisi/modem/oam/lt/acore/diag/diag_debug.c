...
VOS_VOID diag_GetDFR(DIAG_DFR_INFO_STRU *pDfr)
{
    ...
    (VOS_VOID)VOS_MemCpy_s((FilePath+len), VOS_StrLen(pDfr->name), pDfr->name, VOS_StrLen(pDfr->name));
    ...
    (VOS_VOID)VOS_MemCpy_s(aucInfo, (DIAG_DEBUG_INFO_LEN-1), "DIAG DFR info", VOS_StrLen("DIAG DFR info"));
