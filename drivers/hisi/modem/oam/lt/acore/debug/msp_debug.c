...
VOS_VOID DIAG_DebugNoIndLog(VOS_VOID)
{
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_ALayerSrcModuleCfg[0], sizeof(g_ALayerSrcModuleCfg));
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_CLayerSrcModuleCfg[0], sizeof(g_CLayerSrcModuleCfg));
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_ALayerDstModuleCfg[0], sizeof(g_ALayerDstModuleCfg));
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_CLayerDstModuleCfg[0], sizeof(g_CLayerDstModuleCfg));
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_EventModuleCfg[0], sizeof(g_EventModuleCfg));
    ...
    (VOS_VOID)VOS_MemCpy((pData + offset), &g_PrintModuleCfg[0], sizeof(g_PrintModuleCfg));
