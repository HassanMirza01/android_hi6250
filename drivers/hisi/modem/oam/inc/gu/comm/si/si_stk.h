...
/*****************************************************************************
 结构名    : PFSISTKPIDMSGPROC
 结构说明  : SI_STK_PID消息处理函数指针
 1.日    期   : 2016年10月13日
   作    者   : z00377832
   修改内容   : 新增
*****************************************************************************/
...
/*****************************************************************************
 结构名    : SI_STK_PIDMSGPROC_FUNC
 结构说明  : SI_STK_PID消息处理表项定义
 1.日    期   : 2016年10月13日
   作    者   : z00377832
   修改内容   : 新增
*****************************************************************************/
...
extern VOS_VOID SI_STK_TimeOutMsgProc(PS_SI_MSG_STRU *pstMsg);
...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
extern VOS_VOID SI_STK_MmMsgProc(PS_SI_MSG_STRU *pstMsg);

extern VOS_VOID SI_STK_GmmMsgProc(PS_SI_MSG_STRU *pstMsg);

extern VOS_VOID SI_STK_MmaMsgProc(PS_SI_MSG_STRU *pstMsg);

extern VOS_VOID SI_STK_MmcMsgProc(PS_SI_MSG_STRU *pstMsg);
#endif
...
extern VOS_VOID SI_STK_StkMsgProc(PS_SI_MSG_STRU *pstMsg);
