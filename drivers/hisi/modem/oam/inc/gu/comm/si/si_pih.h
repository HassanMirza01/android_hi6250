...
#if (OSA_CPU_CCPU == VOS_OSA_CPU)
extern VOS_UINT16 SI_PIH_GetModemId(VOS_VOID);

#if (FEATURE_ON == FEATURE_PTM)
extern VOS_VOID SI_PIH_ErrLogVarInit(VOS_VOID);

extern VOS_VOID SI_PIH_UpdateCardSciErrInfo(USIMM_CMDTYPE_REQ_ENUM_UINT32 enCmdType);

extern VOS_VOID SI_PIH_CardErrorLogActiveReport(
    VOS_VOID                           *pData,
    VOS_UINT32                          ulDataLen,
    SI_PIH_ERR_LOG_ALM_ID_ENUM_UINT16   enAlmId);
...
extern VOS_UINT32 SI_PIH_CchpSetReqProc(
...
extern VOS_VOID SI_PIH_CardSciErrProc(
...
extern VOS_UINT32 SI_PIH_CchpOpenChannelReq(
    VOS_UINT32                          ulAIDLen,
    VOS_UINT8                          *pucADFName,
    VOS_UINT8                           ucAPDUP2);
...
VOS_VOID SI_PIH_VsimIccApnKeySetHandle(VOS_UINT32 ulDataLen, VOS_UINT8 *pucData, VOS_UINT32 ulModemId);

VOS_VOID SI_PIH_VsimIccFileDataSetHandle(VOS_UINT32 ulDataLen, VOS_UINT8 *pucData, VOS_UINT32 ulModemId);
