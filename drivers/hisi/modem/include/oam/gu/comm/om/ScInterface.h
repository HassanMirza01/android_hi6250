...
enum SC_ERROR_CODE_ENUM
{
    ...
    SC_ERROR_CODE_HMAC_ENCRYPT_FAIL,                /* hmac算法生成完整性签名失败(crypto_encrypt) */
    SC_ERROR_CODE_PBKDF2_ENCRYPT_FAIL,              /* PBKDF2算法加密失败(crypto_encrypt) */
...
/*****************************************************************************
 函 数 名  : SC_COMM_InitVerifyRecordImeiMem
 功能描述  : 初始化存储校验IMIE空间
 输入参数  :
