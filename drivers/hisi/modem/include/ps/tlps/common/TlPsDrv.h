...
#define LHPA_RTT_TEST_STATE          LHPA_GetRttTestState((VOS_UINT16)LPS_MODEM_ID)
#define LHPA_RTT_ERRIND_RPTFLG       LHPA_GetHpaErrIndRptFlg((VOS_UINT16)LPS_MODEM_ID)
#define LHPA_RTT_MEAS_RPTFLG         LHPA_GetHpaMeasRptFlg((VOS_UINT16)LPS_MODEM_ID)
#else
