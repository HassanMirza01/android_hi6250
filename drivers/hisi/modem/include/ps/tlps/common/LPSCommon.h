...
enum LTE_SECU_KEY_INDEX_ENUM
{
    ...
    /* DC support */
    I0_LTE_SECU_SCG_PDCP_UP_CIPHER_KEY_INDEX                      = 8,
    I0_LTE_SECU_SCG_LASTEST_PDCP_UP_CIPHER_KEY_INDEX              = 9,
    I0_LTE_SECU_SCG_LRRC_KDF_OUTPUT_INDEX                         = 10,

    /* 双LTE，modem1 */
    I1_LTE_SECU_NAS_INTEGRITY_KEY_INDEX                           = 11,
    I1_LTE_SECU_NAS_CIPHER_KEY_INDEX                              = 12,
    I1_LTE_SECU_PDCP_UP_CIPHER_KEY_INDEX                          = 13,
    I1_LTE_SECU_RRC_INTEGRITY_KEY_INDEX                           = 14,
    I1_LTE_SECU_RRC_CIPHER_KEY_INDEX                              = 15,
    I1_LTE_SECU_LASTEST_PDCP_UP_CIPHER_KEY_INDEX                  = 16,
    I1_LTE_SECU_LRRC_KDF_OUTPUT_INDEX                             = 17,
    I1_LTE_SECU_LMM_KDF_OUTPUT_INDEX                              = 18,
    /* DC support */
