...
/*****************************************************************************
 枚举名    : TAF_MMA_IMS_DOMAIN_CFG_TYPE_ENUM_UINT32
 结构说明  : IMS优选域
 1.日    期   : 2015年10月26日
   作    者   : h00360002
   修改内容   : 新建
...
/*****************************************************************************
 枚举名    : TAF_MMA_IMS_DOMAIN_CFG_RESULT_ENUM_UINT32
 结构说明  : IMS优选域设置返回结果
 1.日    期   : 2015年10月26日
   作    者   : h00360002
   修改内容   : 新建
...
/*****************************************************************************
 枚举名    : TAF_MMA_ROAM_IMS_SUPPORT_ENUM_UINT32
 结构说明  : 漫游下IMS是否支持
 1.日    期   : 2016年3月10日
   作    者   : W00316404
   修改内容   : 新建
...
/*****************************************************************************
 枚举名    : TAF_MMA_ROAM_IMS_SUPPORT_RESULT_ENUM_UINT32
 结构说明  : 漫游下IMS是否支持设置返回结果
 1.日    期   : 2016年3月10日
   作    者   : w00316404
   修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 枚举名    : TAF_MMA_IMS_REG_DOMAIN_ENUM_UNIT8
 结构说明  : IMS的注册域
 1.日    期: 2016年5月5日
   作    者: n00269697
   修改内容: 新增
...
/*****************************************************************************
枚举名    : TAF_MMA_LOC_UPDATE_STATUS_ENUM
枚举说明  : LGU+卡文件6f7e中location_update_status项枚举
  1.日    期   : 2016年07月18日
    作    者   : h00360002
    修改内容   : 新增枚举
*****************************************************************************/
...
/*****************************************************************************
 枚举名    :  TAF_MMA_COMBINED_MODE_ENUM_UINT32
 枚举说明  :  当前组合模式
 1.日    期   : 2016年4月29日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 枚举名    :  TAF_MMA_ICC_APP_TYPE_SWITCH_STATE_ENUM_UINT32
 枚举说明  :  USIM应用类型切换状态
 1.日    期   : 2016年4月29日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_MULTIMODE_RAT_CFG_STRU
 结构说明  : 用户设置的多模配置结构，支持全指示的RAT配置；modem根据卡制式，决定
             是否在CL与GUL模式之间切换；
 1.日    期   : 2016年4月29日
   作    者   : y00245242
   修改内容   : 新建
...
/* Added by s00217060 for 边境搜网优化PhaseI, 2016-8-20, begin */
/*****************************************************************************
 枚举名    : TAF_MMA_SET_BORDER_INFO_OPERATE_TYPE_ENUM
 结构说明  : 设置边境类型，0:增加 1:删除所有
  1.日    期   : 2016年9月1日
    作    者   : s00217060
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 枚举名    : TAF_MMA_LAC_TAC_TYPE_ENUM_UINT8
 结构说明  : LAC或TAC类型枚举
  1.日    期   : 2016年8月22日
    作    者   : s00217060
    修改内容   : 新建:枚举值和AT^BORDERINFO中的<BS>中的<type>对应，不能修改
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_EONS_UCS2_HNB_NAME_STRU
 结构说明  : AT^EONSUCS2 查询内容结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_CSG_SPEC_SEARCH_INFO_STRU
 结构说明  : AT与MMA AT^CSGIDSRCH命令手动搜CSG ID设置结构
...
/*****************************************************************************
结构名    : TAF_MMA_CSG_SPEC_SEARCH_REQ_STRU
结构说明  : 手动CSG搜网请求结构
...
/*****************************************************************************
结构名    : TAF_MMA_QRY_CAMP_CSG_ID_INFO_REQ_STRU
结构说明  : 查询当前驻留csg id信息消息结构
...
/*****************************************************************************
结构名    : TAF_MMA_QRY_CAMP_CSG_ID_INFO_CNF_STRU
结构说明  : 查询驻留csg id信息回复消息结构
  1.日    期   : 2015年11月16日
    作    者   : z00161729
    修改内容   : 支持LTE CSG功能新增
******************************************************************************/
...
/*****************************************************************************
结构名    : TAF_MMA_CSG_SPEC_SEARCH_CNF_STRU
结构说明  : 手动CSG搜网回复结构
  1.日    期   : 2015年11月6日
    作    者   : z00161729
    修改内容   : 支持LTE CSG功能新增
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_CALL_INFO_STRU
 结构说明  : TAF_MMA_IMS_CALL_INFO_STRU结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SMS_INFO_STRU
 结构说明  : TAF_MMA_IMS_SMS_INFO_STRU结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SS_INFO_STRU
 结构说明  : TAF_MMA_IMS_SS_INFO_STRU结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_EMC_INFO_STRU
 结构说明  : TAF_MMA_EMC_INFO_STRU结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_SRV_INFO_NOTIFY_STRU
 结构说明  : 消息ID_TAF_MMA_SRV_INFO_NOTIFY结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_STOP_SRVACQ_NOTIFY_STRU
 结构说明  : SPM通知MMA模块cellular 业务捕获定时器超时消息结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_UPDATE_TYPE_C_PDP_COUNT_NOTIFY_STRU
 结构说明  : 消息ID_TAF_MMA_UPDATE_TYPE_C_PDP_COUNT_NOTIFY结构体
...
/* Modified by s00217060 for 边境搜网优化PhaseI, 2016-9-1, begin */
/*****************************************************************************
 结构名    : TAF_MMA_PLMN_WITH_SIM_RAT_STRU
...
/* Modified by s00217060 for 边境搜网优化PhaseI, 2016-9-1, end */
...
/* Added by s00217060 for 边境搜网优化PhaseI, 2016-8-20, begin */
/*****************************************************************************
 结构名    : TAF_MMA_BORDER_INFO_STRU
 结构说明  : 边境信息结构体:包括流水号，版本号，EHPLMN列表，边境信息
  1.日    期   : 2016年8月20日
    作    者   : s00217060
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_BORDER_INFO_SET_REQ_STRU
 结构说明  : AT^BORDERINFO设置边境信息请求消息
  1.日    期   : 2016年8月20日
    作    者   : s00217060
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_BORDER_INFO_SET_CNF_STRU
 结构说明  : ID_TAF_MMA_BORDER_INFO_SET_CNF的结构体
  1.日    期   : 2016年8月24日
    作    者   : s00217060
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
结构名    : TAF_MMA_BORDER_INFO_QRY_REQ_STRU
结构说明  : ID_TAF_MMA_BORDER_INFO_QRY_REQ消息的结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_BORDER_INFO_QRY_CNF_STRU
 结构说明  : ID_TAF_MMA_BORDER_INFO_QRY_CNF消息的结构体
  1.日    期   : 2016年8月24日
    作    者   : s00217060
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
结构名    : TAF_MMA_IMSI_REFRESH_IND_STRU
结构说明  : IMSI Refresh时主动上报结构体
...
/*****************************************************************************
结构名    : TAF_MMA_RESET_NTF_STRU
结构说明  : 平台能力设置失败后，由A核通知C核进行复位
...
/*****************************************************************************
 结构名    : TAF_MMA_ROAMING_MODE_SWITCH_IND_STRU
 结构说明  : 国际漫游模式切换指示
 1.日    期   : 2016年01月19日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_CCTC_ROAMING_NW_INFO_REPORT_IND_STRU
 结构说明  : 多模MCC或SID变更指示
 1.日    期   : 2016年01月20日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_CCTC_ROAMING_NW_INFO_QRY_REQ_STRU
 结构说明  : 多模MCC或SID查询请求
 1.日    期   : 2016年01月20日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_CCTC_ROAMING_NW_INFO_QRY_CNF_STRU
 结构说明  : 多模MCC或SID查询请求
 1.日    期   : 2016年01月20日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_CTCC_OOS_COUNT_SET_REQ_STRU
 结构说明  : 设置中国电信OOS次数请求结构
 1.日    期   : 2016年02月15日
   作    者   : w00242748
   修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_CTCC_OOS_COUNT_SET_CNF_STRU
 结构说明  : ID_TAF_MMA_CTCC_OOS_COUNT_SET_CNF的结构体
  1.日    期   : 2016年2月15日
    作    者   : w00242748
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_DOMAIN_CFG_SET_REQ_STRU
 结构说明  : IMS注册域偏好设置信息结构体
  1.日    期   : 2015年10月26日
    作    者   : h00360002
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_DOMAIN_CFG_QRY_REQ_STRU
 结构说明  : IMS注册域偏好查询信息结构体
  1.日    期   : 2015年10月26日
    作    者   : h00360002
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_DOMAIN_CFG_SET_CNF_STRU
 结构说明  : IMS注册域偏好设置返回消息结构体
  1.日    期   : 2015年10月26日
    作    者   : h00360002
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_DOMAIN_CFG_QRY_CNF_STRU
 结构说明  : IMS注册域偏好查询返回消息结构体
  1.日    期   : 2015年10月26日
    作    者   : h00360002
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_ROAM_IMS_SUPPORT_SET_REQ_STRU
 结构说明  : 设置漫游下IMS服务是否支持结构
...
/*****************************************************************************
 结构名    : TAF_MMA_ROAM_IMS_SUPPORT_SET_CNF_STRU
 结构说明  : 漫游下IMS是否支持设置返回消息结构体
  1.日    期   : 2016年3月10日
    作    者   : w00316404
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_PRLID_QRY_REQ_STRU
 结构说明  : 查询PRLID ,MLPL version id, MSPL version id消息结构体
  1.日    期   : 2016年3月10日
    作    者   : w00316404
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_PRLID_QRY_CNF_STRU
 结构说明  : 查询PRLID ,MLPL version id, MSPL version id CNF 消息结构体
  1.日    期   : 2016年3月10日
    作    者   : w00316404
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_EFLOCIINFO_STRU
 结构说明  : LGU+6f7e卡文件信息结构体
...
/*****************************************************************************
 结构名    : AT_MTA_EFPSLOCIINFO_REQ_STRU
 结构说明  : LGU+6f73卡文件信息结构体
...
/*****************************************************************************
 结构名    : TAF_MMA_EFLOCIINFO_SET_REQ_STRU
 结构说明  : LGU+6f7e卡文件设置请求
...
/*****************************************************************************
 结构名    : TAF_MMA_EFLOCIINFO_SET_CNF_STRU
 结构说明  : LGU+6f7e卡文件设置请求回复
...
/*****************************************************************************
 结构名    : TAF_MMA_EFLOCIINFO_QRY_REQ_STRU
 结构说明  : LGU+6f7e卡文件查询请求
...
/*****************************************************************************
 结构名    : TAF_MMA_EFLOCIINFO_QRY_CNF_STRU
 结构说明  : LGU+6f7e卡文件查询请求回复
...
/*****************************************************************************
 结构名    : TAF_MMA_EFPSLOCIINFO_SET_REQ_STRU
 结构说明  : LGU+6f73卡文件设置请求
...
/*****************************************************************************
 结构名    : TAF_MMA_EFPSLOCIINFO_SET_CNF_STRU
 结构说明  : LGU+6f73卡文件设置请求回复
...
/*****************************************************************************
 结构名    : TAF_MMA_EFPSLOCIINFO_QRY_REQ_STRU
 结构说明  : LGU+6f73卡文件查询请求
...
/*****************************************************************************
 结构名    : TAF_MMA_EFPSLOCIINFO_QRY_CNF_STRU
 结构说明  : LGU+6f73卡文件查询请求回复
...
/*****************************************************************************
 结构名    : TAF_MMA_COMBINED_MODE_SWITCH_IND_STRU
 结构说明  : 多模组合模式切换指示
 1.日    期   : 2016年04月29日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_RAT_COMBINED_MODE_QRY_REQ_STRU
 结构说明  : 查询多模组合的当前模式消息结构体
 1.日    期   : 2016年07月18日
   作    者   : l00359089
   修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_RAT_COMBINED_MODE_QRY_CNF_STRU
 结构说明  : 查询多模组合的当前模式消息结构体 CNF 消息结构体
  1.日    期   : 2016年07月18日
    作    者   : l00359089
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_ICC_APP_TYPE_SWITCH_IND_STRU
 结构说明  : ICC应用类型切换指示
 1.日    期   : 2016年07月01日
   作    者   : y00245242
   修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_SRV_END_NOTIFY_STRU
 结构说明  : 通知mma 业务结束消息结构体
 1.日    期   : 2016年07月05日
   作    者   : c00299063
   修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_REG_DOMAIN_NOTIFY_STRU
 结构说明  : IMS REG DOMAIN通知消息结构体
  1.日    期   : 2016年5月4日
    作    者   : n00269697
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_PACSP_QRY_REQ_STRU
 结构说明  : 查询ENS是否支持
...
/*****************************************************************************
 结构名    : TAF_MMA_PACSP_QRY_CNF_STRU
 结构说明  : 查询ENS是否支持的回复
...
/*****************************************************************************
 结构名    : TAF_MMA_SMC_NO_ENTITY_NOTIFY_STRU
 结构说明  : ID_TAF_MMA_SMC_NO_ENTITY_NOTIFY消息结构体
  1.日    期   : 2016年5月4日
    作    者   : n00269697
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SMS_CFG_SET_REQ_STRU
 结构说明  : IMS短信能力设置信息结构体
  1.日    期   : 2016年10月31日
    作    者   : m00217266
    修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SMS_CFG_QRY_REQ_STRU
 结构说明  : IMS短信能力查询信息结构体
  1.日    期   : 2016年10月31日
    作    者   : m00217266
    修改内容   : 新建
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SMS_CFG_SET_CNF_STRU
 结构说明  : IMS短信能力设置返回消息结构体
  1.日    期   : 2016年10月31日
    作    者   : m00217266
    修改内容   : 新建
*****************************************************************************/
...
/*****************************************************************************
 结构名    : TAF_MMA_IMS_SMS_CFG_QRY_CNF_STRU
 结构说明  : IMS短信能力查询返回消息结构体
  1.日    期   : 2016年10月31日
    作    者   : m00217266
    修改内容   : 新建
*****************************************************************************/
