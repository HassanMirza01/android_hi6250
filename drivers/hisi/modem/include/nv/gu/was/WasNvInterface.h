...
#define WAS_NV_ERACH_BROKEN_CELL_N_FAIL               (1)                       /* 加入Erach BrokenCell列表中得小区的RRMM_EST_REQ的默认值 */
#define WAS_NV_ERACH_BROKEN_CELL_MAX_BAR_LEN          (300)                     /* 加入Erach BrokenCell列表中得小区的最长Bar时间，单位秒 */
#define WAS_NV_ERACH_BROKEN_CELL_INIT_BAR_LEN         (60)                      /* 加入Erach BrokenCell列表中得小区的初始Bar时间，单位秒 */
#define WAS_NV_ERACH_BROKEN_CELL_RSCP_HIGH_THRESH     (-80)                     /* 加入Erach BrokenCell列表中得小区是高质量小区的门限 */
#define WAS_NV_ERACH_BROKEN_CELL_ECN0_THRESH          (-12)                     /* Erach BrokenCell列表中的小区能量好于次门限才可能退出bar列表 */

#define WAS_NV_ERACH_BROKEN_CELL_RSCP_OFFSET          (15)                      /* 加入Erach BrokenCell中得小区能量变好放出bar列表的门限 */
#define WAS_NV_ERACH_BROKEN_CELL_MIN_RSCP_OFFSET      (10)                      /* 加入Erach BrokenCell中得小区能量变好放出bar列表的最小门限 */

#define WAS_NV_DEFAULT_CQQUALMIN                (-18)
#define WAS_NV_DEFAULT_CQRXLEVMIN               (-110)
#define WAS_NV_MAX_ATT_PLMN_NUM                 16
#define WAS_NV_CELLULAR_PREFER_HIGH_THRESH             (-60)                    /* CELLULAR_PREFER 默认High RSCP 门限，单位是dbm */
#define WAS_NV_CELLULAR_PREFER_LOW_THRESH              (-85)                    /* CELLULAR_PREFER 默认Low RSCP 门限，单位是dbm */
#define WAS_NV_CELLULAR_PREFER_OFFSET                  (5)                      /* CELLULAR_PREFER 默认Offset，单位是dbm */
#define WAS_NV_CELLULAR_PREFER_TEVALUATION             (5000)                   /* CELLULAR_PREFER 默认评估时间，单位是ms */
#define WAS_NV_CELLULAR_PREFER_MIN_TEVALUATION         (1000)                   /* CELLULAR_PREFER 默认评估最小时间，单位是ms */
...
enum WAS_NETWORK_SEARCH_PROGRESS_ENUM
{
    ...
    WAS_NETWORK_SEARCH_PROGRESS_PLMN_LIST_SRCH                 = 0x00008000,   /* bit15:主模或者从模下的PLMN LIST搜网 */
    WAS_NETWORK_SEARCH_PROGRESS_ANY_CELL_SRCH                  = 0x00010000,   /* bit16:主模或者从模下的ANY CELL搜网 */
...
/*****************************************************************************
 枚 举 名  : WAS_CS_NOT_RCV_SPEC_SIB_ENUM
 枚举说明  : cs过程中不接受部分系统消息的bitmap
 修改历史  :
  1.日  期   : 2016年10月10日
    作  者   : w00380530
    修改内容 : 新生成结构
...
enum WAS_CS_NOT_RCV_SPEC_SIB_ENUM
{
    ...
    WAS_CS_NOT_RCV_SPEC_SIB11BIS               = 0x1,   /* bit0: 不接受sib11bis */
    WAS_CS_NOT_RCV_SPEC_SIB12                  = 0x2,   /* bit1: 不接受sib12 */
    WAS_CS_NOT_RCV_SPEC_SIB18                  = 0x4,   /* bit2: 不接受sib18 */
    WAS_CS_NOT_RCV_SPEC_SIB19                  = 0x8,   /* bit3: 不接受sib19 */
...
typedef struct
{
    ...
    PS_BOOL_ENUM_UINT8                     enCsNotRcvSpecSibFlg;   /* cs过程中不接受部分系统消息的标记位 */
    WAS_CS_NOT_RCV_SPEC_SIB_ENUM_UINT8     ucNotRcvSpecSibBitmap;  /* cs过程中不接受部分系统消息的bitmap */
...
/*****************************************************************************
 结构名    : WAS_NV_HISTORY_RSSI_SEARCH_STRU
 结构说明  : 开机搜网优化历史频点扫频的相关NV
*****************************************************************************/
typedef struct
{
    PS_BOOL_ENUM_UINT8               ucHistoryRssiSearchFlg;                         /* 历史频点扫频开关 */
    PS_BOOL_ENUM_UINT8               ucHistoryPschSearchFlg;                         /* 历史频点扫频后是否细扫的开关 */
    VOS_UINT8                        ucHistoryRssiFreqSearchNum;                     /* 历史频点rssi扫给物理层下发频点的最大个数，默认为50，最大支持100 */
    VOS_UINT8                        ucHistoryPschFreqSearchNum;                     /* 历史频点细扫给物理层下发频点的最大个数，默认为5 */
    VOS_INT8                         cHistoryRssiBgSearchThreshold;                  /* 背景搜中历史频点的RSSI扫频的门限，单位1db */
    VOS_INT8                         cHistoryRssiPlmnListSearchThreshold;            /* list搜中历史频点的RSSI扫频的门限，单位1db */
    VOS_INT8                         cHistoryRssiOtherSearchThreshold;               /* 其他搜中历史频点的RSSI扫频的门限，单位1db */
    VOS_UINT8                        ucHistoryReportCellSearchFreqSearchNum;               /* 历史频点小区搜需要物理层上报的频点最大个数，默认为5 */
    VOS_UINT8                        ucAnycellReportCellSearchFreqSearchNum;               /* anycell搜网中小区搜需要物理层上报的频点最大个数 */
    VOS_UINT8                        ucHistoryCellSearchFreqMaxNum;                        /* 历史频点小区搜需要物理层小区搜的频点最大个数 */
    VOS_UINT8                        ucBgSearchCellSearchFreqMaxNum;                    /* BG搜网中小区搜需要物理层小区搜的频点最大个数*/
    VOS_UINT8                        ucAnycellCellSearchFreqMaxNum;                     /* anycell搜网中小区搜需要物理层小区搜的频点最大个数 */
    VOS_UINT8                        ucPlmnlistCellSearchFreqMaxNum;                    /* plmnlist搜网中小区搜需要物理层小区搜的频点最大个数 */
    VOS_INT8                         cHistoryRssiSpecSearchThreshold;                  /* EPLMN 历史频点门限 */
    PS_BOOL_ENUM_UINT8               enSearchNotEplmnFreqFlg;                           /* 是否搜索非EPLMN MCC标记 */
    VOS_UINT8                        ucReserve1;                                         /* 保留位 */
...
/*****************************************************************************
 结构名    : WAS_NVIM_NW_REL_TIMER_INFO_STRU
 结构说明  : 不存在信令连接时启动保护定时器控制NV
*****************************************************************************/
typedef struct
{
    PS_BOOL_ENUM_UINT8               enNoConnectionStartNwRelTimerFlg;       /* 没有信令连接时启动timer开关 */
    VOS_UINT8                        ucNwRelTimerLen;                        /* 定时器时长，默认10s */
    VOS_UINT8                        ucReserve1;                             /* 保留位 */
    VOS_UINT8                        ucReserve2;                             /* 保留位 */
}WAS_NVIM_NW_REL_TIMER_INFO_STRU;
/*****************************************************************************
 结构名    : WAS_NVIM_ERACH_BROKEN_CELL_STRU
 结构说明  : 存放ERACH Broken Cell的参数设置              ID:3055 en_NV_Item_Was_Erach_Broken_Cell_Info
*****************************************************************************/

typedef struct
{
    PS_BOOL_ENUM_UINT8                      enNvErachBackToRachFlg;             /* 是否开启Erach回退功能 */
    VOS_UINT8                               ucEraNfail;                         /* 最多进行Nfail轮EST_REQ的重发，否则将小区假如ERACH Bar列表 */
    VOS_UINT8                               ucRscpOffset;                       /* 该小区能量增加这么多db时将小区从ERACH bar列表放出，可以尝试ERACH接入 */
    VOS_UINT8                               ucReserved;                         /* 保留位 */
    VOS_UINT16                              usEraMaxBarlen;                     /* ERACH bar小区的最大时长，单位为分钟，超过该时长小区自动解bar */
    VOS_UINT16                              usEraTBarInitialLen;                /* 小区加入ERACH bar列表的初始时间，单位:秒 */
    VOS_INT16                               sRscpHighThresh;                    /* 加入ERACH bar列表中的小区能量高于此门限，该小区放出ERACH bar列表就不受能量控制 */
    VOS_INT16                               sEcn0Thresh;                        /* 小区能量比上一次至少增加ucRscpOffset，且好于EcNo门限才可能解Bar */
}WAS_NVIM_ERACH_BROKEN_CELL_STRU;

/*****************************************************************************
 结构名    : WAS_NVIM_ERACH_SYS_CHG_IND_CTRL_STRU
 结构说明  : 存放ERACH 系统消息变更CR的参数设置              ID:3056 en_NV_Item_Was_Erach_Sys_ChgInd_Ctrl
*****************************************************************************/

typedef struct
{
    PS_BOOL_ENUM_UINT8                      enSysChgIndCtrlFlg;                 /*  是否开启ERACH CR升级的功能 */
    PS_BOOL_ENUM_UINT8                      enPeriodCellUpdateInPchFlg;         /* ERACH下，pch下不走CU，走测量报告的开关，0为走测量报告，1为走CU流程 */
    VOS_UINT8                               ucReserved2;                       /* 保留位 */
    VOS_UINT8                               ucReserved3;                       /* 保留位 */
}WAS_NVIM_ERACH_SYS_CHG_IND_CTRL_STRU;

/*****************************************************************************
 结构名    : WAS_NVIM_ERRLOG_ACTIVE_RPT_TIME_INTERVAL_CTRL_STRU
 结构说明  : 用于控制CHR主动上报的时间间隔参数控制
*****************************************************************************/
typedef struct
{
    VOS_UINT8                        ucRptTimeIntervalForOtaMsgCheckFail;       /* 用于空口检查失败事件的上报间隔，单位为min */
    VOS_UINT8                        ucReserve1;                                /* 保留位  */
    VOS_UINT8                        ucReserve2;                                /* 保留位  */
    VOS_UINT8                        ucReserve3;                                /* 保留位  */
    VOS_UINT8                        ucReserve4;                                /* 保留位  */
    VOS_UINT8                        ucReserve5;                                /* 保留位  */
    VOS_UINT8                        ucReserve6;                                /* 保留位  */
    VOS_UINT8                        ucReserve7;                                /* 保留位  */
    VOS_UINT8                        ucReserve8;                                /* 保留位  */
    VOS_UINT8                        ucReserve9;                                /* 保留位  */
    VOS_UINT8                        ucReserve10;                               /* 保留位  */
    VOS_UINT8                        ucReserve11;                               /* 保留位  */
}WAS_NVIM_ERRLOG_ACTIVE_RPT_TIME_INTERVAL_CTRL_STRU;

/*****************************************************************************
 结 构 名  : WAS_NV_CAMP_HANDLE_CUSTOMIZE_CFG_STRU
 结构说明  : 搜网驻留判决定制NV
 修改历史  :
  1.日  期   : 2015年4月6日
    作  者   : z00184470
...
typedef struct
{
    VOS_UINT32              ulCampHandleCustomEnableBitmap;                     /* 驻留判决定制使能bit位，每一位与特定的搜网类型相对应，具体对应关系可参照搜网流程枚举结构WAS_NETWORK_SEARCH_PROGRESS_ENUM */
}WAS_NV_CAMP_HANDLE_CUSTOMIZE_CFG_STRU;

/*****************************************************************************
 结构名    : WAS_NVIM_SVALUE_CUSTOMIZE_CTRL_STRU
 结构说明  : 重定向CSFB或者搜网CSFB流程S准则定制设置              ID:3062 en_NV_Item_WAS_SValue_CUSTOMIZE_CFG
*****************************************************************************/

typedef struct
{
    PS_BOOL_ENUM_UINT8                      enSValueCtrlFlg;                   /*  是否s准则定制功能 */
    VOS_INT8                                cRscp_Threshold;                   /* WCDMA Cpich_Rscp门限,默认值:-105 ,范围0~-127*/
    VOS_INT8                                cEcNo_Threshold;                   /* WCDMA Cpich_EcNo门限,默认值:-18 */
    VOS_UINT8                               ucReserved1;                       /* 保留位 */
    VOS_UINT8                               ucReserved2;                       /* 保留位 */
    VOS_UINT8                               ucReserved3;                       /* 保留位 */
...
/*****************************************************************************
 结构名    : WAS_NVIM_MFBI_CTRL_STRU
 结构说明  : 用于控制是否支持MFBI
*****************************************************************************/
typedef struct
{
    PS_BOOL_ENUM_UINT8               enLteMfbiSptFlg;                           /* 是否支持MFBI */
    PS_BOOL_ENUM_UINT8               enNeedAttActiveFlg;                        /* 是否需要判决ATT网络  */
    VOS_UINT8                        ucReserve1;
    VOS_UINT8                        ucReserve2;
...
/*****************************************************************************
 结 构 名  : WAS_TAFITF_NvimReadGeoSearchForSib1
 结构说明  : 获取Geo搜网是否需要解SIB1的控制开关
 修改历史  :
  1.日  期   : 2016年9月7日
    作  者   : h00377722
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      enSib1OnOffFlg;                                     /* 定制是否生效开关 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
    VOS_UINT8               ucReserved3;                                        /* 保留位 */
...
/* Added by z00184470 for 搜网优化6.0, 2016-09-07, begin */
/*****************************************************************************
 结 构 名  : WAS_NV_MULTI_MODEM_HISTORY_FERQ_SHARE_CFG_STRU
 结构说明  : 多MODEM历史频点共享定制NV
 修改历史  :
  1.日  期   : 2016年9月7日
    作  者   : z00184470
    修改内容 : 新生成结构
...
typedef struct
{
    VOS_UINT32              ulMultiModemHistoryFreqShareCfgEnableBitmap;        /* 多MODEM历史频点共享流程使能bit位 */    
}WAS_NV_MULTI_MODEM_HISTORY_FERQ_SHARE_CFG_STRU;

/*****************************************************************************
 结 构 名  : WAS_NV_NET_SRCH_RMV_INTER_RAT_FREQ_BAND_CTRL_STRU
 结构说明  : 多模搜网删异系统频点定制NV开关
 修改历史  :
  1.日  期   : 2016年9月7日
    作  者   : z00184470
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      enNetSrchRmvInterRatFreqBandEnableFlg;              /* 定制搜网删除异系统频段使能开关 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
    VOS_UINT8               ucReserved3;                                        /* 保留位 */
...
/* Added by z00184470 for 搜网优化6.0, 2016-09-07, end */
/*****************************************************************************
 结构名    : WAS_NVIM_W2L_RESEL_PUNISH_CUSTOMIZE_CTRL_STRU
 结构说明  : W2L重选挂起nas失败，W2L重选惩罚的控制开关              ID:3069 en_NV_Item_WAS_W2L_Resel_Punish_CUSTOMIZE_CFG
*****************************************************************************/

typedef struct
{
    PS_BOOL_ENUM_UINT8                      enW2LReselPunishCtrlFlg;           /*  W2L重选惩罚的控制开关  */
    VOS_UINT8                               ucW2LReselPunishTimerLen;          /* W2L重选惩罚的定时器的长度，单位:s */
    VOS_UINT8                               ucReserved1;                       /* 保留位 */
    VOS_UINT8                               ucReserved2;                       /* 保留位 */  

}WAS_NVIM_W2L_RESEL_PUNISH_CUSTOMIZE_CTRL_STRU;
/*****************************************************************************
 结 构 名  : WAS_NV_RE_CALC_ACTIVE_TIME_CTRL_STRU
 结构说明  : 重新计算激活时间控制开关
 修改历史  :
  1.日  期   : 2016年10月12日
    作  者   : j00169676
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      enRecalActiveTimeFlg;                               /* 定制打开重新计算激活时间使能开关 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
    VOS_UINT8               ucReserved3;                                        /* 保留位 */
}WAS_NV_RE_CALC_ACTIVE_TIME_CTRL_STRU;
/*****************************************************************************
 结 构 名  : WAS_NV_PRINT_LEVEL_CTRL_STRU
 结构说明  : Normal和Info级别打印的使能开关
 修改历史  :
  1.日  期   : 2016年10月25日
    作  者   : j00169676
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8      enPrintInfoFlg;                                     /* 定制打开Normal和Info级别打印的使能开关 */
    VOS_UINT8               ucReserved1;                                        /* 保留位 */
    VOS_UINT8               ucReserved2;                                        /* 保留位 */
    VOS_UINT8               ucReserved3;                                        /* 保留位 */
...
typedef struct
{
    PS_BOOL_ENUM_UINT8              enTreseltionCustCtrlFlg;                    /* 重选定时器定制使能总开关  */
    PS_BOOL_ENUM_UINT8              enSValueNotFulfilCustValidFlg;              /* 当不满足S准则时，定制是否生效的标记 */
    VOS_UINT16                      usEcn0Delta;                                /* 只有当目标小区的EC/N0减去服务小区的EC/N0大于或等于该门限大小时，定制才生效 */
    VOS_UINT16                      usIntraFreqTreselectionCustLenInIdlePch;    /* IDLE或PCH态同频重选定时器可定制时长，单位为配置给物理层的DRX周期长度 */
    VOS_UINT16                      usIntraFreqTreselectionLowCustLenInIdlePch; /* IDLE或PCH态同频重选定时器可定制最低时长，单位为ms */
    VOS_UINT16                      usIntraFreqTreselectionHighCustLenInIdlePch;/* IDLE或PCH态同频重选定时器可定制最高时长，单位为ms */
    VOS_UINT16                      usInterFreqTreselectionCustLenInIdlePch;    /* IDLE或PCH态异频重选定时器可定制时长，单位为配置给物理层的DRX周期长度 */
    VOS_UINT16                      usInterFreqTreselectionLowCustLenInIdlePch; /* IDLE或PCH态异频重选定时器可定制最低时长，单位为ms */
    VOS_UINT16                      usInterFreqTreselectionHighCustLenInIdlePch;/* IDLE或PCH态异频重选定时器可定制最高时长，单位为ms */    
    VOS_UINT16                      usReserve1;                                 /* 保留位 */
    VOS_UINT16                      usReserve2;                                 /* 保留位 */
    VOS_UINT16                      usReserve3;                                 /* 保留位 */
    VOS_UINT16                      usReserve4;                                 /* 保留位 */
    VOS_UINT16                      usReserve5;                                 /* 保留位 */
    VOS_UINT16                      usReserve6;                                 /* 保留位 */
}WAS_NVIM_TRESELECTION_CUSTOMIZE_CFG_STRU;

/*****************************************************************************
 结 构 名  : WAS_NVIM_HO2EUTRAN_CFG_STRU
 结构说明  : 存储在NVIM中的W切换到LTE功能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_EUTRANMEAS_CFG_STRU
 结构说明  : 存储在NVIM中的W连接态LTE测量功能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_FDPCH_EFDPCH_CFG_STRU
 结构说明  : 存储在NVIM中的FDPCH/EFDPCH使能控制开关
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_CPC_CFG_STRU
 结构说明  : 存储在NVIM中的CPC相关配置
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : WAS_NVIM_EFACH_CFG_STRU
 结构说明  : 存储在NVIM中的EFACH相关配置 
 修改历史  :
  1.日    期   : 2016年11月11日
    作    者   : h00390293
    修改原因   : 新生成结构
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_DSDS_NEED_APPLY_SEARCH_CTRL_STRU
 结构说明  : DSDS1.0 was和gas是否要申请搜网资源
 修改历史  :
  1.日    期   : 2017年01月05日
    作    者   : p00179010
    修改原因   : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8                      enGasDsdsUnNeedApplySearchFlg;                  /* chicago C20版本gas异系统搜网是否需要申请搜网资源的标记 */
    PS_BOOL_ENUM_UINT8                      enWasDsdsUnNeedApplySearchFlg;                  /* chicago C20版本was同系统和异系统搜网是否需要申请搜网资源的标记 */
    VOS_UINT8                               ucReserve1;
    VOS_UINT8                               ucReserve2;
    VOS_UINT8                               ucReserve3;
...
/*****************************************************************************
 结 构 名  : WAS_NV_FAKE_DMCR_CFG_STRU
 结构说明  : CSFB时网络不支持DMCR时不需要解SIB11\SIB19等定制NV
 修改历史  :
  1.日  期   : 2016年12月20日
    作  者   : j00169676
    修改内容 : 新生成结构
...
/*****************************************************************************
 ...
 结 构 名  : WAS_NV_EMERGENCY_CAMP_CFG_STRU
 结构说明  : 紧急呼叫时Suitable驻留配置NV结构
 DESCRIPTION: 异系统重选相关优化定制开关
 修改历史  :
  1.日  期   : 2017年4月1日
    作  者   : j00169676
    修改内容 : 新生成结构
...
typedef struct
{
    PS_BOOL_ENUM_UINT8              enEmergencySuitableCampFlg;                 /* 发起紧急呼叫时是否允许suitable驻留 */
    VOS_UINT8                       ucMccNum;                                   /* 匹配的国家码 */
    VOS_UINT8                       ucRsv1;
    VOS_UINT8                       ucRsv2;
