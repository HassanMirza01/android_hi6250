...
/*****************************************************************************
 ...
 修改历史  :
  ...
  2.日    期   : 2016年6月29日
    作    者   : s00184266
    修改原因   : pref band saved cell, 新增预置频段挽救的功能控制
...
/*****************************************************************************
 结 构 名  : NVIM_GSM_PARALLEL_SEARCH_CUSTOMIZE_CFG_STRU
 结构说明  : en_NV_Item_GSM_PARALLEL_SEARCH_CUSTOMIZE_CFG 结构，GSM并行搜网流程相关配置
 修改历史  :
  1.日    期   : 2016年6月20日
    作    者   : s00184266
    修改原因   : 新增ucAnyCellSrchBaFlag
...
/*****************************************************************************
 ...
 修改历史  :
  ...
  3.日  期   : 2016年05月10日
    作  者   : w00146666
    修改内容 : for DTS2016050901311, 信号强度变化老化机制按照信号强度等级细化
*****************************************************************************/
typedef struct
{
    /* ===============惩罚机制总体相关的NV配置项===================== */
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_CELLULAR_PREFER_PARA_CFG_STRU
 结构说明  : 用于GUAS Cellular Prefer域选上报配置定制 
 修改历史  :
  1.日  期   : 2016年9月22日
    作  者   : s00184266
    修改内容 : 新生成结构
...
/*****************************************************************************
 结 构 名  : NVIM_GUAS_CELLULAR_PREFER_SELECT_CFG_STRU
 结构说明  : 用于GUAS Cellular Prefer域选上报配置定制 
 修改历史  :
  1.日  期   : 2016年9月22日
    作  者   : s00184266
...
/*****************************************************************************
 结 构 名  : NVIM_GSM_IRAT_ACTIVE_RESEL_CUSTOM_CFG_STRU
 结构说明  : GSM重选到WCDMA私有定制
 修改历史  :
  1.日  期   : 2017年4月17日
    作  者   : s00184266
    修改内容 : 新生成结构
