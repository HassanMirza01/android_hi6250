...
/*****************************************************************************
 ...
 结构说明  : en_NV_Item_PPP_CONFIG对应的NV结构
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 ...
 结构说明  : en_NV_Item_TTF_SEQ_OUT_OF_ORDER_COMPATIBLE对应的NV结构
*****************************************************************************/
typedef struct
{
    TTF_BOOL_ENUM_UINT8                 enWcdmaEnable;          /* 是否使能WCDMA兼容 */
    TTF_BOOL_ENUM_UINT8                 enLAPDmEnable;          /* 是否使能LAPDm兼容 */
...
/*****************************************************************************
 ...
 结构说明  : NV_TTF_CORE_BIND_CONFIG_STRU对应的NV结构
...
/*****************************************************************************
 ...
 结构说明  : NV_CTTF_FID_CORE_BIND_CONFIG_STRU对应的NV结构, CoreMask的每一个bit位对应一个核
