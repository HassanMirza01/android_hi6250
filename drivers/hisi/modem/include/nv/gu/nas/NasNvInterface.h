...
/*****************************************************************************
 结构名    : NAS_MMC_IMSI_REFRESH_DELETE_FPLMN_CFG_STRU
 结构说明  : 记录en_NV_Item_IMSI_REFRESH_DELETE_FPLMN_CFG NV项内容
 修改记录  :
 1.日    期   : 2017年1月22日
   作    者   : w00167002
   修改内容   : 新增.
                举例:ucLastAddFplmnMaxTimeLength配置为3000ms。
                电信46001卡在23005上拒绝#11,则MMC在收到卡的IMSI更新为国际卡时候，
                判断当前距上次增加FPLMN的时长，如果时长小于3秒，则可能错误的写入了
                FPLMN卡文件。需要把FPLMN统一清除下，否则国际卡不会尝试搜索23005网络。

*****************************************************************************/
typedef struct
{
    VOS_UINT8                           ucLastUpdateFplmnMaxTimeLength;         /* 上次更新FPLMN的最大时长，单位s,如果增加FPLMN时长小于MAX值，则删除卡中的FPLMN列表 */
    VOS_UINT8                           ucReserved1;
    VOS_UINT8                           ucReserved2;
    VOS_UINT8                           ucReserved3;
}NAS_MMC_IMSI_REFRESH_DELETE_FPLMN_CFG_STRU;
/*****************************************************************************
...
/*****************************************************************************
 结构名    : NAS_NVIM_CL_IMS_SUPPORT_CFG_STRU
 结构说明  : CL模式下IMS能力配置
 修改历史      :
  1.日    期   : 2016-10-13
    作    者   : g00261581
...
typedef struct
{
    ...
    VOS_UINT8                           ucReserve2;
    VOS_UINT8                           ucReserve3;
} NAS_NVIM_CL_IMS_SUPPORT_CFG_STRU;
