...
#define UCOM_NV_INTERFERENCE_TABLE_MAX_NUM      ( 32 )                           /* 干扰规则表最大个数*/
...
#define UCOM_NV_G_AGC_BLK_MAX_NUM           ( 8 )
#define UCOM_NV_G_AGC_NOBLK_MAX_NUM         ( UCOM_NV_G_AGC_BLK_MAX_NUM )
...
#define UCOM_NV_G_CHAN_GAIN_RAM_NUM         ( 4 )                               /* 接收增益存放在BBP的块数 */
...
/* MRX */
#define UCOM_NV_MRX_GAIN_CTRL_MAX_NUM       ( 5 )                               /* MRX GAIN控制字命令最大数目 */
#define UCOM_NV_MRX_GAIN_CHAN_MAX_NUM       ( 3 )                               /* MRX GAIN信道最大数目 */

#define UCOM_NV_RFIC_PA_GAIN_INDEX_MAX_NUM  ( 4 )                              /* GSM线性PA下，RF和PA组合档位最大数目 */
#define UCOM_NV_RFIC_GAIN_CTRL_MAX_NUM      ( 2 )                              /* GSM线性PA下，RF档位最大数目 */

#define UCOM_NV_CROSS_MIPI_MEM_INDEX_MAX_NUM        ( 512 )                     /* NV_CROSS_MIPI_MEM_INDEX中存放的最大数目 */
#define UCOM_NV_CROSS_GPIO_TUNER_MEM_MAX_NUM        ( 192 )                     /* NV_CROSS_GPIO_TUNER_MEM中存放的最大数目 */
...
#define UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM          ( 16 )                      /* BODY SAR (Additional,5mm)每个状态包含16个档位 */
...
#define UCOM_NV_TX_MAX_CAL_FREQ_NUM          ( 0x10 )                            /* Tx每个频段下UARFCN个数 */
#define UCOM_NV_RX_MAX_CAL_FREQ_NUM          ( 0x10 )                            /* Rx每个频段下UARFCN个数 */
...
#define UCOM_NV_W_AGC_GAIN_STEP_NUM         ( 0x8 )                            /* AGC档位个数 */
#define UCOM_NV_W_RX_FREQ_COMP_NUM          ( 0x20 )                            /* 每个频段下UARFCN个数 */
...
#define UCOM_NV_RF_KEY_REG_NUM                  ( 32 )                          /* 6362关键寄存器定义了最多32个 */
...
#define UCOM_DCXO_OLD_SAMPLE_MAX_NUM        ( 144 )
...
#define UCOM_NV_CDMA_AGC_FREQ_COMP_NUM                ( 0x20 )                  /* AGC每个档位下频补个数 */
#define UCOM_NV_CDMA_AGC_STATUS_NUM                   ( 8 )                   /* NV项中AGC档位个数 */
...
#define UCOM_NV_CDMA_APC_ATTEN_NUM                    ( 88 )
...
#define UCOM_NV_CDMA_MIPI_PA_TRIGGER_NUM              ( 1 )  /* pa trigger个数 */
#define UCOM_NV_CDMA_MIPI_PA_VCC_VBIAS_NUM            ( 1 )  /* pa vcc cmd和data个数 */

#define UCOM_NV_CDMA_APT_FREQ_COMP_NUM                 ( 16 )
#define UCOM_NV_CDMA_APT_TEMP_COMP_NUM                 ( 16 )

#define UCOM_NV_CDMA_ET_DELAY_FREQ_COMP_MAX_NUM        ( 8 )                    /* ET DELAY 频补最大值 */
...
/* DPD模式 */
#define UCOM_NV_DPD_MODE_POWER                      ( 0 )
#define UCOM_NV_DPD_MODE_APC                        ( 1 )

/* DPD幅度默认值 0dB */
#define UCOM_NV_DPD_LUT_I_START                     ( 1024 )
#define UCOM_NV_DPD_LUT_Q_START                     ( 0 )
...
#define UCOM_NV_HARMONIC_NUM                        ( 5 )                       /* 存在的谐波数目 */

#define UCOM_NV_GSM_HARMONIC_NUM                    ( 8 )                       /* GSM存在的谐波数目 */

/* W下FET动态译码SNR门限个数 */
#define UCOM_NV_W_FET_DYN_DEC_SNR_NUM               ( 22 )

/* W下FET动态译码盲检测SNR门限时隙结构体个数 */
#define UCOM_NV_W_FET_BLIND_DYN_DEC_SNR_NUM         ( 5 )

/* W下FET动态译码非盲检测SNR门限时隙结构体个数 */
#define UCOM_NV_W_FET_NOBLIND_DYN_DEC_SNR_NUM       ( 4 )
#define UCOM_NV_MAX_MIPI_TAS_CMD_NUMBER             ( 4 )                       /* tas mipi控制字命令最大数目 */
#define UCOM_NV_MAX_MIPI_TAS_DATA_NUMBER            ( 5 )                       /* tas mipi数据字命令最大数目 */


/* DCXO每段的最大样本个数 */
#define UCOM_NV_DCXO_SAMPLE_H_MAX_NUM               ( 40 )
#define UCOM_NV_DCXO_SAMPLE_M_MAX_NUM               ( 28 )
#define UCOM_NV_DCXO_SAMPLE_L_MAX_NUM               ( 32 )

/* 三段的和，因为NV不支持宏运算，所以直接得出加结果，不用宏加 */
#define UCOM_NV_DCXO_SAMPLE_MAX_NUM                 ( 100 )

/* 老化缓存大小 */
#define UCOM_NV_DCXO_AGEING_BUF_MAX_NUM             ( 12 )

/* TX TAS项目新增，WPHY TX-TAS-STATE II 的档位个数 */
#define UCOM_NV_W_TX_TAS_STATEII_LEVEL_NUM          ( 4 )

#define UCOM_NV_W_CQI_VALUE_NUM                     ( 30 )
#define UCOM_NV_W_CQI_TABLE_NUM                     ( 8 )

/* C模MIPI回读个数 */
#define UCOM_NV_TEST_MIPI_READ_MAX_NUM              ( 10 )
#define UCOM_NV_TEST_MIPI_READ_MIN_NUM              ( 0 )
/*****************************************************************************
  3 Massage Declare
*****************************************************************************/
...
/*****************************************************************************
 枚举名    :UCOM_NV_W_HARMONIC_TYPE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :下行谐波产生的来源
*****************************************************************************/
...
{
    UCOM_NV_W_HARMONIC_TYPE_ABB                             = 0,                /* abb 产生的谐波 */
    UCOM_NV_W_HARMONIC_TYPE_RF                                 ,                /* rf 晶振产生的谐波 */
...
/*****************************************************************************
 结构名    : UCOM_NV_DCXO_FIX_COFF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :多项式定点系数，其中T单位为0.1度，ppm量化为2^30/10^6
            ppm = swC + swK1*( T - RefT )/2^16 + K2*(( T - RefT )^2)/2^24 + K3*((T - RefT )^3)/2^32
*****************************************************************************/
typedef struct
{
    VOS_INT32                  swC;                                             /* 式中的C，2^30/10^6 */
    VOS_INT32                  swK1;                                            /* 式中的K1，K1为浮点数*(2^30/10^7)*2^16 */
    VOS_INT32                  swK2;                                            /* 式中的K2，K2为浮点数*(2^30/10^8)*2^24 */
    VOS_INT32                  swK3;                                            /* 式中的K3，K3为浮点数*(2^30/10^9)*2^32 */
}UCOM_NV_DCXO_FIX_COFF_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_DCXO_AGEING_EST_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : XO老化估计 Ageing_ppm = C + K1*△m + K2*(△m^2)
             其中△m单位为月，表示(当前时间-首次使用时间)月，Ageing_ppm量纲为2^30/10^6
*****************************************************************************/
typedef struct
{
    VOS_INT32                  swAgeingC;                                       /* 式中的C，2^30/10^6 */
    VOS_INT32                  swAgeingK1;                                      /* 式中的K1，K1*△m为2^30/10^6 */
    VOS_INT32                  swAgeingK2;                                      /* 式中的K2，K2*(△m^2)为2^30/10^6 */
    VOS_INT32                  swAgeingK3;                                      /* 保留 */
}UCOM_NV_DCXO_AGEING_EST_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_DCXO_SAMPLE_UPDATA_PARA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 用于控制样本更新的参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwRcmUpdataPeriod;                     /* RCM周期性更新样本的周期，单位1ms，默认值1000 */
    VOS_UINT16                          uhwTempCompPeriod;                      /* RCM周期性更新温补的周期，单位1ms，默认值400 */
    VOS_UINT16                          uhwNvWrPeriod;                          /* 向FLASH刷新样本NV和系数NV的周期，单位分，默认10分钟 */
    VOS_UINT16                          uhwRdSamplePeriod;                      /* RCM从CTU读样本的周期，单位1ms，默认值24 */
    VOS_UINT16                          uhwUpdateLowThr;                        /* 样本更新下门限,默认215,即0.2ppm*2^30/10^6 */
    VOS_UINT16                          uhwUpdateHighThr;                       /* 样本更新上门限,默认2684,即2.5ppm*2^30/10^6 */
    VOS_UINT16                          uhwAgeingMonthThr;                      /* 老化样本点判断年限，单位月，默认12个月 */
    VOS_INT16                           shwAgeingThrOffset;                     /* 在老化估计上的偏移量，2^30/10^6 */
    VOS_UINT16                          uhwXoTempChangeThr;                     /* XO温度变化门限，单位0.1度，默认值10 */
    VOS_UINT16                          uhwReserved0;                           /* 保留 */
    UCOM_NV_DCXO_AGEING_EST_STRU        stAgeingEstimate;                       /* XO老化估计参数 */
    UCOM_NV_DCXO_FIX_COFF_STRU          stFtDiscretePpmThr;                     /* ppm离散性门限,△T取绝对值 */
    VOS_INT16                           ashwCompForecastTempExtend[5];          /* 温补外推各级别温度定义 */
    VOS_UINT16                          uhwReserved1;                           /* 保留 */
    VOS_UINT16                          uhwReserved2;                           /* 保留 */
    VOS_UINT16                          uhwReserved3;                           /* 保留 */
}UCOM_NV_DCXO_SAMPLE_CTRL_PARA_STRU;
...
typedef struct
{
    VOS_INT32                   swTime      :16;                                /* 年月，比如2016.4表示值为1604,小于1604表示该样本无效 */
    VOS_INT32                   swTemp      :16;                                /* 温度，单位0.1度 */

    VOS_INT32                   swPpm       :24;                                /* 相对频偏，定点化2^30/10^6 */
    VOS_INT32                   swMode      :8;                                 /* 模式，高4bit为modem_id,低4bit为模式，0:G、1:U、2:L、3:TD、4:1X、5:EVDO */
}UCOM_NV_DCXO_SAMPLE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_DCXO_AGEING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 存放一组老化信息
*****************************************************************************/
...
{
    VOS_INT32                   swTime      :16;                                /* 年月，比如2016.4表示值为1604,小于1604表示该样本无效 */
    VOS_INT32                   swPpm       :16;                                /* 相对频偏，定点化2^30/10^6 */
}UCOM_NV_DCXO_AGEING_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_DCXO_SAMPLE_ARRAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 存放所有DCXO样本
*****************************************************************************/
typedef struct
{
    VOS_INT16                   shwMinTemp;
    VOS_INT16                   shwMaxTemp;
    VOS_INT32                   swFirstTime;                                    /* 第一次获得的有效网络时间 */
    UCOM_NV_DCXO_AGEING_STRU    stPpmAgeingPlus;                                /* XO老化值,2^30/10^6,参考温度为校准温度,即当前XO在校准温度的ppm - 校准残余ppm */
    UCOM_NV_DCXO_SAMPLE_STRU    astSample[UCOM_NV_DCXO_SAMPLE_MAX_NUM];         /* 样本 */
    UCOM_NV_DCXO_AGEING_STRU    astAgeingBuf[UCOM_NV_DCXO_AGEING_BUF_MAX_NUM];  /* 老化历史信息 */
    UCOM_NV_DCXO_FIX_COFF_STRU  stFixPolyCoff;                                  /* 样本系数的定点化值 */
}UCOM_NV_DCXO_SAMPLE_ARRAY_STRU;
...
typedef UCOM_NV_WG_MIPI_INIT_WORD_STRU  UCOM_NV_CDMA_MIPI_INIT_WORD_STRU;

/*****************************************************************************

 结构名    : UCOM_Tuner_Ctrl_Reg_STRU
 协议表格  :
 结构说明  :
*****************************************************************************/
typedef struct
{
    VOS_UINT32                         uwTunerMipiMask    :4;                   /* TUNER_MIPI_MASK寄存器配置 */
    VOS_UINT32                         uwGpioMask         :21;                  /* GPIO方式mask 寄存器配置*/
    VOS_UINT32                         uwReserved3        :7;
}UCOM_NV_TUNER_CTRL_REG_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CROSS_GPIO_MIPI_CTRL_STRU
 协议表格  :
 结构说明  : 用于存储CrossMipiTable
*****************************************************************************/
typedef struct
{
    VOS_UINT32                         uwTunerEn;                               /* TUNER_EN寄存器配置值 */
    VOS_UINT32                         uwTunerRegEn;                            /* TUNER_REG_EN寄存器配置值 */
    VOS_UINT32                         uwGpioCrossEn;                           /* GPIO交叉配置是否使能*/
    VOS_UINT32                         uwTasIndEn;                              /* TAS IND 取反配置*/
    VOS_UINT32                         uwMipiTuner0Len;                         /* MIPI 方式Modem0主载波实际buffer长度*/
    VOS_UINT32                         uwMipiTuner1Len;                         /* MIPI 方式Modem0主载波实际buffer长度*/
    VOS_UINT32                         uwMipiTuner2Len;                         /* MIPI 方式Modem0辐载波实际buffer长度*/
    VOS_UINT32                         uwGpioTunerLen;                          /* GPIO方式实际buffer长度*/
    UCOM_NV_TUNER_CTRL_REG_STRU        stReg;
}UCOM_NV_CROSS_GPIO_MIPI_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CROSS_MIPI_MEM_INDEX
 协议表格  :
 结构说明  : 用于存储mipi指令
*****************************************************************************/
typedef struct
...
/*****************************************************************************
 结构名    : UCOM_NV_CROSS_GPIO_MEM_STRU
 协议表格  :
 结构说明  : 用于存储gpio指令
*****************************************************************************/
typedef struct
...
typedef struct
{
    VOS_UINT32                          auwMantissa[UCOM_DCXO_POLY_COEFF_NUM];  /* 依次存放a0,a1,a2,a3的尾数 */
    VOS_UINT16                          auhwExponent[UCOM_DCXO_POLY_COEFF_NUM]; /* 依次存放a0,a1,a2,a3的指数 */
...
typedef struct
{
    ...
    VOS_INT16                           shwTmax;                                /* 样本温度最大值 */
    VOS_INT16                           shwTmin;                                /* 样本温度最小值 */
    UCOM_NV_DCXO_AFC_VS_TEMP_VALUE_STRU astAfcTempValue[UCOM_DCXO_OLD_SAMPLE_MAX_NUM]; /* 样本数据 */
...
/*****************************************************************************
 结构名    : UCOM_NV_G_TIMING_CTRL_B_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : BOSTON使用
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_MIPI_PA_TIMING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MIPI PA的timing 结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwMipiPaInitTiming;                    /* Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwMipiPaGainSetTiming;
    VOS_UINT16                          uhwMipiPaTrigTiming;                    /* PA使能时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotMipiPaGainSetTiming;
    VOS_UINT16                          uhwMultislotMipiPaTrigTiming;           /* 多时隙下，Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwMipiPaOffTiming;                     /* PA关闭时刻，单位为Qb */
}UCOM_NV_GSM_MIPI_PA_TIMING_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_GPIO_PA_TIMING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GPIO PA的timing 结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwGpioPaModeSetTiming;                 /* Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwGpioPaEnableTiming;                  /* PA使能时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotGpioPaModeSetTiming;        /* 多时隙下，Pa Mode的设置时刻，单位为Qb */
    VOS_UINT16                          uhwGpioPaDisableTiming;                 /* PA关闭时刻，单位为Qb */
}UCOM_NV_GSM_GPIO_PA_TIMING_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_G_SWITCH_SPECTRUM_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 开关谱相关的timing 结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwTxBurstOffset;                       /* GSM burst offset */
    VOS_UINT16                          uhwAntSwitchOpenTiming;                 /* 天线打开时刻，单位为Qb */
    VOS_UINT16                          uhwAntSwitchCloseTiming;                /* 天线关闭时刻，单位为Qb */
    VOS_UINT16                          uhwPreChargeEnableTiming;               /* 预充打开时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotPreChargeTiming;            /* 多时隙预充，单位为Qb */
    VOS_UINT16                          uhwPrechargeDisableTiming;              /* 预充关闭时刻，单位为Qb */
    VOS_UINT16                          uhwReserved0;
    VOS_UINT16                          uhwReserved1;                           /* 多预留两位保留位 */

    UCOM_NV_GSM_GPIO_PA_TIMING_STRU     stGsmGpioPaTiming;
    UCOM_NV_GSM_MIPI_PA_TIMING_STRU     stGsmMipiPaTiming;
}UCOM_NV_GSM_SWITCH_SPECTRUM_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwAntSwitchOpenTiming;                 /* 天线打开时刻，单位为Qb */
    VOS_UINT16                          uhwAntSwitchCloseTiming;                /* 天线关闭时刻，单位为Qb */
    VOS_UINT16                          uhwPaVbiasTiming;                       /* vbias打开时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotVbiasTiming;
    VOS_UINT16                          uhwPaVbiasDisableTiming;
    VOS_UINT16                          uhwReserved0;
    VOS_UINT16                          uhwReserved1;                           /* 多预留两位保留位 */

    UCOM_NV_GSM_GPIO_PA_TIMING_STRU     stGsmGpioPaTiming;
    UCOM_NV_GSM_MIPI_PA_TIMING_STRU     stGsmMipiPaTiming;
}UCOM_NV_EDGE_SWITCH_SPECTRUM_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_G_APT_TIMING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM ATP TIMING结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwPaVccTiming;                         /* PA Vcc打开时刻，单位为Qb */
    VOS_UINT16                          uhwMultiSlotPaVccTiming;                /* 多时隙下，PA Vcc打开时刻，单位为Qb */
    VOS_UINT16                          uhwPaVccDisableTiming;                  /* PA Vcc关闭的时刻，单位为Qb */
    VOS_UINT16                          uhwReserved;
}UCOM_NV_G_APT_TIMING_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_TX_TIME_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM 开放给射频调试的TIMING结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_SWITCH_SPECTRUM_STRU    stSwitchSpectrum;                       /* GSM开关谱相关timing */
    UCOM_NV_G_TIMING_CTRL_B_STRU        stOpenTxTunerTiming;                    /* open tx tuner时刻,GMSK和8PSK共用时序，8PSK结构体中无需此项 */
    UCOM_NV_G_APT_TIMING_STRU           stAptTiming;                            /* GSM开关谱相关timing */
}UCOM_NV_GSM_TX_TIME_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_EDGE_TX_TIME_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EDGE 开放给射频调试的TIMING结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_EDGE_SWITCH_SPECTRUM_STRU   stSwitchSpectrum;                       /* GSM开关谱相关timing */
    UCOM_NV_G_APT_TIMING_STRU           stAptTiming;                            /* GSM开关谱相关timing */
}UCOM_NV_EDGE_TX_TIME_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_MOD_TYPE_TIMING_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM内部调试TIMING结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwPreModSymbol;                        /* 预调制符号 */
    VOS_UINT16                          uhwModOpenTiming;                       /* 调制时刻，单位为Qb */
    VOS_UINT16                          uhwTxPaLength;                          /* 爬坡保持长度 */
    VOS_UINT16                          uhwRampOpenTiming;                      /* 爬坡时刻，单位为Qb */
    VOS_UINT16                          uhwMultislotRampOpenTiming;             /* 多时隙时刻，单位为Qb */
    VOS_UINT16                          uhwTxPllEnableTiming;                   /* 配置频点发送时刻，单位为Qb */
    VOS_UINT16                          uhwAbbEnableTiming;                     /* ABB使能时刻，单位为Qb */
    VOS_UINT16                          uhwTxPllDiableTiming;                   /* 关闭射频时，Ch2的发送时刻，单位为Qb */
    VOS_UINT16                          uhwAbbDisableTiming;                    /* ABB关闭时刻,单位为Qb */
    VOS_UINT16                          uhwTxCmdTiming;                         /* 新增，CMD下发时刻 */
    VOS_UINT16                          uhwTxCmdTimer;                          /* 新增，CMD生效前延迟时间 */
    VOS_UINT16                          uhwReserved;                            /* 保留位 */
}UCOM_NV_MOD_TYPE_TIMING_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_PA_TYPE_TIME_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM内部调试TIMING结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_MOD_TYPE_TIMING_STRU         stGmskTiming;                          /* GMSK时序 */
    UCOM_NV_MOD_TYPE_TIMING_STRU         stEdgeTiming;                          /* 8PSK时序 */
}UCOM_NV_PA_TYPE_TIME_CONFIG_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_PRIVATE_TIME_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM内部调试TIMING结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_PA_TYPE_TIME_CONFIG_STRU    stSaturatedPaTimeConfig;                /* 饱和PA时序配置 */
    UCOM_NV_PA_TYPE_TIME_CONFIG_STRU    stLinearPaTimeConfig;                   /* 线性PA时序配置 */
}UCOM_NV_GSM_PRIVATE_TIME_CONFIG_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_POLAR_PA_RFIC_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC GAIN控制字结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwRficGainCtrl;                         /* 饱和PA情况下，RFIC控制字，高档位 */
    VOS_UINT32                          uwReserved;                             /* 保留 */
}UCOM_NV_GSM_POLAR_PA_RFIC_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_LINEAR_PA_RFIC_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC GAIN控制字结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwRficGainCtrl[UCOM_NV_RFIC_GAIN_CTRL_MAX_NUM]; /* 线性PA情况下，RFIC控制字，2档位 */
}UCOM_NV_GSM_LINEAR_PA_RFIC_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_POLAR_RFIC_GAIN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC GAIN控制字结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_POLAR_PA_RFIC_CTRL_STRU     stGsmSaturatedPaRficCtrl;           /* 饱和PA情况下，RFIC控制字 */
    UCOM_NV_GSM_LINEAR_PA_RFIC_CTRL_STRU    stGsmLinearPaRficCtrl;              /* 线性PA情况下，RFIC控制字 */
}UCOM_NV_GSM_POLAR_RFIC_GAIN_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_EDGE_POLAR_RFIC_GAIN_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC GAIN控制字结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwRficGainCtrl[UCOM_NV_G_TX_ATTEN_NUM]; /* 8PSK RFIC控制字 */
}UCOM_NV_EDGE_POLAR_RFIC_GAIN_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_RFIC_PA_CTRL_GAIN_INDEX_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC 和 PA索引结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwRficGainIndex;                       /* 每档增益下，RFIC索引 */
    VOS_UINT16                          uhwPaGainIndex;                         /* 每档增益下，PA索引 */
}UCOM_NV_RFIC_PA_CTRL_GAIN_INDEX_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_RFIC_PA_CTRL_INDEX_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC 和 PA索引结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              uwValidCount;                       /* 档位有效个数 */
    UCOM_NV_RFIC_PA_CTRL_GAIN_INDEX_STRU    stRficPaCtrlGainIndex[UCOM_NV_RFIC_PA_GAIN_INDEX_MAX_NUM]; /* 线性PA下每档增益的RF和PA索引 */
}UCOM_NV_GSM_RFIC_PA_CTRL_INDEX_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_PRECHARGE_OFFSET_VS_PCL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 线性PA情况下，不同PCL下的PrechargeOffset，类似与饱和PA的precharge
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwPrechargeOffset[UCOM_NV_G_PCL_NUM];  /* 不同PCL下的PrechargeOffset */
}UCOM_NV_GSM_PRECHARGE_OFFSET_VS_PCL_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_SAR_BACK_OFF_POWER_ADDITIONAL
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM下BODY SAR(additional,5mm)各档位的回退值,分直通态和交叉态，各16档
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwGsmSarDpdtThrough[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];      /* 直通态 */
    VOS_INT16                           ashwGsmSarDpdtSwap[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];         /* 交叉态 */

}UCOM_NV_GSM_SAR_BACKOFF_POWER_ADDITIONAL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_SAR_BACK_OFF_POWER_ADDITIONAL
 协议表格  :
 ASN.1描述 :
 结构说明  : WCDMA下BODY SAR(additional,5mm)各档位的回退值,分直通态和交叉态，各16档
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwWcdmaSarDpdtThrough[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];    /* 直通态 */
    VOS_INT16                           ashwWcdmaSarDpdtSwap[UCOM_NV_SAR_BACKOFF_ADDITIONAL_NUM];       /* 交叉态 */
}UCOM_NV_W_SAR_BACKOFF_POWER_ADDITIONAL_STRU;
...
/*****************************************************************************
 枚举名    : UCOM_NV_GSM_RX_AGC_CTRL_B_STRU
 协议表格  :
 枚举说明  : 5.3G下行AGC增益控制字,BOSTON使用
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          aunBlkRxAgcCtrl[UCOM_NV_G_AGC_BLK_MAX_NUM];     /* block下AGC增益控制字 */
    VOS_UINT32                          aunNoBlkRxAgcCtrl[UCOM_NV_G_AGC_NOBLK_MAX_NUM]; /* noblock下AGC增益控制字 */
}UCOM_NV_GSM_RX_AGC_CTRL_B_STRU;

/*****************************************************************************
 枚举名    : UCOM_NV_GSM_RX_AGC_CTRL_B_STRU
 协议表格  :
 枚举说明  : 5.3G下行AGC增益控制字,BOSTON之前使用
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 枚举名    : UCOM_NV_GSM_AGC_SLOWMEAS_THRESHOLD_STRU
 协议表格  :
 枚举说明  : 慢速AGC增益切换门限,BOSTON使用
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwInc[UCOM_NV_G_GAIN_THRESHOLD_MAX_NUM];  /* 切换迟滞 */
    VOS_INT16                           ashwDec[UCOM_NV_G_GAIN_THRESHOLD_MAX_NUM];  /* 切换门限 */
}UCOM_NV_GSM_AGC_SLOWMEAS_THRESHOLD_STRU;

/*****************************************************************************
 枚举名    : UCOM_NV_GSM_AGC_THRESHOLD_STRU
 协议表格  :
 枚举说明  : AGC增益切换门限,BOSTON使用
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_AGC_SLOWMEAS_THRESHOLD_STRU     stAgcSlowMeasThrd;                 /* 慢速测量切换门限 */
    UCOM_NV_GSM_AGC_FASTMEAS_THRESHOLD_STRU     stAgcFastMeasThrd;                 /* 快速测量切换门限 */
}UCOM_NV_GSM_AGC_THRESHOLD_STRU;

/*****************************************************************************
 枚举名    : UCOM_NV_GSM_RX_AGC_SWITCH_THRESHOLD_STRU
 协议表格  :
 枚举说明  : AGC增益切换门限，BOSTON使用
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_AGC_THRESHOLD_STRU              stBlkAgcSwitchThrd;               /* block下测量切换门限 */
    UCOM_NV_GSM_AGC_THRESHOLD_STRU              stNoBlkAgcSwitchThrd;             /* noblock测量下切换门限 */
}UCOM_NV_GSM_AGC_SWITCH_THRESHOLD_B_STRU;

/*****************************************************************************
 枚举名    : UCOM_NV_GSM_AGC_SWITCH_THRESHOLD_STRU
 协议表格  :
 枚举说明  : 慢速AGC增益切换门限，BOSTON之前使用
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_EXT_LNA_INFO_B_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EXT LNA INFO,BOSTON使用
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT32                               auwBlkGainIndex[UCOM_NV_G_LNA_GAIN_INDEX_NUM];     /* BLOCK下AGC档位的lna增益索引*/
    VOS_UINT32                               auwNoBlkGainIndex[UCOM_NV_G_LNA_GAIN_INDEX_NUM];   /* NOBLOCK下AGC档位的lna增益索引*/
}UCOM_NV_GSM_EXT_LNA_INFO_B_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_EXT_LNA_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EXT LNA INFO,BOSTON之前使用
*****************************************************************************/
typedef struct
{
    VOS_UINT32                               uwGpioEnable;                              /* GPIO使能信号 */
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_EXT_LNA_COMMON_INFO_B_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EXT LNA COMMON INFO,BOSTON使用
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_EXT_LNA_INFO_B_STRU            stMainLnaInfo;                   /* 主集mipi lna 信息 */
    UCOM_NV_GSM_EXT_LNA_INFO_B_STRU            stDivLnaInfo;                    /* 分集mipi lna 信息  */
}UCOM_NV_GSM_EXT_LNA_COMMON_INFO_B_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_EXT_LNA_COMMON_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : EXT LNA COMMON INFO,BOSTON之前使用
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : UCOM_NV_MODEM_W_RF_DIV_BAND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 是否支持分集
*****************************************************************************/
typedef struct
{
    VOS_UINT32          uwWBand;
    VOS_UINT32          uwWbandExtRsv;
}UCOM_NV_MODEM_W_RF_DIV_BAND_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                              uwRfResetPeriod;                    /* RESET RF的最小间隔，考虑到用户使用方便，单位ms,范围[0,65536000] */
    VOS_UINT16                              uhwRfResetSwitch;                   /* RF RESET特性开关，0表示特性关闭，1表示特性打开 */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_UL_RF_DPD_GATE_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              uwUlRfDpdGate0;
    VOS_UINT32                              uwUlRfDpdGate1;
}UCOM_NV_W_UL_RF_DPD_GATE_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_OFF_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_IDLE_ON_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_IDLE_OFF_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_ABB_INIT_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_ABB_OFF_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
...
typedef struct
{
    ...
    VOS_UINT16                          uhwDsdsCWBcchCollisonElu;               /* W解广播与1X paging解广播规避 */
...
typedef struct
{
    ...
    VOS_UINT16                          auhwRxCalChan[UCOM_NV_RX_MAX_CAL_FREQ_NUM];        /* _H2ASN_Replace PHY_UINT16_ARRAY2_16 auhwRxCalChan[UCOM_WCDMA_BAND_NUM][UCOM_NV_W_UARFCN_NUM]; */ /* RX频点区间，3个频段，每个频段16个UARFCN */
...
typedef struct
{
    VOS_INT16                           ashwRxAgcFreqComp[UCOM_NV_RX_MAX_CAL_FREQ_NUM];
...
typedef struct
{
    VOS_INT16                           ashwRxAgcFreqComp[UCOM_NV_W_AGC_GAIN_STEP_NUM][UCOM_NV_W_RX_FREQ_COMP_NUM];
}UCOM_NV_W_RX_AGC_FREQ_COMP_STRU;
...
typedef struct
{
    /* GPIO配置 */
    VOS_UINT32                               uwGpioEnable;                              /* GPIO使能信号 */
    VOS_UINT32                               uwLnaGpioNumber;                           /* GPIO支持的档位数*/
    VOS_UINT32                               auwLnaGpio[UCOM_NV_W_LNA_GPIO_STEP_NUM];   /* GPIO方式的LNA配置 */
    VOS_UINT32                               uwLnaGpioMask;                             /* 使用的LNA GPIO的掩码 */

    /* MIPI配置 */
    VOS_UINT32                               uwMipiEnable;                              /* MIPI使能信号*/
    VOS_UINT32                               uwLnaMipiNumber;                           /* MIPI支持的档位数*/
    ...
    /* LNA配置索引表 */
    VOS_UINT32                               auwUnBlockGainIndex[UCOM_NV_W_AGC_GAIN_NOBLK_STEP_NUM];/* BLOCK下AGC档位的lna索引*/
...
typedef struct
{
    UCOM_NV_W_EXT_LNA_INFO_STRU              stMainLnaInfo;                     /* 主集lna 信息 */
    UCOM_NV_W_EXT_LNA_INFO_STRU              stDivLnaInfo;                      /* 分集lna 信息  */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_RX_TIME_DOMAIN_HARMONIC_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 下行时域谐波信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                      uwHarmonicFlag;                         /* 当前band是否存在谐波并对下行产生干扰 */
    UCOM_NV_W_HARMONIC_TYPE_ENUM_UINT16             enHarmonicType;                         /* 当前band谐波来源 */
    VOS_UINT32                                      uwHarmonicNum;                          /* 谐波数目 */
    VOS_UINT16                                      auhwHarmonicFreq[UCOM_NV_HARMONIC_NUM]; /* 谐波频率，单位100khz */
    VOS_INT16                                       shwEnableRssi;                          /* 打开谐波消除的门限,单位1db */
    VOS_INT16                                       shwDisableRssi;                         /* 关闭谐波消除的门限,单位1db */

}UCOM_NV_W_RX_TIME_DOMAIN_HARMONIC_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_HARMONIC_OPT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM谐波信息
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwHarmonicFlag;                        /* 是否存在谐波并对下行产生干扰 */
    VOS_UINT16                          uhwHarmonicNum;                         /* 谐波数目 */
    VOS_UINT16                          auhwHarmonicFreq[UCOM_NV_GSM_HARMONIC_NUM]; /* 谐波频率，单位100khz */
    VOS_UINT16                          uhwReserved0;                           /* 保留0 */
    VOS_UINT16                          uhwReserved1;                           /* 保留1 */
}UCOM_NV_GSM_HARMONIC_OPT_STRU;
...
{
    VOS_UINT16                          uhwValidCalChanNum;
    VOS_UINT16                          auhwTxCalChan[UCOM_NV_TX_MAX_CAL_FREQ_NUM];        /* _H2ASN_Replace PHY_UINT16_ARRAY2_16 auhwRxCalChan[UCOM_WCDMA_BAND_NUM][UCOM_NV_W_UARFCN_NUM]; */ /* RX频点区间，3个频段，每个频段16个UARFCN */
...
typedef struct
{
    VOS_INT16                           ashwTxHdetFreqComp[UCOM_NV_TX_MAX_CAL_FREQ_NUM];                       /* 不同频点对功率器件影响不同，频率补偿值 */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_FET_DYN_DECODE_SNR_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : FET动态译码启动时隙配置
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwFetDecodeStartSlot;                  /* FET动态译码启动时隙 */
    VOS_UINT16                          uhwFetDecodeSnrThre;                    /* FET动态译码启动时隙相应SNR门限 */
...
typedef struct
{
    ...
    VOS_UINT16                                uhwFetBlindDynDecodeEnable;       /* 盲检测下动态配置FET译码启动时隙开关，打开为1，关闭为0 */
    VOS_UINT16                                uhwFetNoBlindDynDecodeEnable;     /* 非盲检测下动态配置FET译码启动时隙开关，打开为1，关闭为0 */
    VOS_UINT16                                uhwCodedLenSrb;                   /* 信令编码块长度 */
    VOS_UINT16                                uhwSrbRmLocal;                    /* 信令信道传输速率 */
    VOS_UINT16                                uhwTrch0RmLocal;                  /* 传输信道0的传输速率 */
    VOS_UINT16                                uhwReserved;                      /* 保留 */
...
typedef struct
{
    VOS_UINT16                          uhwMPAntRssiEstiEnable;                 /* 主辅天线RSSI差值评估开关 */
    VOS_INT16                           shwMPAntRssiThers;                      /* 主天线比辅天线的RSSI值高出的门限值 */
}UCOM_NV_W_MP_USEANT2_THRESHOLD_STRU;
...
typedef struct
{
    VOS_UINT16                          uhwRfSsiChannel;                        /* RFIC选择SSI通道 */
    ...
    VOS_UINT16                          uhwUsIdBit3;                            /* RX所在RFIC的硬件USID BIT3 */
...
typedef struct
{
    VOS_UINT16                          uhwAbbChannel;                          /* ABB通道选择 */
    VOS_UINT16                          uhwRfSsiChannel;                        /* RFIC选择SSI通道 */
    VOS_UINT16                          uhwFbPin;                               /* RFIC的Mrx通道选择 */
    VOS_UINT16                          uhwUsIdBit3;                            /* TX所在RFIC的硬件USID BIT3 */
...
typedef struct
{
    ...
    VOS_UINT32                          uwRxIqImbalanceFlag    :1;              /* RxIqImbalance功能是否打开的标记 */
    VOS_UINT32                          uwReserved2            :25;
...
/*****************************************************************************
 结构名    : UCOM_NV_TAS_DPDT_MIPI_CTRL_WORD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : tas mipi寄存器控制字
*****************************************************************************/
...
{
    VOS_UINT16                          uhwCmdValidCnt;
    UCOM_NV_MIPI_CMD_STRU               astTasDpdtMipiCmd[UCOM_NV_MAX_MIPI_TAS_CMD_NUMBER];   /* 命令字 */
    UCOM_NV_MIPI_BYTE_DATA_STRU         astTasDpdtMipiData[UCOM_NV_MAX_MIPI_TAS_DATA_NUMBER]; /* 数据 */
}UCOM_NV_TAS_DPDT_MIPI_CTRL_WORD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_TAS_DPDT_MIPI_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : tas mipi寄存器控制字
*****************************************************************************/
typedef struct
{
    UCOM_NV_TAS_DPDT_MIPI_CTRL_WORD_STRU stTasDpdtThrough;                      /* 直通态的配置 */
    UCOM_NV_TAS_DPDT_MIPI_CTRL_WORD_STRU stTasDpdtSwap;                         /* 交叉态的配置 */
...
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_UL_RF_GATE_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CFR门限，区分开关DPD，需要区分1X，HRPD
*****************************************************************************/
typedef struct
{
    /* for 1X */
    VOS_UINT32                              uwUlRfGate0;
    VOS_UINT32                              uwUlRfGate1;
    VOS_UINT32                              uwUlRfDpdGate0;                     /* 支持DPD时，GATE0门限 */
    VOS_UINT32                              uwUlRfDpdGate1;                     /* 支持DPD时，GATE1门限 */

    /* for HRPD */
    VOS_UINT32                              uwEvdoUlRfGate0;
    VOS_UINT32                              uwEvdoUlRfGate1;
    VOS_UINT32                              uwEvdoUlRfDpdGate0;                 /* 支持DPD时，GATE0门限 */
    VOS_UINT32                              uwEvdoUlRfDpdGate1;                 /* 支持DPD时，GATE1门限 */

}UCOM_NV_CDMA_UL_RF_GATE_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                          uhwTxDpdDelay;                          /* 支持DPD时上行延迟调整 */
    VOS_UINT16                          uhwCfrDelay;                            /* 削波打开时的延时量，单位 1/4chip，默认值 */
    VOS_UINT16                          uhwEtActEnOffsetDelay;                  /* ET线控使能关闭相对于上行关闭的延迟, 单位1/4chip */
...
typedef struct
{
    ...
    VOS_UINT16                          uhwReserved;
    VOS_UINT32                          auwRxFrequencyKHz[UCOM_NV_RX_MAX_CAL_FREQ_NUM];  /* 频率表，单位KHz */
}UCOM_NV_CDMA_RX_CAL_FREQ_STRU;


/*****************************************************************************
 枚举名    : UCOM_NV_CDMA_RX_AGC_FAST_SWITCH_THRESHOLD_STRU
 协议表格  :
 枚举说明  : AGC快切门限
*****************************************************************************/
typedef struct
{
    VOS_UINT16                           uhwNoBlockAgcFastSwitchThrd;           /* NOBLOCK下快切门限 */
    VOS_UINT16                           uhwBlockAgcFastSwitchThrd;             /* BLOCK下快切门限 */
...
/*****************************************************************************
 ...
 协议表格  :
 枚举说明  : 非语音模式，非外置LNA下，AGC档位切换门限的NV项，包括BLOCK和非BLOCK
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 枚举名    : UCOM_NV_CDMA_RX_AGC_CTRL_STRU
 协议表格  :
 枚举说明  : 无外置LNA时，AGC控制字，包括BLOKC和非BLOCK
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : UCOM_NV_W_RX_AGC_SECDONARY_FREQ_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : AGC每档的频补值,新方案
*****************************************************************************/
typedef struct
{
    VOS_INT16           ashwAgcFreqComp[UCOM_NV_CDMA_AGC_STATUS_NUM][UCOM_NV_CDMA_AGC_FREQ_COMP_NUM];
}UCOM_NV_CDMA_RX_AGC_FREQ_COMP_STRU;
...
typedef struct
{
    VOS_UINT16                          uhwValidCalChanNum;                          /* 频率个数 */
    VOS_UINT16                          uhwReserved;
    VOS_UINT32                          auwTxFrequencyKHz[UCOM_NV_TX_MAX_CAL_FREQ_NUM];  /* 频率值,单位KHz */
...
typedef struct
{
    ...
    UCOM_NV_CDMA_RX_AGC_FAST_SWITCH_THRESHOLD_STRU  stAgcFastSwitchThrd;       /* normal+非外置LNA下快切门限 */
    UCOM_NV_CDMA_RX_AGC_FAST_SWITCH_THRESHOLD_STRU  stAgcFastSwitchThrdVoiceLna;/* 语音+外置LNA下快切门限 */
    UCOM_NV_CDMA_RX_AGC_FAST_SWITCH_THRESHOLD_STRU  stAgcFastSwitchThrdLna;    /*  normal+外置LNA下快切门限 */
    UCOM_NV_CDMA_RX_AGC_FAST_SWITCH_THRESHOLD_STRU  stAgcFastSwitchThrdVoice;  /* 语音+非外置LNA下快切门限 */
...
typedef struct
{
    ...
    VOS_UINT32                          uwTestRxPart:1;                         /* RFIC1 Rx测试特性开关,1-打开,0-关闭，默认关闭 */
    VOS_UINT32                          uwTestErachSf8Elusion:1;                /* ERACH下规避华为网络问题，容量限制SF8时不打孔 */
    VOS_UINT32                          uwTestDcmScene:1;                       /* DCM场景采用不同的最早径最强径间隔值，1-DCM,0-非DCM，默认非DCM */
    VOS_UINT32                          uwReserve:26;
}UCOM_NV_W_TEST_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_G_TEST_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM测试特性专用开关，默认测试特性都为关闭。0表示开关关闭 1表示开关打开
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwReserve1:3;
    VOS_UINT32                          uwTestRxPart:1;     /* DSDS2.0 RFIC1 RX测试特性开关，1-打开，0-关闭，默认关闭 */
    VOS_UINT32                          uwKeyRfRecover:1;   /* 恢复RF关键寄存器开关 */
    VOS_UINT32                          uwReserve2:27;
}UCOM_NV_G_TEST_CTRL_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_LIF_FREQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 低中频频率
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwLIFFreq;                              /* 低中频频率 */
}UCOM_NV_GSM_LIF_FREQ_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                      uhwDoubleModemDelayTime;  /* 双卡互相影响可能产生的延迟时间，单位us */
    VOS_UINT16                      uhwResverd2;
}UCOM_NV_CDMA_LPC_ADV_WAKEUP_TIME_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_DVS_SWITCH_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CBBE16降频降压开关,chicago及其之后版本支持该功能
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwDvsSwitch;                   /* CBBE16降频降压开关 */
    VOS_UINT16          uhwResverd;                     /* 保留位 */
}UCOM_NV_CDMA_DVS_SWITCH_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ACH_PWRINC_SWITCH_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ACH发送功率抬升开关
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwAchPwrIncSwitch;              /* ACH发送功率抬升开关 */
    VOS_UINT16          uhwReserved;                     /* 保留位 */
}UCOM_NV_CDMA_ACH_PWRINC_SWITCH_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RF_RX_BIAS_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC RX的BIAS控制字，区分BLK,NBLK
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          auhwBlockStateBias[UCOM_NV_CDMA_AGC_GAIN_BLK_STEP_NUM]; /* block bias的NV项 */
    VOS_UINT16                          auhwNoBlockStateBias[UCOM_NV_CDMA_AGC_GAIN_NOBLK_STEP_NUM]; /* no block bias的NV项 */
}UCOM_NV_CDMA_RF_RX_BIAS_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RF_RX_BIAS_DELTA_GAIN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 语音模式下的AGC增益补偿，区分BLK,NBLK
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwBlockStateDeltaGain[UCOM_NV_CDMA_AGC_GAIN_BLK_STEP_NUM]; /* block delta gain的NV项 */
    VOS_INT16                           ashwNoBlockStateDeltaGain[UCOM_NV_CDMA_AGC_GAIN_NOBLK_STEP_NUM]; /* no block delta gain的NV项 */
}UCOM_NV_CDMA_RF_RX_BIAS_DELTA_GAIN_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RX_RFIC_BIAS_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC BIAS配置信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                  uwRxBiasEnable;                 /* 是否支持语音低功耗, 0 不支持，1-支持 */
    UCOM_NV_CDMA_RF_RX_BIAS_STRU                stRfRxBiasNormalMode;           /* 正常模式下, Rx Bias配置 */
    UCOM_NV_CDMA_RF_RX_BIAS_STRU                stRfRxBiasVoiceMode;             /* VOICE模式下,Rx Bias配置 */
    UCOM_NV_CDMA_RF_RX_BIAS_DELTA_GAIN_STRU     stRfRxBiasDeltaGain;       /* VOICE模式与正常模式下的增益差 */
...
/*****************************************************************************
 结构名    : UCOM_NV_INTERFE_JUDGE_BUSINESS_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 干扰判决业务类型定义
*****************************************************************************/
...
/*****************************************************************************
 结构名    : UCOM_NV_POWER_BACKOFF_BUSINESS_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 最大功率回退业务类型定义
*****************************************************************************/
...
typedef struct
{
	...
	VOS_UINT16                                  uhwGRxBlankingPower     : 12;   /* 此BAND\mode组合下，G执行RX BLANKING的功率门限，单位0.1 DB */
	VOS_UINT16                                  uhwHarmonicTxBlanking   : 4;    /* 谐波因子，0 不考虑谐波干扰，1 考虑谐波干扰 */
...
typedef struct
{
    ...
    VOS_UINT16                                          uhwDsds2Rf1FddIdle;     /* Dsds2.0 辅通道 FDD IDLE*/
} UCOM_NV_FEATURE_INTERFE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_TAS_CTRL_WORD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 天线交换控制字
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              uwCdmaAntMasPassThroughTasPassThroughCtrlWord;      /* 天线MAS=0,TAS=0时的GPIO控制字 */
    VOS_UINT32                              uwCdmaAntMasPassThroughTasSwapCtrlWord;             /* 天线MAS=0,TAS=1时时的GPIO控制字 */
    VOS_UINT32                              uwCdmaAntMasSwapTasPassThroughCtrlWord;             /* 天线MAS=1,TAS=0时的GPIO控制字 */
    VOS_UINT32                              uwCdmaAntMasSwapTasSwapCtrlWord;                    /* 天线MAS=1,TAS=1时时的GPIO控制字 */
}UCOM_NV_CDMA_TAS_CTRL_WORD_STRU;
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_TAS_MAS_RF_CTRL_STRU
 协议表格  :
 ASN.1描述 : auwBandBlindSwitchMap是针对每个band是否使用TAS盲切算法做的bitmap。
             bit位为1，代表此band使用盲切算法，否则反之。
 结构说明  : TAS射频相关控制参量
...
typedef struct
{
    VOS_UINT32                              uwBandBlindSwitchMap;               /* BAND是否适用盲切 */
    UCOM_NV_CDMA_TAS_CTRL_WORD_STRU         stTasCtrlWord;                      /* 天线切换控制字 */
    VOS_UINT32                              uwBandIaEnable;                     /* uwBandIaEnable 从低到高分别代表Bc0~Bc10是否支持Ia:0,不支持；1，支持*/
    VOS_UINT32                              uwBandIbEnable;                     /* uwBandIbEnable 从低到高分别代表Bc0~Bc10是否支持Ib:0,不支持；1，支持*/

}UCOM_NV_CDMA_TAS_MAS_RF_CTRL_STRU;
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_HPRD_DRX_PAGING_OFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : hrpd drx寻呼唤醒提前量，单位slot
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                          uhwHrpdDrxPagingOffset;          /* hrpd drx寻呼唤醒提前量 */
    VOS_UINT16                                          uhwHrpdDrxPagingOffsetForHSTrainMode; /* hrpd drx高铁模式寻呼唤醒提前量 */
} UCOM_NV_CDMA_HPRD_DRX_PAGING_OFFSET_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_1X_OCCUPY_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 1X是否支持抢占开关，默认不支持抢占
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwIs1xOccupyFlag;     /* 是否支持1X抢占开关，用于SVLTE,SRLTE使用模式判断 */
...
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_EXT_LNA_COMMON_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CDMA外置LNA配置信息，区分主分集
*****************************************************************************/
typedef struct
{
    UCOM_NV_CDMA_EXT_LNA_INFO_STRU              astExtLnaInfo[UCOM_NV_CDMA_ANT_NUM];  /* 主分集LNA配置 */
}UCOM_NV_CDMA_EXT_LNA_COMMON_INFO_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RX_AGC_CTRL_EXT_LNA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CDMA外置LNA时，AGC控制字
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_RX_AGC_CTRL_STRU      stRxAgcCtrl;
...
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_VOICE_EXT_LNA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 语音模式+外置LNA，AGC档位切换门限
*****************************************************************************/
typedef UCOM_NV_CDMA_RX_AGC_GAIN_SWITCH_THRESHOLD_STRU  UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_VOICE_EXT_LNA_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_EXT_LNA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 非语音模式+外置LNA，AGC档位切换门限
*****************************************************************************/
typedef UCOM_NV_CDMA_RX_AGC_GAIN_SWITCH_THRESHOLD_STRU   UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_EXT_LNA_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_VOICE_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 语音模式+非外置LNA，AGC档位切换门限
*****************************************************************************/
typedef UCOM_NV_CDMA_RX_AGC_GAIN_SWITCH_THRESHOLD_STRU  UCOM_NV_CDMA_RX_AGC_SWITCH_THRD_VOICE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_HRPD_GAP_WORK_AROUND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : hrpd是否规避"沟长在300ms左右时网络A9-AL Disconnected"，默认规避
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwGap300msWorkAroundEnable;                       /* 规避使能: 1 使能；0 不使能 */
    VOS_UINT16          uhwReserved;
}UCOM_NV_CDMA_HRPD_GAP_WORK_AROUND_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_TX_HIGH_POWER_PROTECT_GPIO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : G模大功率保护相关控制参数
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              uwEnable;                           /* 1:表示根据功率输出不同的线控 */
    VOS_UINT32                              uwPowerThrd;                        /* 功率门限，0.1dbm */
    VOS_UINT32                              uwHighPowerGpioValue;               /* 大功率时，输出线控 */
    VOS_UINT32                              uwLowPowerGpioValue;                /* 小功率时，输出线控 */
}UCOM_NV_GSM_TX_HIGH_POWER_PROTECT_GPIO_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_C_TEST_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : CDMA测试特性专用开关，默认测试特性都为关闭。0表示开关关闭 1表示开关打开
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwPilotCtrlEnable:1;
    VOS_UINT32                          uwReserve1:2;
    VOS_UINT32                          uwTestRxPart:1;                         /* RFIC1 Rx测试特性开关,1-打开,0-关闭，默认关闭 */
    VOS_UINT32                          uwPaPowerCtrlTest  :1;                  /* 1-不支持直接上下电PA,0-支持PA直接上下电PA */
    VOS_UINT32                          uwRfReadBackFlag :1;                    /* RFIC回读功能是否打开，默认开 */
    VOS_UINT32                          uwRfRecoveryOpen:1;                     /* 关键寄存器保护是否打开 */
    VOS_UINT32                          uwReserve2:25;
}UCOM_NV_C_TEST_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_MIPI_APT_TIMING_CFG_STRU
 协议表格  :
 结构说明  : PA的控制信息提前于时隙头生效时间，单位chip
*****************************************************************************/
typedef struct
...
/*****************************************************************************
 结构名    : UCOM_NV_CDMA_APT_CTRL_PARA_STRU
 协议表格  :
 结构说明  : APT控制信息
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_APT_CTRL_STRU                stAptCtrlInfo;
    UCOM_NV_MIPI_CMD_STRU                  astPaVccMipiCmdPaStatus[UCOM_NV_CDMA_TX_PA_MODE_NUM];     /* PA Vcc的mipi控制指令,数据在APT中,高中低三档 */
    UCOM_NV_MIPI_CMD_STRU                  astPaVbias1MipiCmdPaStatus[UCOM_NV_CDMA_TX_PA_MODE_NUM];  /* 配置PA Vbias1的控制指令，数据在APT中 */
    UCOM_NV_MIPI_CMD_STRU                  astPaVbias2MipiCmdPaStatus[UCOM_NV_CDMA_TX_PA_MODE_NUM];  /* 配置PA Vbias2的控制指令，数据在APT中 */
    UCOM_NV_MIPI_CMD_STRU                  astPaVbias3MipiCmdPaStatus[UCOM_NV_CDMA_TX_PA_MODE_NUM];  /* 配置PA Vbias3的控制指令，数据在APT中 */
    UCOM_NV_W_APT_MIPI_PA_TRIGGER_STRU     stMipiPaTrigger;                                  /* Mipi PA Trigger指令，保证APT表中Pa指令同时生效，避免临界情况  */
    UCOM_NV_CDMA_MIPI_APT_TIMING_CFG_STRU  stMipiAptTimingInfo;                              /* PA的控制信息提前于时隙头生效时间，单位chip */
...
typedef struct
{
    VOS_UINT32                          uwTxFreqKhz;                             /* 频率 */
    VOS_INT16                           shwFreqComp;                            /* delay comp */
    VOS_UINT16                          uhwReserved;                            /* reserved; */
}UCOM_NV_CDMA_ET_DELAY_FREQ_STRU;
...
{
    VOS_UINT32                          uwChannelNum;                           /* 每个Band有效个数 */
    UCOM_NV_CDMA_ET_DELAY_FREQ_STRU     astEtDelayFreq[UCOM_NV_CDMA_ET_DELAY_FREQ_COMP_MAX_NUM];/* Et 包络通路Time Delay */
}UCOM_NV_CDMA_ET_TIME_DELAY_FREQ_COMP_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_TIME_DELAY_TEMP_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET LUT的温度补偿
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwTempComp[UCOM_NV_CDMA_TX_PA_TEMP_NUM];      /* P-Vcc LUT的温度补偿 */
}UCOM_NV_CDMA_ET_TIME_DELAY_TEMP_COMP_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_ENVELOP_TIME_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET Time Delay校准结果
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwEnvelopDelay;                        /* Et 包络通路Time Delay */
    VOS_UINT16                          uhwRslv;                                /* 保留 */
}UCOM_NV_CDMA_ET_TIME_DELAY_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_COEFF_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 按照功率查表类型时，可以近似认为功率和电压的满足现行关系V = P*Gain+GainOffet，
 不同单板的（Gain, GainOffset）可以通过校准获得，通过软件半静态配置
...
typedef struct
{
    VOS_INT16                           shwGain;                                /* ET LUT 修正斜率 */
    VOS_INT16                           shwGainOffset;                          /* ET LUT 修正偏移 */
}UCOM_NV_CDMA_ET_COEFF_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_PA_VCC_DATA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 复数数据结构
*****************************************************************************/
typedef struct
{
    VOS_INT16                           shwPower;                                /* 功率或APC index */
    VOS_INT16                           shwPaVcc;                                /* 电压控制字 */
}UCOM_NV_CDMA_ET_PA_VCC_DATA_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_PWR_VCC_LUT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET  LUT表结构
*****************************************************************************/
typedef struct
{
    UCOM_NV_CDMA_ET_PA_VCC_DATA_STRU       astEtPaData[UCOM_NV_ET_LUT_MAX_LEN];  /* LUT数据 */
}UCOM_NV_CDMA_ET_PWR_VCC_LUT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_INT_TIME_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 可能只需要校准包络通路分数延时，所以定义整数延时默认值
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT16                          uhwEtPathIntDelay;                      /* 包络通路整数延时 */
}UCOM_NV_CDMA_ET_INT_TIME_DELAY_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_EN_MASK_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET DPD是否支持
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwEtBandMask;   /* bit0为1表示支持band0, 类推 */
    VOS_UINT32                          uwResv;
}UCOM_NV_CDMA_ET_EN_MASK_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_DPD_EN_MASK_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET DPD是否支持
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwDpdBandMask;   /* bit0为1表示支持band0, 类推 */
    VOS_UINT32                          uwResv;
}UCOM_NV_CDMA_DPD_EN_MASK_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                          uwMrxDcAdjust   :2;                 /* MRX直流调整 */
    VOS_UINT32                          uwReserved2     :23;
}UCOM_NV_CDMA_ET_CAL_MRX_CFG_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_LUT_CAL_FE_CFG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET模式下LUT提取及LUT校准时RFIC的MRX配置修改以及ETM的控制配置
*****************************************************************************/
typedef struct
{
    UCOM_NV_CDMA_ET_CAL_MRX_CFG_STRU      stMrxCfg;         /* MRX配置参数 */
    UCOM_NV_ET_MIPI_WORD_STRU             stEtMCalCfg;      /* ETM在LUT提取时需要配置特殊模式 */
}UCOM_NV_CDMA_ET_LUT_CAL_FE_CFG_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_RFFE_MIPI_ETM_CTRL_STRU
 协议表格  :
 结构说明  : Et modulator 的MIPI控制字,随PA档位配置
*****************************************************************************/
typedef struct
{
    UCOM_NV_ET_MIPI_WORD_STRU               stEtMOn;            /* ET器件MIPI打开控制字 */
    UCOM_NV_ET_MIPI_WORD_STRU               stEtMOff;           /* ET器件MIPI关闭控制字 */
    UCOM_NV_ET_MIPI_WORD_STRU               stMipiEtMode;       /* ET器件配置为ET 模式mipi控制字 */
    UCOM_NV_ET_MIPI_WORD_STRU               stMipiMAptMode;     /* ET器件配置为中增益APT模式mipi控制字 */
    UCOM_NV_ET_MIPI_WORD_STRU               stMipiLAptMode;     /* ET器件配置为低增益APT模式mipi控制字 */
}UCOM_NV_CDMA_RFFE_MIPI_ETM_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_TIME_DELAY_CAL_PARA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : Et Delay 搜索校准信息
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwCenterEnvelopTimeDelay;              /* delay的中心值 */
    ...
    VOS_UINT16                          uhwSweepRange;                          /* 扫描范围 */
    VOS_UINT16                          uhwSweepStep;                           /* 扫描步长 */
}UCOM_NV_CDMA_ET_TIME_DELAY_CAL_PARA_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_CDMA_ET_TIME_DELAY_FREQ_CAL_CHAN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ET Time Delay频补校准信道,频率值
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwEtTimeDelayCalEnable;
    VOS_UINT16                          uhwChannelNum;                          /* 每个Band有效个数 */
    VOS_UINT32                          auwFreqChan[UCOM_NV_CDMA_ET_DELAY_FREQ_COMP_MAX_NUM];/* Et 包络通路Time Delay */
}UCOM_NV_CDMA_ET_TIME_DELAY_FREQ_CAL_CHAN_STRU;
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  : ET Time Delay 频补default值
*****************************************************************************/
typedef struct
{
    VOS_INT16                           ashwDefault[UCOM_NV_CDMA_ET_DELAY_FREQ_COMP_MAX_NUM];
}UCOM_NV_CDMA_ET_TIME_DELAY_FREQ_COMP_DEFAULT_STRU;

/* ET LUT cal struct end */

/*****************************************************************************
 结构名    : UCOM_NV_TEST_MIPI_READ_CMD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MIPI 指令控制段定义
*****************************************************************************/
typedef struct
{
    VOS_UINT32                  uwSlaveAddr    :4;                              /* Mipi Slave地址，有效值0-15 */
    VOS_UINT32                  uwRegAddr      :16;                             /* 寄存器地址 OR 起始地址 */
    VOS_UINT32                  uwMasterSel    :3;                              /* MIPI通道 */
    VOS_UINT32                  uwRsv          :9;                              /* 保留 */
}UCOM_NV_CDMA_TEST_MIPI_READ_CMD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_TEST_MIPI_READ_STRU
 协议表格  :
 结构说明  : 用于测试MIPI回读
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwReadRffeValidCnt;
    VOS_UINT16                              uhwReadRficValidCnt;
    UCOM_NV_CDMA_TEST_MIPI_READ_CMD_STRU    astRffeMipiCmd[UCOM_NV_TEST_MIPI_READ_MAX_NUM];
    UCOM_NV_CDMA_TEST_MIPI_READ_CMD_STRU    astRficMipiCmd[UCOM_NV_TEST_MIPI_READ_MAX_NUM];
}UCOM_NV_CDMA_TEST_MIPI_READ_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_ABB_HARMONY_OPT_ENABLE_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : abb谐波点优化
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                   uwEnable;                      /* 0:关闭功能 1:打开ABB谐波点优化功能 */
    VOS_UINT16                                   uhwReserved;                   /* 保留 */
}UCOM_NV_W_ABB_HARMONY_OPT_ENABLE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_CS_TX_PCL_OPTI_CTRL_STRU
 结构说明  : GSM各频段上行发射功率异常场景的优化配置参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwPclOptiEn;                       /* 调整上行发射功率使能开关 0--关闭 1--打开 */
    VOS_INT16                               shwRssiOptiThd;                     /* 通过路损调整上行发射功率方案的RSSI生效门限*/
    VOS_UINT16                              uhwPclOptiThd;                      /* 通过路损调整上行发射功率方案的PCL生效门限 */
    VOS_UINT16                              uhwTxPclMaxStep;                    /* 通过路损调整上行发射功率抬高最大PCL门限 */
    VOS_INT16                               shwDlTxLevel;                       /* 基站下行最大发射功率 */
    VOS_INT16                               shwUlRxRefSensLevel;                /* 基站上行接收灵敏度电平 */
}UCOM_NV_GSM_CS_TX_PCL_OPTI_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_HRPD_DRC_LEN_MISMATCH_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 当网络配置的DRC Length为2个slots或者8个slots时，
             检测到DRC Length不匹配后是否尝试DRC Length为4个slots。
             默认使能尝试。
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwDrcLenMismatchEnable;                                /* 使能尝试4 slots: 1; 不使能: 0 */
    VOS_UINT16          uhwReserved;
}UCOM_NV_CDMA_HRPD_DRC_LEN_MISMATCH_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_HRPD_INCREASE_RRI_DATA_POWER_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 增加RRI信道和DATA信道功率
             默认不使能。
*****************************************************************************/
typedef struct
{
    VOS_UINT16          uhwIncreasePowerEnable;                                 /* 1:使能增加RRI和DATA功率方案; 0:不使能 */
    VOS_UINT16          uhwReserved;
    VOS_UINT16          uhwIncreaseFixDataPowerEnable;                          /* 1:使能DATA信道增加固定功率方案; 0:不使能 */
    VOS_INT16           shwFixDataPower;                                        /* DATA信道固定增加的功率值 */
}UCOM_NV_CDMA_HRPD_INCREASE_RRI_DATA_POWER_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_FDPCH_SYNC_THRESHOLD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : FDPCH同失步FDPCH TPC BER门限NV结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwFDpchQin;                        /* FDPCH同步门限 */
    VOS_UINT16                              uhwFDpchQout;                       /* FDPCH失步门限 */
}UCOM_NV_W_FDPCH_SYNC_THRESHOLD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_CDMA_TX_DCDC_EN_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : DCDC使能配置
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                   uhwTxCh0Enable;    /* ch0 DCDC使能 */
    VOS_UINT16                                   uhwTxCh0PinNum;    /* ch0 对应的GPIO */
    VOS_UINT16                                   uhwTxCh1Enable;    /* ch1 DCDC使能 */
    VOS_UINT16                                   uhwTxCh1PinNum;    /* ch1 对应的GPIO */

}UCOM_NV_CDMA_TX_DCDC_EN_CTRL_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_CAL_THRESHOLD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX 校准门限
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwDciLimit;                        /* DCi自校准失败门限，单位mv */
    VOS_UINT16                              uhwDcqLimit;                        /* DCq自校准失败门限，单位mv */
    VOS_UINT16                              uhwReserved1;                       /* 保留位 */
    VOS_UINT16                              uhwReserved2;                       /* 保留位 */
}UCOM_NV_GSM_MRX_CAL_THRESHOLD_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_GAIN_DCOFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX校准结果
*****************************************************************************/
typedef struct
{
    VOS_INT16                               shwDci;                             /* 校准码子DCI. RFIC MRX一码字15.625mv */
    VOS_INT16                               shwDcq;                             /* 校准码子DCQ. RFIC MRX一码字15.625mv */
    VOS_INT16                               shwReMainDci;                       /* 软件计算或BBP测量获得的校准残余DCI. 单位mv */
    VOS_INT16                               shwReMainDcq;                       /* 软件计算或BBP测量获得的校准残余DCQ. 单位mv */
}UCOM_NV_GSM_MRX_GAIN_DCOFFSET_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_DCOFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX校准结果
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_MRX_GAIN_DCOFFSET_STRU          stGsmMrxDcOffset[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];  /* 各个档位校准码子 */
}UCOM_NV_GSM_MRX_DCOFFSET_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_GAIN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GAIN每档 增益控制字和增益默认值
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwMrxGainCtrl;                     /* mrx 档位控制字 */
    VOS_INT16                               shwMrxGainValue;                    /* mrx 默认增益 */
}UCOM_NV_MRX_GAIN_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_GAIN_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GAIN增益控制字和增益默认值
*****************************************************************************/
typedef struct
{
    VOS_UINT16                  uhwValidNum;                                    /* mrx 有效档位 */
    VOS_UINT16                  uhwReserved;                                    /* 保留位 */
    UCOM_NV_MRX_GAIN_STRU       stGsmMrxGain[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];    /* mrx 5档 */
}UCOM_NV_GSM_MRX_GAIN_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_CTRL_GAIN_OFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GAIN每档增益偏差
*****************************************************************************/
typedef struct
{
    VOS_UINT16              uhwMrxGainOffset[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];  /* 每档增益偏差 */
    VOS_UINT16              uhwReserved;                                        /* 保留位 */
}UCOM_NV_GSM_MRX_GAIN_OFFSET_CHAN_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_GAIN_OFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GAIN3个信道，5档增益偏差
*****************************************************************************/
typedef struct
{
    UCOM_NV_GSM_MRX_GAIN_OFFSET_CHAN_STRU   stMrxGainOffset[UCOM_NV_MRX_GAIN_CHAN_MAX_NUM];   /* 3个信道，5档增益偏差 */
}UCOM_NV_GSM_MRX_GAIN_OFFSET_STRU;
...
typedef struct
{
    VOS_UINT16                              uhwChanValidCnt;                                /* 信道有效个数 */
    VOS_UINT16                              uhwMrxCalChan[UCOM_NV_MRX_GAIN_CHAN_MAX_NUM]; /* 信道值 */
}UCOM_NV_GSM_MRX_GAIN_CAL_CHAN_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_GSDR_ENABLE_CONTROL_STRU
 协议表格  :
 结构说明  : GSDR启动使能开关和算法启动/停止门限
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwForeCallGsdrEnFlag;              /* 前台语音GSDR使能标志:0:不使能;1:使能 */
    VOS_UINT16                              uhwBackCallGsdrEnFlag;              /* 后台语音GSDR使能标志:0:不使能;1:使能 */
    VOS_UINT16                              uhwForeCallForceEnFlag;             /* 前台语音强制启动 */
    VOS_UINT16                              uhwBackCallForceEnFlag;             /* 后台语音强制启动 */
    VOS_UINT16                              uhwSoftSwitchHardEnFlag;            /* 软基带切换硬基带使能标志. */
    VOS_UINT16                              uhwRsv[3];                          /* 预留后面增加控制变量. */

    VOS_UINT16                              uhwStatisticsWindowF;               /* 统计窗长全速率 */
    VOS_UINT16                              uhwStatisticsWindowH;               /* 统计窗长半速率 */

    VOS_INT16                               shwIsaicOnRssiThreshold;            /* 启动ISAIC的Rssi门限   -90*/
    VOS_UINT16                              uhwIsaicOnRssiPercent;              /* 低于启动ISAIC的Rssi门限次数比例 80% */
    VOS_INT16                               shwIsaicOnCiThreshold;              /* 启动ISAIC的CI门限  3 */
    VOS_UINT16                              uhwIsaicOnCiPercent;                /* 低于启动ISAIC的CI门限次数比例 80%  */
    VOS_UINT16                              uhwIsaicOnQualThreshold;            /* 启动ISAIC的误码率门限 4% */
    VOS_UINT16                              uhwIsaicOnQualTimes;                /* 超过启动ISAIC的误码率门限次数  3*/

    VOS_INT16                               shwIsaicOffRssiThreshold;           /* 关闭ISAIC的Rssi门限   -80*/
    VOS_UINT16                              uhwIsaicOffRssiPercent;             /* 高于关闭ISAIC的Rssi门限次数比例 80% */
    VOS_INT16                               shwIsaicOffCiThreshold;             /* 关闭ISAIC的CI门限     10*/
    VOS_UINT16                              uhwIsaicOffCiPercent;               /* 高于启动ISAIC的CI门限次数比例   80% */
    VOS_UINT16                              uhwIsaicOffSubQualThreshold;        /* 关闭ISAIC的Sub帧误码率门限   1% */
    VOS_UINT16                              uhwIsaicOffFullQualThreshold;       /* 关闭ISAIC的Full帧误码率门限  1% */
    VOS_UINT16                              uhwIsaicOffSubQualTimes;            /* 高于关闭ISAIC的Sub帧误码率门限次数 3 */
    VOS_UINT16                              uhwIsaicOffFullQualTimes;           /* 高于ISAIC的Full帧误码率门限次数    3 */

}UCOM_NV_GSM_GSDR_ENABLE_CONTROL_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_GSDR_DLISAIC_PARA_STRU
 协议表格  :
 结构说明  : GSDR算法相关参数，需要16字节对齐
*****************************************************************************/
typedef struct
{
    VOS_INT16                               shwCorrThreshold;                   /* DEC 用于BFI判决的偷帧比特相关判决门限 */
    VOS_UINT16                              uhwCorrEnable;                      /* DEC 用于BFI判决的偷帧比特相关判决使能 */
    VOS_INT16                               shwAFSFrmTypDecThres;               /* DEC AFS帧类型判决用到的门限 */
    VOS_INT16                               shwAFSFrmTypDecAbsThres;            /* DEC AFS帧类型判决用到的绝对门限 */
    VOS_INT16                               shwAHSFrmTypDecThres;               /* DEC AHS帧类型判决用到的门限 */
    VOS_INT16                               shwAHSFrmTypDecAbsThres;            /* DEC AHS帧类型判决用到的绝对门限 */
    VOS_INT16                               shwFacchHThresSnd;                  /* DEC FACCH/H偷帧判决的二次判决门限 */

    VOS_UINT16                              uhwAfcCiThreshold;                  /* AFC CI判决门限 */
    VOS_UINT16                              uhwAfcKFactor;                      /* AFC 环路滤波器参数 */
    VOS_UINT16                              uhwAfcKaSlow;                       /* AFC 2阶环路滤波器快慢切换参数 */
    VOS_UINT16                              uhwAfcShiftRKaSlow;                 /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftLKpSlow;                 /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKiSlow;                 /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKintSlow;               /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcKaFast2;                      /* AFC 2阶环路滤波器快慢切换参数 */
    VOS_UINT16                              uhwAfcShiftRKaFast2;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftLKpFast2;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKiFast2;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKintFast2;              /* AFC 2阶环路滤波器参数 */

    VOS_INT16                               ashwScnRssiThreshold[6];            /* SCNDET RSSI门限 */
    VOS_INT16                               shwScnType1CiThreshold;             /* SCNDET 第1类CI门限 */
    VOS_INT16                               ashwScnType2CiThreshold[6];         /* SCNDET 第2类CI门限 */

    VOS_INT16                               ashwFocAciMetricThreshold[2];       /* FOCOR ACI场景下最小度量门限 */
    VOS_INT16                               ashwFocCciMetricThreshold[2];       /* FOCOR CCI场景下最小度量门限 */
    VOS_INT16                               ashwFocSenMetricThreshold[2];       /* FOCOR 灵敏度场景下最小度量门限 */

    VOS_INT16                               shwScoefNbAciDgnlOff;               /* SCOEF NB下ACI场景对角线噪声 */
    VOS_INT16                               shwScoefNbCciDgnlOff;               /* SCOEF NB下CCI场景对角线噪声 */

    VOS_INT32                               aswScoefNbAwgnDgnlOff[2];           /* SCOEF NB下AWGN场景对角线噪声, 第1级 */
    VOS_INT16                               ashwScoefSbAciDgnlOff[3];           /* SCOEF SB ACI场景对角线噪声, 1x, 2x_0, 2x */
    VOS_INT16                               ashwScoefSbCciDgnlOff[3];           /* SCOEF SB CCI场景对角线噪声, 1x_1, 2x_0, 2x */
    VOS_INT32                               aswScoefSbAwgnDgnlOff[3];           /* SCOEF SB AWGN场景对角线噪声, 1x, 2x_0, 2x */

    VOS_INT16                               shwNbAciThresholdAci;               /* NB ACI检测门限 */
    VOS_INT16                               shwNbAciThresholdPower;             /* NB ACI检测门限 */
    VOS_INT16                               shwSbAciThresholdAci;               /* SB ACI检测门限 */
    VOS_INT16                               shwSbAciThresholdPower;             /* SB ACI检测门限 */

    VOS_INT16                               ashwAciHPFltrCoeff[32];             /* ACI检测高通滤波器系数 */
    VOS_INT16                               ashwAciFltrCoeff1[32];              /* ACI滤波器1系数，复数 */
    VOS_INT16                               ashwAciFltrCoeff2[32];              /* ACI滤波器2系数，复数 */
    VOS_INT16                               ashwAciFltrCoeff3[16];              /* ACI滤波器3系数，实数 */
    VOS_INT16                               ashwNbFoInc[4];                     /* NB时尝试频偏估计的步长 */
    VOS_INT16                               shwFrOffFltGSACCH;                  /* SACCH第三、四级FO估计值限幅的门限 */
    VOS_UINT16                              uhwCiThresholdSaic;                 /* SAIC CI门限，对数值的8倍 */
    VOS_UINT16                              uhwCiThresholdIsaic;                /* ISAIC CI门限，线性值 */
    VOS_UINT16                              uhwNumValidFrm;                     /* TOA训练算法调整解调起始时间时，参与统计的有效帧数门限 */

    VOS_UINT16                              uhwZeroInitStateFlg;                /*增强VTB，1表示从零状态开始译码，0表示从非零状态开始译码*/
    VOS_UINT16                              uhwZeroTrackStateFlg;               /*增强VTB，1表示从零状态开始回溯，0表示从状态值最大的状态开始回溯*/
    VOS_UINT16                              uhwSchEvtbFlag;                     /*SCH最后一次迭代采用VTB的标识信号，1为VTB，0为MLM*/
    VOS_UINT16                              uhwSaFaEvtbFlag;                    /*SACCH类型的控制帧(含偷帧)最后一次迭代采用VTB的标识信号，1为VTB，0为MLM*/
    VOS_UINT16                              uhwAfsNonSpeechEvtbFlag;            /*AFS控制帧最后一次迭代采用VTB的标识信号，1为VTB，0为MLM*/
    VOS_UINT16                              uhwAhsNonSpeechEvtbFlag;            /*AHS控制帧最后一次迭代采用VTB的标识信号，1为VTB，0为MLM*/
    VOS_UINT16                              uhwSchCandidateSeqNum;              /*SCH增强VTB回溯次数*/
    VOS_UINT16                              uhwSaFaCandidateSeqNum;             /*SACCH/FACCH增强VTB回溯次数*/
    VOS_UINT16                              uhwAfsCandidateSeqNum;              /*AFS控制帧增强VTB回溯次数*/
    VOS_UINT16                              uhwAhsCandidateSeqNum;              /*AHS控制帧增强VTB回溯次数*/

    VOS_INT32                               swScoefSbCciDgnlOffToa;             /* SCOEF SB CCI场景对角线噪声,1x_0 */
    VOS_INT16                               shwSbSyncPos;                       /* SB场景判决CI估计的输入同步位置 */
    VOS_UINT16                              uhwMixScnRatioThreshold1;           /* 虚实比均值门限1 */
    VOS_UINT16                              uhwMixScnRatioThreshold2;           /* 虚实比均值门限2 */
    VOS_UINT16                              uhwMixScnRatioThreshold3;           /* 虚实比均值门限3 */
    VOS_UINT16                              uhwMixScnRatioThreshold4;           /* 虚实比均值门限4 */
    VOS_UINT16                              uhwMixScnRatioThreshold5;           /* 虚实比均值门限5 */
    VOS_UINT16                              uhwMixScnRatioThreshold6;           /* 虚实比均值门限6 */
    VOS_UINT16                              uhwMixScnLenthNum;                  /* 均值长度虚实比 */
    VOS_UINT16                              uhwMixScnMidRatio;                  /* 实部为零时的虚实比值 */
    VOS_UINT16                              uhwMixScnMidBlfcaThreshold;         /* 实虚部能量比值门限 */
    VOS_INT16                               shwScoefNbMix1DgnlOff;              /* SCOEF NB下混合场景检测第2档对角线加重值 */
    VOS_INT16                               shwScoefNbMix2DgnlOff;              /* SCOEF NB下混合场景检测第3档对角线加重值 */
    VOS_INT16                               shwScoefNbMix3DgnlOff;              /* SCOEF NB下混合场景检测第4档对角线加重值 */
    VOS_INT16                               shwScoefNbMix4DgnlOff;              /* SCOEF NB下混合场景检测第5档对角线加重值 */

    VOS_UINT16                              uhwScnCiThdForToaPre;               /* SAIC CI门限，线性值 */
    VOS_UINT16                              uhwScnToaOffset;                    /* 预设符号偏差参数，大于门限，启动快调 */
    VOS_INT16                               shwScnToaPreAlpha;                  /* TOA滤波因子 */

    VOS_UINT16                              uhwAfcKaFast1;                      /* AFC 2阶环路滤波器快慢切换参数 */
    VOS_UINT16                              uhwAfcShiftRKaFast1;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftLKpFast1;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKiFast1;                /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwAfcShiftRKintFast1;              /* AFC 2阶环路滤波器参数 */
    VOS_UINT16                              uhwFast1StageLen;                   /* AFC Fast1阶段持续的TDMA帧数 */
    VOS_UINT16                              uhwFast2StageLen;                   /* AFC Fast2阶段持续的TDMA帧数 */

    VOS_INT32                               swFoLuiseSelCiPreSaicThrFast1;      /* 鉴频值选择SAIC前CI门限Fast1阶段，用于非ACI场景 */
    VOS_INT32                               swFoLuiseSelCiPreSaicThrFast2;      /* 鉴频值选择SAIC前CI门限Fast2阶段，用于非ACI场景 */
    VOS_INT32                               swFoLuiseSelCiPreSaicThrSlow;       /* 鉴频值选择SAIC前CI门限Slow阶段，用于非ACI场景 */
    VOS_INT32                               swFoLuiseSelCiPostSaicThrFast1;     /* 鉴频值选择SAIC后CI门限Fast1阶段 */
    VOS_INT32                               swFoLuiseSelCiPostSaicThrFast2;     /* 鉴频值选择SAIC后CI门限Fast2阶段 */
    VOS_INT32                               swFoLuiseSelCiPostSaicThrSlow;      /* 鉴频值选择SAIC后CI门限Slow阶段 */

    VOS_UINT16                              uhwFoLuiseSelLlrLowThr;             /* LLR软值求和判断低门限 */
    VOS_UINT16                              uhwFoLuiseSelLlrHighThr;            /* LLR软值求和判断高门限 */
    VOS_UINT32                              uwFoLuiseSelFoMedThr;               /* FO度量比值门限 */
    VOS_UINT16                              uhwMedAlpha;                        /* FO度量比值alpha滤波参数（例如取8表示新值8/32，老值24/32） */
    VOS_UINT16                              uhwLuiseShortDelNum;                /* Luise鉴频缩短符号个数，用于非ACI场景 */
    VOS_INT32                               swLuiseShortSelCiPostSaicThr;       /* 是否使用缩短Luise鉴频的SAIC后CI判断门限 */
    VOS_UINT16                              uhwFoLuiseSelForceFlag;             /* 强制选择开关，0：自适应切换；1：强制选Luise；2：强制选FO； */
    VOS_UINT16                              uhwCorrAlpha;                       /* 相关滤波因子 */

    VOS_UINT32                              uwDtxJudgeFsThre;                   /* 全速率下Dtx判决门限 */
    VOS_UINT32                              uwDtxJudgeHsThre;                   /* 半速率下Dtx判决门限 */
    VOS_UINT16                              uhwRatioCntNum;                     /* Ratio统计周期内Burst数 */
    VOS_UINT16                              uhwRatioAddNumMinThre;              /* Ratio统计周期内最少累加Burst数 */
    VOS_UINT32                              uwCorrCoefThd;                      /* 相关系数比值，配置102 */

    /* 预留 */
    VOS_UINT32                              uwRsv1;
    VOS_INT32                               swFoLuiseSelCiPreSaicThrFast1Aci;   /* 鉴频值选择SAIC前CI门限Fast1阶段，用于ACI场景 */
    VOS_INT32                               swFoLuiseSelCiPreSaicThrFast2Aci;   /* 鉴频值选择SAIC前CI门限Fast2阶段，用于ACI场景 */
    VOS_INT32                               swFoLuiseSelCiPreSaicThrSlowAci;    /* 鉴频值选择SAIC前CI门限Slow阶段，用于ACI场景 */
    VOS_UINT16                              uhwLuiseShortDelNumAci;             /* Luise鉴频缩短符号个数，用于ACI场景 */
    VOS_UINT16                              uwRsv3;

} UCOM_NV_GSM_GSDR_DLISAIC_PARA_STRU;


/*****************************************************************************
 结构名    : GPHY_COM_BAND_FREQ_INFO_STRU
 协议表格  :
 结构说明  : 当前频段对应的频点的开始位置和频点数目
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwEnergyThr;                           /* 进入对应状态的差值门限 0.125dbm */
    VOS_UINT16                          uhwNumberThr;                           /* 进入对应状态的次数门限 */
}UCOM_NV_GSM_ENERGY_NUMBER_THR_STRU;
...
typedef struct
{
    UCOM_NV_GSM_ENERGY_NUMBER_THR_STRU  stBlkThr;                               /* 进入Blk状态的能量 次数门限 单位为0.125 */
    UCOM_NV_GSM_ENERGY_NUMBER_THR_STRU  stNoBlkThr;                             /* 进入NoBlk状态的能量 次数门限 */
}UCOM_NV_GSM_BLK_NOBLK_THR_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_AGC_BLK_NOBLK_MODE_PARA_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : AGC Block模式相关的门限

*****************************************************************************/
typedef struct
{
    VOS_UINT16                         uhwAgcBlkNoBlkFlag;
    VOS_UINT16                         uhwRsv;
    UCOM_NV_GSM_BLK_NOBLK_THR_STRU     stNcellBlkNoBlkThr;                             /* 邻区判决block模式或者Noblk的门限 */
    UCOM_NV_GSM_BLK_NOBLK_THR_STRU     stTchBlkNoBlkThr;                               /* 业务信道判决block模式或者Noblk的门限  */
    UCOM_NV_GSM_BLK_NOBLK_THR_STRU     stBchBlkNoBlkThr;                               /* 空闲态判决block模式或者Noblk的门限 */
    VOS_INT16                          ashwDtxNoBlockTh[UCOM_NV_G_AGC_LEVEL_MAX_NUM];  /* NoBlock判决为DTX的门限 */
    VOS_INT16                          ashwDtxBlockTh[UCOM_NV_G_AGC_LEVEL_MAX_NUM];    /* Block判决为DTX的门限 */
    VOS_UINT16                         uhwStubAgcBlkNoBlkFlag;                         /* 当此标记为1的时候boston版本之后使用固定的blk或者noblk模式 */
    VOS_UINT16                         uhwStubBlkNoBlkMode;                            /* 为0表示Noblk 1表示blk模式 */

}UCOM_NV_GSM_AGC_BLK_NOBLK_MODE_PARA_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_RX_AGC_GAIN_COMP_FOR_FFT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : FFT扫频，Rx Agc增益补偿

*****************************************************************************/
typedef struct
{
    VOS_INT32                           swRxAgcGainCompForFft;                  /* 单位: 0.125dBm */
}UCOM_NV_GSM_RX_AGC_GAIN_COMP_FOR_FFT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_PMOM_INFO_CTRL_STRU
 结构说明  : GSM通信低功耗可维可测业务流程参数统计配置
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwGsmPmomEn;                       /* GSM PMOM信息统计使能开关 0--关闭 1--打开 */
    VOS_UINT16                              uhwReserved;                        /* 保留字段 */
    VOS_UINT16                              uhwDrxTimeNormal;                   /* 待机唤醒时间正常最大边界, 单位ms, 默认15ms */
    VOS_UINT16                              uhwDrxTimeLong;                     /* 待机唤醒时间偏长最小边界, 单位ms, 默认30ms */
    VOS_UINT16                              uhwNcellMeasSpanFloor;              /* 统计测量邻区数量区间下限 */
    VOS_UINT16                              uhwNcellMeasSpanCeil;               /* 统计测量邻区数量区间上限 */
    VOS_INT16                               shwRssiWeak;                        /* 统计弱信号边界, 单位dBm, 默认-90dBm */
    VOS_INT16                               shwRssiStrong;                      /* 统计强信号边界, 单位dBm, 默认-60dBm */
    VOS_INT16                               shwCsTxPwrLow;                      /* CS业务上行发射功率低功率边界, 单位dBm, 默认10dBm */
    VOS_INT16                               shwCsTxPwrHigh;                     /* CS业务上行发射功率高功率边界, 单位dBm, 默认20dBm */
    VOS_INT16                               shwPsTxPwrLow;                      /* PS业务上行发射功率低功率边界, 单位dBm, 默认10dBm */
    VOS_INT16                               shwPsTxPwrHigh;                     /* PS业务上行发射功率高功率边界, 单位dBm, 默认20dBm */
}UCOM_NV_GSM_PMOM_INFO_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_DPA_MPO_ELUSION_THRESHOLD_STRU
 结构说明  : W的最近100个有HS-PDSCH调度的TTI内平均BLER门限值与TAO门限值
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwBlerHighThreshold;               /* 对高于该平均BLER的场景采取规定策略 */
    VOS_UINT16                              uhwBlerLowThreshold;                /* 对低于该平均BLER的场景采取规定策略 */
    VOS_UINT16                              uhwTaoLowThreshold;                 /* 对低于该TAO值的场景采取规定策略*/
    VOS_UINT16                              uhwReserved;                        /* 保留字段 */
}UCOM_NV_W_DPA_MPO_ELUSION_THRESHOLD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_AFC_CALC_THRESHOLD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : DRX下维护频偏的门限
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwNormalDeltaTemperature;          /* 常温时:睡眠到唤醒之间的温度变化门限，单位0.1度 */
    VOS_UINT16                              uhwUnNormalDeltaTemperature;        /* 非常温时:睡眠到唤醒之间的温度变化门限，单位0.1度 */
    VOS_UINT32                              uwDeltaPpmValue;                    /* 睡眠到唤醒之间的ppm变化门限，单位2^31/10^6 */
    VOS_INT16                               shwHighTemperature;                 /* 高温门限，单位0.1度 */
    VOS_INT16                               shwLowTemperature;                  /* 低温门限，单位0.1度 */
    VOS_UINT32                              uwDeltaTime;                        /* 温度和ppm变化超过门限之后，持续没有更新ppm的时间门限，单位ms */
    VOS_UINT32                              uwReserved1;
    VOS_UINT32                              uwReserved2;
}UCOM_NV_W_AFC_CALC_THRESHOLD_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_RF_KEY_REQ_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : RFIC关键寄存器定义
*****************************************************************************/
...
{
    VOS_UINT32                              uwRfCount;
    UCOM_NV_RF_INIT_INFO_STRU               stConfigInfo[UCOM_NV_RF_KEY_REG_NUM];
}UCOM_NV_RF_KEY_REQ_CONFIG_STRU;




/*****************************************************************************
 结构名    : UCOM_NV_GSM_TX_HML_CHANNEL_PWR_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 高中低三信道功率补偿
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                  uhwChannelPowerCompEn;          /* 使能信号，0表示不使用，非0表示使用 */
    VOS_UINT16                                  uhwRsv;
    UCOM_NV_GSM_LINEAR_PA_NONLINEAR_COMP_STRU   stLowChannelPwrComp;            /* 低信道功率补偿 */
    UCOM_NV_GSM_LINEAR_PA_NONLINEAR_COMP_STRU   stMidChannelPwrComp;            /* 中信道功率补偿 */
    UCOM_NV_GSM_LINEAR_PA_NONLINEAR_COMP_STRU   stHighChannelPwrComp;           /* 高信道功率补偿 */
}UCOM_NV_GSM_TX_HML_CHANNEL_PWR_COMP_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_GSM_TX_POWER_DETECT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM 功率检测
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwEnable;                              /* PD使能信号，0表示不使用，非0表示使能 */
    VOS_UINT16                          uhwVga;                                 /* VGA增益: 0: +15dB; 1: +13dB,2:+11dB, ...,
                                                                                   13: -11dB, 以RFIC资料为准 */
    VOS_UINT16                          uhwPreAtten;                            /* 前级衰减: 1: 1dB; 2: 5dB; 3: 9dB */
    VOS_UINT16                          uhwDcOffset;                            /* 直流偏置: 00: -512mV, 01: -508mV, ...,
                                                                                   ff: +508mV, 以RFIC资料为准 */
    VOS_UINT16                          uhwInputPortSel;                        /* 反馈回路: 0: FB_1; 1: FB_2 */
    VOS_UINT16                          uhwHkadcChan;                           /* HKADC检测通道 */
}UCOM_NV_GSM_TX_POWER_DETECT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_GSDR_GPHY_PARA_STRU
 协议表格  :
 结构说明  : GSDR方案GPHY组件算法参数
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              uwCiThdSdrEfs;                      /* SDR时，EFS业务CI判决门限 */
    VOS_UINT32                              uwCiThdSdrFs;                       /* SDR时，FS业务CI判决门限 */
    VOS_UINT32                              uwCiThdSdrHs;                       /* SDR时，HS业务CI判决门限 */
    VOS_UINT32                              uwCiThdSdrAfs;                      /* SDR时，AFS业务CI判决门限 */
    VOS_UINT32                              uwCiThdSdrAhs;                      /* SDR时，AHS业务CI判决门限 */

    /* 预留 */
    VOS_UINT32                              uwRsv1;
    VOS_UINT32                              uwRsv2;
    VOS_UINT32                              uwRsv3;
} UCOM_NV_GSM_GSDR_GPHY_PARA_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_PA_TYPE_TIME_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM通道延迟，不开放给产品线调试
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwGmskModChDelaySp;                /* 通道延迟，样点级别 */
    VOS_UINT16                              uhwGmskModChDelayClk;               /* 通道延迟，Clk级别 */

    VOS_UINT16                              uhwEdgeModChDelaySp;                /* 通道延迟，样点级别 */
    VOS_UINT16                              uhwEdgeModChDelayClk;               /* 通道延迟，Clk级别 */

    VOS_UINT16                              uhwGmskRampSetPosClk;               /* 在Qb内第几个Clk发出 */
    VOS_UINT16                              uhwEdgeRampSetPosClk;               /* 在Qb内第几个Clk发出 */
}UCOM_NV_PA_TYPE_TIME_DELAY_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_TIME_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM通道延迟，开放给产品线调试
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwSaturatedPaGmskRampChDelaySp;    /* 通道延迟，样点级别 */                             /* 信道有效个数 */
    VOS_UINT16                              uhwSaturatedPaGmskRampChDelayClk;   /* 通道延迟，Clk级别 */
    VOS_UINT16                              uhwLinearPaGmskRampChDelaySp;       /* 通道延迟，样点级别 */
    VOS_UINT16                              uhwLinearPaGmskRampChDelayClk;      /* 通道延迟，Clk级别 */
}UCOM_NV_GSM_TIME_DELAY_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_PRIVATE_TIME_DELAY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM通道延迟，不开放给产品线调试
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwSsSetPosClk;                     /* SS在Qb内第几个Clk发出 */
    VOS_UINT16                              uhwSsSetTiming;                     /* SS下发时刻 */
    VOS_UINT16                              uhwEsSetPosClk;                     /* ES在Qb内第几个Clk发出 */
    VOS_UINT16                              uhwEsSetTiming;                     /* ES下发时刻 */

    UCOM_NV_PA_TYPE_TIME_DELAY_STRU         stSaturatedPaTimeDelay;
    UCOM_NV_PA_TYPE_TIME_DELAY_STRU         stLinearPaTimeDelay;
}UCOM_NV_GSM_PRIVATE_TIME_DELAY_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_W_SAR_TAS_BAND_SUPPORT_STRU
 协议表格  :
 ASN.1描述 : auwBandSarTasMap是针对每个band是否支持SAR TAS的bitmap。
             auwBandSarTasMap[0]bit0代表band1，bit1代表band2，以此类推。
             auwBandSarTasMap[1]bit0代表band33，bit1代表band34，以此类推。
             bit位为1，代表此band使用支持SAR TAS算法，否则反之。
 结构说明  : BAND 是否支持 SAR TAS相关参数
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              auwBandSarTasMap[2];                /* BAND是否支持SAR TAS */
}UCOM_NV_W_SAR_TAS_BAND_SUPPORT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_TX_STATEII_LEVEL_STRU
...
}UCOM_NV_W_TX_STATEII_LEVEL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_MAS_TX_STATEII_LEVEL_TABLE_STRU
 结构说明  : MAS_TX_STATEII档位表结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          uhwLevelNum;                            /* 档位表有效档位个数 */
    VOS_UINT16                          uhwRsv;                                 /* 4字节对齐 */
    UCOM_NV_W_TX_STATEII_LEVEL_STRU     astLevelTable[UCOM_NV_W_TX_TAS_STATEII_LEVEL_NUM]; /* 档位表 */
}UCOM_NV_W_TX_STATEII_LEVEL_TABLE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_TX_TAS_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : SAR TAS相关的控制参量
*****************************************************************************/
typedef struct
{
    VOS_INT16                                   shwTxGoodPowerValue;            /* TX发射情况GOOD门限:MaxPower - MPR - SarReduction - uhwTxGoodPowerValue，单位:0.1dB */
    VOS_INT16                                   shwTxPoorPowerValue;            /* TX发射情况POOR门限:MaxPower - MPR - SarReduction - uhwTxPoorPowerValue，单位:0.1dB */
    VOS_INT16                                   shwTxMonitorPowerValue;         /* TX发射监测门限:MaxPower - MPR - SarReduction - uhwTxMonitorPowerValue，单位:0.1dB */
    VOS_UINT16                                  uhwTxPowerLimitedRatio;         /* TX发射功率受限判定比例，单位:% */
    VOS_UINT16                                  uhwTxStateIISampleFactor;       /* TxStateII内T1/T2时间长度的倍数，若uhwSampleFactor个uhwT1Duration/uhwT2Duration时间内，仍然没有收集到约定的有效的TX时隙个数，则认为发射情况很好，停止收集 */
    VOS_UINT16                                  uhwTxStateIMonitorFactor;       /* TxStateI内TX功率监测周期倍数，即若uhwTxMonitorFactor个uhwTxMonitorPeriod时间内，还没有收集到需要的有效的TX时隙个数，则认为发射情况很好，停止收集 */
    VOS_UINT16                                  uhwTxStateIMonitorPeriod;       /* TxStateI内监测TX发射功率是否受限的有效TX时长，单位:ms  */
    VOS_UINT16                                  uhwTxPowerJudgeFactor;          /* 判定当前发射功率是否GOOD/POOR的最长时长是有效TX时长多少倍 */
    VOS_UINT16                                  uhwTxPowerJudgePeriod;          /* 判定当前发射功率是否GOOD/POOR的有效TX时长，单位:ms */
    VOS_UINT16                                  uhwRxBetterAntEvaTime;          /* 判断RX好天线的评估时长，单位:ms */
    VOS_INT16                                   shwRxBetterThd;                 /* 目标天线比源天线好多少，才认为目标天线更好，单位:0.1dB */
    VOS_UINT16                                  uhwRsv;                         /* 4字节对齐 */
    UCOM_NV_W_TX_STATEII_LEVEL_TABLE_STRU       stLevelTable;                   /* 档位表 */
}UCOM_NV_W_TX_TAS_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_TX_TAS_DUAL_ANT_IMBALANCE_STRU
 协议表格  :
 结构说明  : TX TAS项目开发，物理天线源天线为下天线，目标天线为上天线时，【源天线->目标天线】的Imbalance值
*****************************************************************************/
typedef struct
{
    VOS_INT16                                   shwDualAntImbalance;            /* 【物理下天线->物理上天线】的mbalance值 单位1/8 dB */
    VOS_UINT16                                  uhwRsv1;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv2;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv3;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv4;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv5;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv6;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv7;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv8;                        /* 保留位 */
    VOS_UINT16                                  uhwRsv9;                        /* 保留位 */
} UCOM_NV_TX_TAS_DUAL_ANT_IMBALANCE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_TX_TAS_SAR_OFFSET_WEIGHT_STRU
 协议表格  :
 结构说明  : TX TAS项目新增，TAS连接态 RX-TAS判决流程中计算两天线deltaValue时 sar offset的权重，GU common，协议NV
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                  uhwSarOffsetWeight;             /* TAS连接态 RX-TAS判决流程中计算两天线deltaValue时 sar offset的权重，单位% */
    VOS_UINT16                                  uhwSarOffsetWeightUmts;         /* 同上,上面给GSM使用,这个给UMTS使用 */
} UCOM_NV_TX_TAS_SAR_OFFSET_WEIGHT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_HSPA_CQI_REPLACE_TABLE_STRU
 协议表格  :
 结构说明  : 具体替换的CQI表以及对应的参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwCqiTableIndex;                           /* CQI3张大表，具体替换的哪张大表 */
    VOS_UINT16                              uhwCqiTypeIndex;                            /* 需要替换的小表，该下标为替换小表在大表中的位置 */
    VOS_UINT32                              auwTable[UCOM_NV_W_CQI_VALUE_NUM];          /* 具体参数 */
} UCOM_NV_W_HSPA_CQI_REPLACE_TABLE_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_W_HSPA_CQI_REPLACE_TABLE_INFO_STRU
 协议表格  :
 结构说明  : 替换默认CQI表的参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                  uhwEnableFlag;                              /* 是否需要替换的标记，1为替换，0为不替换 */
    VOS_UINT16                                  uhwTalbeNum;                                /* 需要替换的小表的个数 */
    UCOM_NV_W_HSPA_CQI_REPLACE_TABLE_STRU       astCqiTable[UCOM_NV_W_CQI_TABLE_NUM];       /* 具体每张表的位置和参数 */
} UCOM_NV_W_HSPA_CQI_REPLACE_TABLE_INFO_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_W_BCCH_AFC_ADJUST_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 初始搜网解广播失败时AFC纠偏方案参数
*****************************************************************************/
typedef struct
{
    VOS_UINT16                              uhwEnable;                          /* AFC纠偏使能，0:关闭，1:打开 */
    VOS_INT16                               shwHighTemperature;                 /* 高温门限，单位0.1度 */
    VOS_INT16                               shwLowTemperature;                  /* 低温门限，单位0.1度 */
    VOS_UINT16                              uhwAfcAdjustValue;                  /* AFC纠偏幅度，单位Hz */
}UCOM_NV_W_BCCH_AFC_ADJUST_CTRL_STRU;
