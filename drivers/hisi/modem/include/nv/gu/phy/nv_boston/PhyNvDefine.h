...
#define UCOM_NV_MRX_GAIN_CHAN_MAX_NUM       ( 16 )                              /* MRX GAIN信道最大数目 */
#define UCOM_NV_MRX_GAIN_TEMP_COMP_NUM      ( 32 )                              /* MRX 温度补偿点数 */
#define UCOM_NV_MRX_GAIN_FREQ_COMP_NUM      ( 32 )                              /* MRX 频率补偿点数 */
...
#define UCOM_NV_PA_GAIN_MAX_NUM             ( 4 )                               /* PA档位个数 */
#define UCOM_NV_TX_MAX_CAL_FREQ_NUM         ( 32 )                              /* Tx 校准最大频点数 */
#define UCOM_NV_RX_MAX_CAL_FREQ_NUM         ( 32 )                              /* Rx 校准最大频点数 */

#define UCOM_NV_W_TX_PA_MODE_NUM            ( UCOM_NV_PA_GAIN_MAX_NUM )         /* PA 增益个数:高中低超低 */
...
#define UCOM_NV_TX_PA_TEMP_NUM              ( 32 )                              /* TX PA的温度设置的温度点 */
#define UCOM_NV_W_TX_FREQ_COMP_NUM          ( 32 )                              /* TX 频补点数，与频率个数相同 */

#define UCOM_NV_TRX_TEMP_COMP_FREQ_NUM       ( 3 )                              /* TRX温补最多支持频点个数 */
...
#define UCOM_NV_W_APC_ATTEN_NUM             ( 96 )
...
#define UCOM_NV_ET_MIPI_MAX_NUM                 ( 8 )
#define UCOM_NV_MIPI_COMM_NUM                   ( 5 )
#define UCOM_NV_W_MIPI_INIT_WORD_NUM            ( 16 )

#define UCOM_NV_HAL_MIPI_FORMAT_NUM             ( 8 )
...
#define UCOM_NV_MAX_MIPI_ANT_NUMBER             ( 5 )                           /* ant switch控制字命令最大数目 */
...
#define UCOM_NV_CDMA_APC_ATTEN_NUM                    ( 96 )
...
#define UCOM_NV_ET_DELAY_TEMP_COMP_MAX_NUM          ( 1 )                       /* ET DELAY 温补最大值 */
...
#define UCOM_NV_CDMA_TX_PA_VBIAS_NUM                ( UCOM_NV_W_TX_PA_VBIAS_NUM )       /* pa vbias个数 */
#define UCOM_NV_CDMA_TX_PA_VCC_NUM                  ( 1 )                               /* pa vcc个数 */
...
/*****************************************************************************
 枚举名    :LNA_GAIN_MIPI_LEVEL
 协议表格  :
 ASN.1描述 :
 枚举说明  :lna gain mipi level
*****************************************************************************/
enum LNA_GAIN_MIPI_LEVEL
{
    LNA_GAIN_MIPI_LEVEL_0         = 0,
    LNA_GAIN_MIPI_LEVEL_1            ,
};
...
{
    UCOM_NV_FEMIO_CTRL_TOP              = 0,                                    /* 无需配置 */
    UCOM_NV_GPIO_ONLY                   = 1,                                    /* 只配置GPIO */
...
typedef struct
{
    VOS_INT16                           ashwTxTempDefine[UCOM_NV_TX_PA_TEMP_NUM];
...
/*****************************************************************************
 结构名    : UCOM_NV_GUC_RF_IQ_REV_CTRL_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IQ接反配置
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          uwRxAIQExchange :1;                     /* RX A I/Q路交换选择，为1时交换 */
    VOS_UINT32                          uwRxBIQExchange :1;                     /* RX B I/Q路交换选择，为1时交换 */

    VOS_UINT32                          uwTxIRevSel     :1;                     /* TX I路数据是否取反，为1时取反 */
    VOS_UINT32                          uwTxQRevSel     :1;                     /* TX Q路数据是否取反，为1时取反 */

    VOS_UINT32                          uwMrxIQExchange :1;                     /* MRx I/Q路交换选择，为1时交换 */

    VOS_UINT32                          uwReserved0     :3;
    VOS_UINT32                          uwReserved1     :8;
    VOS_UINT32                          uwReserved2     :8;
    VOS_UINT32                          uwReserved3     :8;
}UCOM_NV_GUC_RF_IQ_REV_CTRL_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_WG_MRX_DCR_CAL_THRESHOLD_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX 校准门限
*****************************************************************************/
...
}UCOM_NV_WG_MRX_DCR_CAL_THRESHOLD_STRU;
...
/*****************************************************************************
 结构名    : UCOM_NV_GSM_TIME_CONFIG_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    UCOM_NV_GSM_TX_FREQ_COMP_STRU       ashwGsmTxFreqComp[UCOM_NV_GSM_LINEAR_PA_GAIN_NUM];  /*Range:[-100,100]*//* [频段][不同频点的发射功率的补偿值] ，单位0.1dBm*/
}UCOM_NV_GSM_TX_GAIN_FREQ_COMP_STRU;
...
typedef struct
{
    UCOM_NV_EDGE_TX_FREQ_COMP_STRU      ashwEdgeTxFreqComp[UCOM_NV_GSM_LINEAR_PA_GAIN_NUM];  /*Range:[-100,100]*//* [频段][不同频点的发射功率的补偿值] ，单位0.1dBm*/
}UCOM_NV_EDGE_TX_GAIN_FREQ_COMP_STRU;
...
{
    VOS_UINT32          uwValidCount;
    VOS_UINT32          auwRfGainCtrl[UCOM_W_MAX_RF_GAIN_CTRL_NUM];
...
{
    VOS_UINT32          uwValidCount;
    VOS_UINT32          auwRfBias[UCOM_W_MAX_RF_BIAS_NUM];
...
typedef struct
{
    ...
    VOS_INT16                           shwL2ULComp;                            /* PA增益从低切到超低的门限补偿,单位0.1db */
    VOS_INT16                           shwUL2LComp;                            /* PA增益从超低切到低的门限补偿,单位0.1db */
...
typedef UCOM_NV_W_TX_PA_GAIN_STRU     UCOM_NV_W_TX_PA_GAIN_VOICE_MODE_STRU;
...
typedef struct
{
    VOS_UINT32                          uwPaGainNumber;                         /* PA支持的档位数 */
    ...
    VOS_INT16                           shwPaGainThresL2UL;                     /* PA从低增益到超低增益的切换门限 */
    VOS_INT16                           shwPaGainThresUL2L;                     /* PA从超低增益到低增益的切换门限 */
...
typedef struct
{
    ...
    VOS_INT16                           shwPaGainSwitchL2UL;                    /* PA增益低增益到超低增益切换时序 */
    VOS_INT16                           shwPaGainSwitchUL2L;                    /* PA增益超低增益到低增益切换时序 */
...
/*****************************************************************************
 结构名    : UCOM_NV_W_TX_FREQ_COMP_CAL_RESULT_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :
*****************************************************************************/
typedef struct
{
    UCOM_NV_W_TX_GAIN_FREQCOMP_STRU     astTxFreqCompGain[UCOM_NV_W_TX_PA_MODE_NUM];   /* TX频率补偿值 */
}UCOM_NV_W_TX_FREQ_COMP_CAL_RESULT_STRU;
...
typedef struct
{
    VOS_UINT32                                  auwApcRficCtrlGain[UCOM_NV_W_APC_ATTEN_NUM];
...
typedef struct
{
    VOS_UINT32                                  auwApcRficCtrlGainVoiceMode[UCOM_NV_W_APC_ATTEN_NUM];
...
typedef UCOM_NV_W_PA_GAIN_SWITH_THRESHOLD_STRU  UCOM_NV_CDMA_PA_GAIN_SWITCH_THRESHOLD_STRU; /* PA档位切换门限 */
...
typedef UCOM_NV_W_TX_FREQ_COMP_CAL_RESULT_STRU            UCOM_NV_CDMA_TX_FREQ_COMP_CAL_RESULT_STRU; /* PA频率补偿表，分高中低三档 */
...
typedef UCOM_NV_WG_MRX_DCR_CAL_THRESHOLD_STRU   UCOM_NV_GUC_MRX_DCR_CAL_THRESHOLD_STRU;  /* MRX DC 校准门限 */
...
typedef struct
{
    ...
    VOS_UINT32                          uwTestErachSf8Elusion:1;                /* ERACH下规避华为网络问题，容量限制SF8时不打孔，需要默认打开 */
...
typedef struct
{
    VOS_UINT32                              uwMrxGainCtrl;                      /* mrx档位控制字，包含0x80,0x81,0x82,按照顺序从低到高排列，占24bit */
    VOS_INT16                               shwMrxGainValue;                    /* mrx 默认增益 */
    VOS_UINT16                              uhwReserved;                        /* 预留 */
...
typedef struct
{
    ...
    VOS_UINT16                  uhwReserved;                                    /* 保留位 */
    UCOM_NV_MRX_GAIN_STRU       astMrxGain[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];      /* mrx 5档 */
}UCOM_NV_MRX_GAIN_CTRL_STRU;

typedef UCOM_NV_MRX_GAIN_CTRL_STRU      UCOM_NV_GSM_MRX_GAIN_CTRL_STRU;
typedef UCOM_NV_MRX_GAIN_CTRL_STRU      UCOM_NV_W_MRX_GAIN_CTRL_STRU;
typedef UCOM_NV_MRX_GAIN_CTRL_STRU      UCOM_NV_C_MRX_GAIN_CTRL_STRU;
...
typedef struct
{
    VOS_INT16               shwMrxGainOffset[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];  /* 每档增益偏差 */
    VOS_UINT16              uhwReserved;                                        /* 保留位 */
}UCOM_NV_MRX_GAIN_OFFSET_STRU;
...
typedef struct
{
    UCOM_NV_MRX_GAIN_OFFSET_STRU           stMrxGsmGainOffset;
    UCOM_NV_MRX_GAIN_OFFSET_STRU           stMrxEdgeGainOffset;
}UCOM_NV_GSM_MRX_GAIN_OFFSET_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_GSM_MRX_GAIN_CAL_CHAN_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : GSM MRX GAIN校准频点
*****************************************************************************/
typedef struct
{
...
typedef struct
{
    VOS_INT16                           ashwMrxGainCalResult[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];
    VOS_UINT16                          uhwReserved;                                        /* 保留位 */

}UCOM_NV_MRX_GAIN_CAL_RESULT_STRU;

typedef UCOM_NV_MRX_GAIN_CAL_RESULT_STRU  UCOM_NV_W_MRX_GAIN_CAL_RESULT_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_MRX_DCOFFSET_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 每个档位的MRX DC OFFSET
*****************************************************************************/
typedef struct
{
    VOS_INT16                               shwDci;                             /* 校准码字DCI */
    VOS_INT16                               shwDcq;                             /* 校准码字DCQ */
    VOS_INT16                               shwRemainDci;                       /* 软件计算或BBP测量获得的校准残余DCI*/
    VOS_INT16                               shwRemainDcq;                       /* 软件计算或BBP测量获得的校准残余DCQ*/
}UCOM_NV_MRX_DCOFFSET_STRU;
/*****************************************************************************
 结构名    : UCOM_NV_MRX_DCOFFSET_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
    UCOM_NV_MRX_DCOFFSET_STRU               astMrxDcOffset[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM];
}UCOM_NV_MRX_GAIN_DCOFFSET_STRU;

typedef UCOM_NV_MRX_GAIN_DCOFFSET_STRU  UCOM_NV_W_MRX_GAIN_DCOFFSET_STRU;


/*****************************************************************************
 结构名    : UCOM_NV_MRX_GAIN_FREQ_COMP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : MRX GAIN频补
*****************************************************************************/
typedef struct
{
    VOS_INT16                               ashwMrxGainFreqComp[UCOM_NV_MRX_GAIN_CTRL_MAX_NUM][UCOM_NV_MRX_GAIN_FREQ_COMP_NUM];
}UCOM_NV_MRX_GAIN_FREQ_COMP_STRU;

typedef UCOM_NV_MRX_GAIN_FREQ_COMP_STRU  UCOM_NV_W_MRX_GAIN_FREQ_COMP_STRU;

/*****************************************************************************
 结构名    : UCOM_NV_MRX_IQMISMATCH_DC_STRU
 协议表格  :
 结构说明  : MRX IQMISTCH,振幅校正因子，相位校正因子，直流校正因子
*****************************************************************************/
typedef struct
{
    VOS_INT16                           shwIqMcI;                               /* I路校正因子 */
    VOS_INT16                           shwIqMcQ;                               /* Q路校正因子 */
    VOS_INT16                           shwIDc;                                 /* TX I路直流 */
    VOS_INT16                           shwQDc;                                 /* TX Q路直流 */
}UCOM_NV_MRX_IQMISMATCH_DC_STRU;
...
/*****************************************************************************
 ...
 结构说明  : DTS2016081909695_W的最近100个有HS-PDSCH调度的TTI内平均BLER门限值与TAO门限值
*****************************************************************************/
typedef struct
{
...
// TODO: boston上不用该NV 结构体，需要等DPD/ET接口归一后删除
/*****************************************************************************
...
/*****************************************************************************
 结构名    : UCOM_NV_GUC_BBP_MIPI_HW_BASIC_INFO_STRU
 协议表格  :
 结构说明  : GUC BBP MIPI指令相关信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                              bitRficMipiHalfRead         :1;     /* 半速率模式，全速率：0，半速率：1 */
    VOS_UINT32                              bitRficMipiReadDelay         :2;    /* 回读模式，单位clock  */
    VOS_UINT32                              bitRffeMipiHalfRead         :1;     /* 半速率模式，全速率：0，半速率：1 */
    VOS_UINT32                              bitRffeMipiReadDelay         :2;    /* 回读模式，单位clock  */
    VOS_UINT32                              bitRsv0                     :1;
    VOS_UINT32                              bitRsv1                     :2;
    VOS_UINT32                              bitRsv2                     :1;
    VOS_UINT32                              bitRsv3                     :2;     /* 预留位，后续GUC需要分开时用  */
    VOS_UINT32                              bitRsv4                     :1;
    VOS_UINT32                              bitRsv5                     :2;
    VOS_UINT32                              bitRsv6                     :1;
    VOS_UINT32                              bitRsv7                     :2;     /* 预留位，后续GUC需要分开时用  */
    VOS_UINT32                              bitRsv8                     :14;    /* 预留位,后续Bbp时钟变化用于确定读写一条指令延迟时间  */
}UCOM_NV_GUC_BBP_MIPI_HW_BASIC_INFO_STRU;
