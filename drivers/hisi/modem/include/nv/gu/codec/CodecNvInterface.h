...
/* 安富音频声学处理NV参数数组单个ID数组长度 单位:int16 */
#define ANFU_ECNR_NV_ARRAY_ID_LEN (150)
...
/*****************************************************************************
 结构名    : ECALL_CUSTOM_MODE_NV_STRU
 结构说明  : ECALL_CUSTOM_MODE NV结构体,ID en_NV_EcallTimerMode 12299
*****************************************************************************/
typedef struct
{
    VOS_UINT16 uwEcallCustomMode;
    VOS_UINT16 uwReserved[3];
}ECALL_CUSTOM_MODE_NV_STRU;

/*****************************************************************************
 结构名    : CMR_NV_STRU
 结构说明  : CMR_NV_STRU NV结构体,ID en_NV_CMR 12300
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : I2SPCM_MODE_NV_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : SIO配置NV项结构体,ID en_NV_I2sPcmMode 12328
*****************************************************************************/
typedef struct
{
    VOS_UINT32                           uhwIsPcmMode;/*Range:[0,1]*/         /* 是否为PCM模式:0-I2S,1-PCM */
}I2SPCM_MODE_NV_STRU;


/*****************************************************************************
 结构名    : RTP_NV_CFG_STRU
 结构说明  : RTP_NV_CFG_STRU NV结构体,ID en_NV_Rtp_Cfg 12302
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : ANFU_ECNR_NV_STRU
 结构说明  : 安富ECNR算法NV结构体
*****************************************************************************/
typedef struct
{
    VOS_INT16                      ashwNv[ANFU_ECNR_NV_ARRAY_ID_LEN];
}ANFU_ECNR_NV_STRU;
