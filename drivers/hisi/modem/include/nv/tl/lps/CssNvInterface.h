...
typedef struct
{
    VOS_UINT16                                    usWinLen;         /* 计算能量差分值窗长参数，默认值取1 */
    VOS_UINT16                                    usThresStep;      /* 计算能量差分值门限参数，默认值取10dB, 2560, Q8精度 */
    VOS_UINT16                                    usFactorE;        /* 相邻2个频点差分值差异的门限参数，默认值取32 ，Q8精度*/
    VOS_UINT16                                    usFactorWin;      /* 幅度匹配因子，默认值取125，Q8精度 */
    VOS_UINT16                                    usThresJudgeWAndL; /* 区分W和L标准差差异的参数，默认值取125，Q8精度 */
    VOS_UINT8                                     ucLteMaxFreqNum;  /* LTE制式输出的最大频点个数 */
    VOS_UINT8                                     ucBandMaxNum;     /* 每个BAND输出频点个数 */
    VOS_UINT16                                    usRsv1;
    VOS_UINT16                                    usRsv2;
    VOS_UINT16                                    usRsv3;
    VOS_UINT16                                    usRsv4;
    VOS_UINT8                                     ucGsmMaxFreqNum;  /* GSM制式输出的最大频点个数 */
    VOS_UINT8                                     ucUmtsMaxFreqNum; /* UMTS制式输出的最大频点个数 */
    VOS_UINT8                                     ucRsv3;
    VOS_UINT8                                     ucRsv4;
    VOS_UINT8                                     ucRsv5;
    VOS_UINT8                                     ucRsv6;
    VOS_UINT8                                     ucRsv7;
    VOS_UINT8                                     ucRsv8;
}CSS_NV_RAT_RECOGNIZE_STRU;
/*****************************************************************************
 结构名     : CSS_NV_CONFIG_CONTROL_PARA_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : CSS控制参数结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                    ulHistoryFreqValidTime;/* 历史频点有效时间，单位秒 */
    VOS_UINT32                                    ulRsv1;
    VOS_UINT32                                    ulRsv2;
    VOS_UINT32                                    ulRsv3;
    VOS_UINT32                                    ulRsv4;
    ...
    VOS_UINT8                                     ucRsv3;
    VOS_UINT8                                     ucRsv4;
}CSS_NV_CONFIG_CONTROL_PARA_STRU;
