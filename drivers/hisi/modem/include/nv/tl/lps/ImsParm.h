...
typedef struct{
    ...
    VOS_UINT8        ucVDFswitch;              /* Suppot VDF feature flags.*/
    VOS_UINT8        ucReserved4;
    VOS_UINT8        ucReserved5;
    VOS_UINT8        ucReserved6;
    VOS_UINT8        ucReserved7;
...
/*****************************************************************************
 * 8. String Switch and Value
 NV Parameters for string switch value
 NV_ID 0xd26e
*****************************************************************************/
typedef struct{
    VOS_CHAR               acPhoneContext[IMS_PARM_STRING_SIZE];
    VOS_CHAR               acPhoneContextImpu[IMS_PARM_STRING_SIZE];
    VOS_CHAR               acDisplayName[IMS_PARM_STRING_SIZE];
    VOS_UINT8              aucReserved3[IMS_PARM_STRING_SIZE];
    VOS_UINT8              aucReserved4[IMS_PARM_STRING_SIZE];
    VOS_UINT8              aucReserved5[IMS_PARM_STRING_SIZE];
    VOS_UINT8              aucReserved6[2];
}IMS_PARM_STRING_SWITCH_VALUE_STRU;
