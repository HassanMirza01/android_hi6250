...
/* delete by s00139335 for DTS2016041910228,无用全局变量删除, 2016-4-19*/
...
/*DTS2016050400657 z00275692 for 美国项目仪器测试 NV控制*/
...
/* 上报cgi-info后相关MeasObj的cellForWhichToReportCGI是否需要保留开关  x00349962 begin */
#define LRRC_NV_ENDELCELLFORCGIFlG_BIT    ( 0x00040000 )
/* 上报cgi-info后相关MeasObj的cellForWhichToReportCGI是否需要保留开关  x00349962 end */
...
#define LRRC_CHECK_DRX_INFRINGED_MCC_NUM    (16)
...
typedef struct
{
    ...
    VOS_INT16               sLowPriMeasSrvRsrqThres;   /* 起等级优先级测量的服务小区q值门限，单位1/8dB,控制开关与DTS2016050408711相同，非标优化 */
    VOS_UINT16              usRsv2;
    VOS_UINT16              usRsv3;
    VOS_UINT16              usRsv4;
...
/*****************************************************************************
 结构名    : LRRC_DRX_OFFSET_INFRINGED_RULE_STRU

 结构说明  : drx offset参数中的侵权项
*****************************************************************************/
typedef struct
{
    VOS_UINT16                  bitMod10Infringed               :1;
    VOS_UINT16                  bitEvenValuesInfringed          :1;
    VOS_UINT16                  bitAllValuesInfringed           :1;
    VOS_UINT16                  bitSpare1                       :1;
    VOS_UINT16                  bitSpare2                       :1;
    VOS_UINT16                  bitSpare3                       :1;
    VOS_UINT16                  bitSpare4                       :10;
}LRRC_DRX_OFFSET_INFRINGED_RULE_STRU;

/*****************************************************************************
 结构名    : LRRC_DRX_CYCLE_STRU

 结构说明  : short drx cycle结构
*****************************************************************************/
typedef struct
{
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf2;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf5;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf8;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf10;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf16;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf20;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf32;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf40;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf64;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf80;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf128;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf160;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf256;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf320;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf512;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf640;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf4V1130;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleBUTT;
}LRRC_SHORT_DRX_CYCLE_STRU;

/*****************************************************************************
 结构名    : LRRC_DRX_DURATION_TIMER_STRU

 结构说明  : short drx duration timer结构
*****************************************************************************/
typedef struct
{
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF1;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF2;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF3;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF4;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF5;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF6;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF8;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF10;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF20;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF30;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF40;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF50;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF60;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF80;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF100;
    LRRC_SHORT_DRX_CYCLE_STRU                    stDuraTimerPSF200;
}LRRC_SHORT_DRX_DURATION_TIMER_STRU;
...
typedef struct
{
    ...
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf512;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf640;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf1024;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf1280;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf2048;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf2560;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf60V1130;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleSf70V1130;
    LRRC_DRX_OFFSET_INFRINGED_RULE_STRU                    stInfringedOffsetInDrxCycleBUTT;
}LRRC_LONG_DRX_CYCLE_STRU;

/*****************************************************************************
 结构名    : LRRC_DRX_DURATION_TIMER_STRU

 结构说明  : long drx duration timer结构
*****************************************************************************/
typedef struct
{
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF1;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF2;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF3;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF4;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF5;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF6;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF8;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF10;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF20;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF30;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF40;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF50;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF60;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF80;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF100;
    LRRC_LONG_DRX_CYCLE_STRU                    stDuraTimerPSF200;
}LRRC_LONG_DRX_DURATION_TIMER_STRU;

/*****************************************************************************
 结构名    : LRRC_NV_DRX_INFRINGED_VALUES_STRU

 结构说明  : 规避德国DRX侵权NV结构
*****************************************************************************/
typedef struct
{
    PS_BOOL_ENUM_UINT8                        enCheckDrxInfringedFlag;
    PS_BOOL_ENUM_UINT8                        enCheckMCCFlag;
    VOS_UINT8                                 enRsv0;
    VOS_UINT8                                 enRsv1;
    VOS_UINT16                                ausInfringedMcc[LRRC_CHECK_DRX_INFRINGED_MCC_NUM];
    LRRC_LONG_DRX_DURATION_TIMER_STRU         stLongDrxInfringedValues;
    LRRC_SHORT_DRX_DURATION_TIMER_STRU        stShortDrxInfringedValues;
}LRRC_NV_DRX_INFRINGED_VALUES_STRU;
/*****************************************************************************
