...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int st_harq_int_raw : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int st_harq_int_msk : 1;
        unsigned int st_harq_int_clr : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int st_harq_int_mskd : 1;
        unsigned int reserved : 20;
    } reg;
