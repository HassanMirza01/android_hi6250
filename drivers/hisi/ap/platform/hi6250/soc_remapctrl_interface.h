...
typedef union
{
    ...
    struct
    {
        unsigned int m7sleep_tcm_auto_lp_bypass : 1;
        unsigned int reserved : 31;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int itcmaddr_out_224k_err : 1;
        unsigned int reserved_0 : 2;
        unsigned int d0tcm_page_err : 1;
        unsigned int d0tcmaddr_out_224k_err : 1;
        unsigned int reserved_1 : 2;
        unsigned int d1tcm_page_err : 1;
        unsigned int d1tcmaddr_out_224k_err : 1;
