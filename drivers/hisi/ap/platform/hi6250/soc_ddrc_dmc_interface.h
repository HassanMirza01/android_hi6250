...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int bank_xor : 3;
        unsigned int reserved_1 : 1;
        unsigned int bank_mode : 4;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int rec_farb_creq : 1;
        unsigned int farb_rec_cmd_idle : 1;
        unsigned int sch_rec_func_grant : 1;
        unsigned int reserved_1 : 3;
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int rec_state : 4;
        unsigned int phy_func_alert_n : 1;
        unsigned int reserved : 10;
    } reg;
