...
typedef union
{
    ...
    {
        unsigned int socp : 1;
        unsigned int usbotg : 1;
        unsigned int usbotg_bc : 1;
...
typedef union
{
    ...
    struct
    {
        unsigned int psam_ns_region : 1;
        unsigned int ipf_ns_region : 1;
        unsigned int psam_s_region : 1;
        unsigned int ipf_s_region : 1;
