...
#define HISI_BL31_SIZE (0xC0000)
#define HISI_BL31_RAM_ADDR HISI_BL31_BASE
#define HISI_BL31_RAM_SIZE (0x80000)
#define HISI_BL31_PARAMS_FROM_FASTBOOT_PARAMS_ADDR (HISI_BL31_RAM_ADDR + HISI_BL31_RAM_SIZE)
...
#define HISI_BL31_MEM_RESERVE_ADDR (HISI_BL31_DDRC_INFO_ADDR + HISI_BL31_DDRC_INFO_SIZE)
#define HISI_BL31_MEM_RESERVE_SIZE (0x1FC70)
#define HISI_BL31_LOG_ADDR (HISI_BL31_MEM_RESERVE_ADDR + HISI_BL31_MEM_RESERVE_SIZE)
