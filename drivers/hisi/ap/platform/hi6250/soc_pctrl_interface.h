...
typedef union
{
    ...
    struct
    {
        unsigned int mdm_dbg_ctrl : 8;
        unsigned int spi1_cs : 2;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int usb2_hresp_ctrl : 1;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int ipf_mid : 5;
        unsigned int sc_modem_ipc_s_auto_clk_gate_en : 1;
        unsigned int sc_modem_ipc_s_soft_gate_clk_en : 1;
        unsigned int reserved : 9;
    } reg;
