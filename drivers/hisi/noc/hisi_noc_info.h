...
extern void hisi_get_noc_initflow(const struct noc_busid_initflow **filter_initflow);
extern void hisi_get_modemnoc_nodename(char ***modemnoc_nodename);
extern void hisi_noc_get_array_size_hi3650(unsigned int *bus_info_size, unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_hi6250(unsigned int *bus_info_size, unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_hi3660(unsigned int *bus_info_size, unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_kirin970_es(unsigned int *bus_info_size, unsigned int *dump_list_size);
extern void hisi_noc_get_array_size_kirin970(unsigned int *bus_info_size, unsigned int *dump_list_size);
extern unsigned int hisi_noc_clock_enable(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_hi3650(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_hi6250(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_hi3660(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_kirin970_es(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
extern unsigned int hisi_noc_clock_enable_kirin970(struct hisi_noc_device *noc_dev,
				     struct noc_node *node);
#endif
