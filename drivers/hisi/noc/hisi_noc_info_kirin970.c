...
struct noc_mid_info noc_mid_kirin970[] = {
	...
	{0, 1, 0x3800, 0x0, "AP_CPU0"}, /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x800, "AP_CPU1"},   /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x1000, "AP_CPU2"},  /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x1800, "AP_CPU3"},  /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x2000, "AP_CPU4"},  /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x2800, "AP_CPU5"},  /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x3000, "AP_CPU6"},  /*noc_cci2sysbus,*/
	{0, 1, 0x3800, 0x3800, "AP_CPU7"},  /*noc_cci2sysbus,*/
	{0, 11, 0x007f, 0x02, "HDLC"},  /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x14, "CICOM1"},  /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x15, "BBE16"},  /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x16, "BBP_DMA_0"},/*noc_modem_mst,*/
	{0, 11, 0x007f, 0x17, "BBP_DMA_1"},/*noc_modem_mst,*/
	{0, 11, 0x007f, 0x18, "GU_BBP_MST_0"},    /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x19, "GU_BBP_MST_1"},    /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1A, "BBE16_C_OR_MCPU_M0"},   /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1B, "EDMA0"},  /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1C, "CIPHER"},    /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1D, "EDMA1"}, /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1E, "UPACC"}, /*noc_modem_mst,*/
	{0, 11, 0x007f, 0x1F, "CICOM_0"},   /*noc_modem_mst,*/
				     ...
				     struct noc_node *node)
{
	...
	if ((NOC_CFG_SYS_BUS_ID == node->bus_id) && (noc_dev->pcrgctrl_base != NULL))
		reg_base = noc_dev->pcrgctrl_base;
	else if ((NOC_VCODEC_BUS_ID == node->bus_id) && (noc_dev->media2_crg_base != NULL))
		reg_base = noc_dev->media2_crg_base;
	else if ((NOC_VIVO_BUS_ID == node->bus_id) && (noc_dev->media1_crg_base != NULL))
