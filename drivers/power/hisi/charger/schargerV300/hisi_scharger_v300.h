...
#define CHG_VERSION_V300                (0x00)
#define CHG_VERSION_V310                (0x10)
#define CHG_VERSION_V320                (0x20)
#ifndef BIT
#define BIT(x)                          (1 << (x))
#endif
...
#define CHG_ADC_APPDET_EN_SHIFT			(SOC_SCHARGER_SYS_RESVO2_app_det_en_START)
#define CHG_ADC_APPDET_EN_MSK			(1<<CHG_ADC_APPDET_EN_SHIFT)
#define CHG_ADC_APPDET_EN				(1)
#define CHG_ADC_APPDET_DIS				(0)
#define CHG_ADC_APPDET_CHSEL_SHIFT		(SOC_SCHARGER_SYS_RESVO2_app_det_chsel_START)
